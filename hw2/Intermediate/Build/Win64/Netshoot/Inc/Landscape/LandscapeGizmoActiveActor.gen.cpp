...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Landscape_ELandscapeGizmoType_Hash() { return 1232449867U; }
...
static struct FScriptStruct_Landscape_StaticRegisterNativesFGizmoSelectData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGizmoSelectData>(FName(TEXT("GizmoSelectData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FGizmoSelectData_Hash() { return 3992438778U; }
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid = { "bSnapToLandscapeGrid", nullptr, (EPropertyFlags)0x0010000800002000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ALandscapeGizmoActiveActor), &Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_SetBit, METADATA_PARAMS(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ALandscapeGizmoActiveActor, 3164501354);
