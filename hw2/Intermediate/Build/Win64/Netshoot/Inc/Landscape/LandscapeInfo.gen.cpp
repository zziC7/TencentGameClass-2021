...
static struct FScriptStruct_Landscape_StaticRegisterNativesFLandscapeInfoLayerSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLandscapeInfoLayerSettings>(FName(TEXT("LandscapeInfoLayerSettings")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FLandscapeInfoLayerSettings_Hash() { return 948081464U; }
...
#endif // WITH_EDITORONLY_DATA
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_Proxies_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_Proxies_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_Proxies;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_EDITORONLY_DATA
#endif // WITH_EDITORONLY_DATA
...
#endif
	const UE4CodeGen_Private::FLazyObjectPropertyParams Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_LandscapeActor = { "LandscapeActor", nullptr, (EPropertyFlags)0x0014000000000000, UE4CodeGen_Private::EPropertyGenFlags::LazyObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeInfo, LandscapeActor), Z_Construct_UClass_ALandscape_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_LandscapeActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_LandscapeActor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_ComponentNumSubsections = { "ComponentNumSubsections", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeInfo, ComponentNumSubsections), METADATA_PARAMS(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_ComponentNumSubsections_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_ComponentNumSubsections_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_DrawScale_MetaData[] = {
		{ "ModuleRelativePath", "Classes/LandscapeInfo.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_DrawScale = { "DrawScale", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeInfo, DrawScale), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_DrawScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_DrawScale_MetaData)) };
#if WITH_EDITORONLY_DATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_Layers = { "Layers", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeInfo, Layers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_Layers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_Layers_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_Proxies_Inner = { "Proxies", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_ALandscapeStreamingProxy_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_Proxies_MetaData[] = {
		{ "ModuleRelativePath", "Classes/LandscapeInfo.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_Proxies = { "Proxies", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeInfo, Proxies), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_Proxies_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_Proxies_MetaData)) };
...
#endif // WITH_EDITORONLY_DATA
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULandscapeInfo_Statics::NewProp_Proxies_Inner,
	...
	IMPLEMENT_CLASS(ULandscapeInfo, 802514059);
