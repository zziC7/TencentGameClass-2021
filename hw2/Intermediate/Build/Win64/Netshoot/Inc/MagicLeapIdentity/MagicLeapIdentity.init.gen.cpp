...
void EmptyLinkFunctionForGeneratedCodeMagicLeapIdentity_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_MagicLeapIdentity()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_UMagicLeapIdentity_AvailableIdentityAttributesDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UMagicLeapIdentity_RequestIdentityAttributeValueDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UMagicLeapIdentity_ModifyIdentityAttributeValueDelegate__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/MagicLeapIdentity",
				SingletonFuncArray,
