...
static struct FScriptStruct_AudioCapture_StaticRegisterNativesFAudioCaptureDeviceInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAudioCaptureDeviceInfo>(FName(TEXT("AudioCaptureDeviceInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAudioCaptureDeviceInfo_Hash() { return 1004733706U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAudioCapture_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAudioCapture_GetAudioCaptureDeviceInfo, "GetAudioCaptureDeviceInfo" }, // 3872084173
	...
	IMPLEMENT_CLASS(UAudioCapture, 2306972575);
