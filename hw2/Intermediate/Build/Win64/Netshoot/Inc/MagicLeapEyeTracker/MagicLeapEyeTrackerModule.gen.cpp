...
static struct FScriptStruct_MagicLeapEyeTracker_StaticRegisterNativesFMagicLeapEyeBlinkState
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMagicLeapEyeBlinkState>(FName(TEXT("MagicLeapEyeBlinkState")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMagicLeapEyeBlinkState_Hash() { return 3258663635U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMagicLeapEyeTrackerFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMagicLeapEyeTrackerFunctionLibrary_GetCalibrationStatus, "GetCalibrationStatus" }, // 2174901605
		{ &Z_Construct_UFunction_UMagicLeapEyeTrackerFunctionLibrary_GetEyeBlinkState, "GetEyeBlinkState" }, // 3237905052
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMagicLeapEyeTrackerFunctionLibrary, 3371523696);
