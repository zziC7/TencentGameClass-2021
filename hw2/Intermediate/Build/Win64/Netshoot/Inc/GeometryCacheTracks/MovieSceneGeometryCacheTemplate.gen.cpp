...
static struct FScriptStruct_GeometryCacheTracks_StaticRegisterNativesFMovieSceneGeometryCacheSectionTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneGeometryCacheSectionTemplate>(FName(TEXT("MovieSceneGeometryCacheSectionTemplate")));
	}
...
static struct FScriptStruct_GeometryCacheTracks_StaticRegisterNativesFMovieSceneGeometryCacheSectionTemplateParameters
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneGeometryCacheSectionTemplateParameters>(FName(TEXT("MovieSceneGeometryCacheSectionTemplateParameters")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplateParameters_Hash() { return 1296146794U; }
