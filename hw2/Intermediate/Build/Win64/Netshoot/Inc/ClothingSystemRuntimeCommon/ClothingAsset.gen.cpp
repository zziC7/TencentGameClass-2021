...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothSimConfig = { "ClothSimConfig", nullptr, (EPropertyFlags)0x0010000820000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, ClothSimConfig_DEPRECATED), Z_Construct_UClass_UClothConfigBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothSimConfig_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothSimConfig_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ChaosClothSimConfig = { "ChaosClothSimConfig", nullptr, (EPropertyFlags)0x0010000820000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, ChaosClothSimConfig_DEPRECATED), Z_Construct_UClass_UClothConfigBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ChaosClothSimConfig_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ChaosClothSimConfig_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothLodData_Inner = { "ClothLodData", nullptr, (EPropertyFlags)0x0000000820000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UClothLODDataCommon_Legacy_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfig = { "ClothConfig", nullptr, (EPropertyFlags)0x0010000820000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, ClothConfig_DEPRECATED), Z_Construct_UScriptStruct_FClothConfig_Legacy, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfig_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfig_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(UClothingAssetCommon, 1901237307);
