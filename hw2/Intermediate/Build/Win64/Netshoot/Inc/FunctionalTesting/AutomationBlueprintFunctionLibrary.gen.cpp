...
class UScriptStruct* FAutomationWaitForLoadingOptions::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern FUNCTIONALTESTING_API uint32 Get_Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions, Z_Construct_UPackage__Script_FunctionalTesting(), TEXT("AutomationWaitForLoadingOptions"), sizeof(FAutomationWaitForLoadingOptions), Get_Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FAutomationWaitForLoadingOptions(FAutomationWaitForLoadingOptions::StaticStruct, TEXT("/Script/FunctionalTesting"), TEXT("AutomationWaitForLoadingOptions"), false, nullptr, nullptr);
static struct FScriptStruct_FunctionalTesting_StaticRegisterNativesFAutomationWaitForLoadingOptions
{
	FScriptStruct_FunctionalTesting_StaticRegisterNativesFAutomationWaitForLoadingOptions()
	{
		UScriptStruct::DeferCppStructOps<FAutomationWaitForLoadingOptions>(FName(TEXT("AutomationWaitForLoadingOptions")));
	}
} ScriptStruct_FunctionalTesting_StaticRegisterNativesFAutomationWaitForLoadingOptions;
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_WaitForReplicationToSettle_MetaData[];
#endif
		static void NewProp_WaitForReplicationToSettle_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_WaitForReplicationToSettle;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const UE4CodeGen_Private::FStructParams ReturnStructParams;
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::NewProp_WaitForReplicationToSettle_MetaData[] = {
		{ "Category", "Automation" },
		{ "ModuleRelativePath", "Public/AutomationBlueprintFunctionLibrary.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::NewProp_WaitForReplicationToSettle = { "WaitForReplicationToSettle", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAutomationWaitForLoadingOptions), &Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::NewProp_WaitForReplicationToSettle_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::NewProp_WaitForReplicationToSettle_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::NewProp_WaitForReplicationToSettle_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::NewProp_WaitForReplicationToSettle,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::ReturnStructParams = {
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_FunctionalTesting();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("AutomationWaitForLoadingOptions"), sizeof(FAutomationWaitForLoadingOptions), Get_Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions_Hash() { return 2962949255U; }
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_AutomationWaitForLoading_Statics::NewProp_Options = { "Options", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AutomationBlueprintFunctionLibrary_eventAutomationWaitForLoading_Parms, Options), Z_Construct_UScriptStruct_FAutomationWaitForLoadingOptions, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_AutomationWaitForLoading_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_AutomationWaitForLoading_Statics::NewProp_Options,
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_TakeHighResScreenshot_Statics::NewProp_Delay = { "Delay", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AutomationBlueprintFunctionLibrary_eventTakeHighResScreenshot_Parms, Delay), METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_TakeHighResScreenshot_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_TakeHighResScreenshot_Statics::NewProp_Delay,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAutomationBlueprintFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_AddExpectedLogError, "AddExpectedLogError" }, // 1145387510
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_AreAutomatedTestsRunning, "AreAutomatedTestsRunning" }, // 270900785
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_AutomationWaitForLoading, "AutomationWaitForLoading" }, // 2530861301
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_DisableStatGroup, "DisableStatGroup" }, // 1717988776
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_EnableStatGroup, "EnableStatGroup" }, // 2968096824
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_GetDefaultScreenshotOptionsForGameplay, "GetDefaultScreenshotOptionsForGameplay" }, // 1071156810
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_GetDefaultScreenshotOptionsForRendering, "GetDefaultScreenshotOptionsForRendering" }, // 2343413471
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_GetStatCallCount, "GetStatCallCount" }, // 3548262478
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_GetStatExcAverage, "GetStatExcAverage" }, // 49564007
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_GetStatExcMax, "GetStatExcMax" }, // 231490400
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_GetStatIncAverage, "GetStatIncAverage" }, // 3260717876
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_GetStatIncMax, "GetStatIncMax" }, // 1458367845
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_SetScalabilityQualityLevelRelativeToMax, "SetScalabilityQualityLevelRelativeToMax" }, // 4164672564
		...
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_TakeAutomationScreenshot, "TakeAutomationScreenshot" }, // 567248325
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_TakeAutomationScreenshotAtCamera, "TakeAutomationScreenshotAtCamera" }, // 1931145083
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_TakeAutomationScreenshotOfUI, "TakeAutomationScreenshotOfUI" }, // 1270270564
		{ &Z_Construct_UFunction_UAutomationBlueprintFunctionLibrary_TakeHighResScreenshot, "TakeHighResScreenshot" }, // 3062122697
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAutomationBlueprintFunctionLibrary, 798820712);
