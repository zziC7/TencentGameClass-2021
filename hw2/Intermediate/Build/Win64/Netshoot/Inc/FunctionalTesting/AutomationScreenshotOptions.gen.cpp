...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_FunctionalTesting_EComparisonTolerance_Hash() { return 14253074U; }
...
static struct FScriptStruct_FunctionalTesting_StaticRegisterNativesFAutomationScreenshotOptions
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAutomationScreenshotOptions>(FName(TEXT("AutomationScreenshotOptions")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Delay = { "Delay", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, Delay), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Delay_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Delay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_VisualizeBuffer = { "VisualizeBuffer", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, VisualizeBuffer), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_VisualizeBuffer_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_VisualizeBuffer_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Tolerance = { "Tolerance", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, Tolerance), Z_Construct_UEnum_FunctionalTesting_EComparisonTolerance, METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Tolerance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Tolerance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_MaximumGlobalError = { "MaximumGlobalError", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, MaximumGlobalError), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_MaximumGlobalError_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_MaximumGlobalError_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Hash() { return 1515219677U; }
...
static struct FScriptStruct_FunctionalTesting_StaticRegisterNativesFComparisonToleranceAmount
{
	...
	{
		UScriptStruct::DeferCppStructOps<FComparisonToleranceAmount>(FName(TEXT("ComparisonToleranceAmount")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FComparisonToleranceAmount_Hash() { return 983259412U; }
