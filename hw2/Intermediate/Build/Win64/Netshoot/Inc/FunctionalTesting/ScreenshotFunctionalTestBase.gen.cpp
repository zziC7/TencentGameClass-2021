...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_Notes = { "Notes", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AScreenshotFunctionalTestBase, Notes), METADATA_PARAMS(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_Notes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_Notes_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotCamera = { "ScreenshotCamera", nullptr, (EPropertyFlags)0x002008000008001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AScreenshotFunctionalTestBase, ScreenshotCamera), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotCamera_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotCamera_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AScreenshotFunctionalTestBase, 315647548);
