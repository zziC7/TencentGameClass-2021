...
#define Engine_Plugins_Lumin_MagicLeap_Source_MagicLeapImageTracker_Public_MagicLeapImageTrackerTypes_h_82_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FMagicLeapImageTargetState_Statics; \
	static class UScriptStruct* StaticStruct();


template<> MAGICLEAPIMAGETRACKER_API UScriptStruct* StaticStruct<struct FMagicLeapImageTargetState>();

#define Engine_Plugins_Lumin_MagicLeap_Source_MagicLeapImageTracker_Public_MagicLeapImageTrackerTypes_h_57_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FMagicLeapImageTargetSettings_Statics; \
	static class UScriptStruct* StaticStruct();


template<> MAGICLEAPIMAGETRACKER_API UScriptStruct* StaticStruct<struct FMagicLeapImageTargetSettings>();
...
#define FOREACH_ENUM_EMAGICLEAPIMAGETARGETORIENTATION(op) \
	op(EMagicLeapImageTargetOrientation::ForwardAxisAsNormal) \
	op(EMagicLeapImageTargetOrientation::UpAxisAsNormal) 

enum class EMagicLeapImageTargetOrientation : uint8;
template<> MAGICLEAPIMAGETRACKER_API UEnum* StaticEnum<EMagicLeapImageTargetOrientation>();

#define FOREACH_ENUM_EMAGICLEAPIMAGETARGETSTATUS(op) \
	op(EMagicLeapImageTargetStatus::Tracked) \
	op(EMagicLeapImageTargetStatus::Unreliable) \
	op(EMagicLeapImageTargetStatus::NotTracked) 

enum class EMagicLeapImageTargetStatus : uint8;
template<> MAGICLEAPIMAGETRACKER_API UEnum* StaticEnum<EMagicLeapImageTargetStatus>();
