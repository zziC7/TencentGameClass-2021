...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMagicLeapImageTrackerComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMagicLeapImageTrackerComponent_SetTargetAsync, "SetTargetAsync" }, // 572742812
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMagicLeapImageTrackerComponent_Statics::NewProp_AxisOrientation_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMagicLeapImageTrackerComponent_Statics::NewProp_AxisOrientation_MetaData[] = {
		{ "Category", "ImageTracking|MagicLeap" },
		{ "ModuleRelativePath", "Public/MagicLeapImageTrackerComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMagicLeapImageTrackerComponent_Statics::NewProp_AxisOrientation = { "AxisOrientation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMagicLeapImageTrackerComponent, AxisOrientation), Z_Construct_UEnum_MagicLeapImageTracker_EMagicLeapImageTargetOrientation, METADATA_PARAMS(Z_Construct_UClass_UMagicLeapImageTrackerComponent_Statics::NewProp_AxisOrientation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMagicLeapImageTrackerComponent_Statics::NewProp_AxisOrientation_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMagicLeapImageTrackerComponent_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMagicLeapImageTrackerComponent_Statics::NewProp_AxisOrientation_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMagicLeapImageTrackerComponent_Statics::NewProp_AxisOrientation,
	...
	IMPLEMENT_CLASS(UMagicLeapImageTrackerComponent, 568292806);
