...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_MagicLeapPrivileges_EMagicLeapPrivilege_Hash() { return 349688998U; }
	UEnum* Z_Construct_UEnum_MagicLeapPrivileges_EMagicLeapPrivilege()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "EMagicLeapPrivilege::SecureBrowserWindow", (int64)EMagicLeapPrivilege::SecureBrowserWindow },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "SecureBrowserWindow.Name", "EMagicLeapPrivilege::SecureBrowserWindow" },
