...
#define Engine_Plugins_Lumin_MagicLeap_Source_MagicLeapPrivileges_Public_MagicLeapPrivilegeTypes_h_59_DELEGATE \
...
#define FOREACH_ENUM_EMAGICLEAPPRIVILEGE(op) \
	...
	op(EMagicLeapPrivilege::SecureBrowserWindow) 
