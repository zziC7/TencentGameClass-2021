...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimNotify_PlayNiagaraEffect_Statics::NewProp_bAbsoluteScale_MetaData[] = {
		{ "Category", "AnimNotify" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimNotify_PlayNiagaraEffect_Statics::NewProp_bAbsoluteScale = { "bAbsoluteScale", nullptr, (EPropertyFlags)0x0010040000000011, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAnimNotify_PlayNiagaraEffect), &Z_Construct_UClass_UAnimNotify_PlayNiagaraEffect_Statics::NewProp_bAbsoluteScale_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimNotify_PlayNiagaraEffect_Statics::NewProp_bAbsoluteScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotify_PlayNiagaraEffect_Statics::NewProp_bAbsoluteScale_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAnimNotify_PlayNiagaraEffect_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimNotify_PlayNiagaraEffect_Statics::NewProp_bAbsoluteScale,
	...
	IMPLEMENT_CLASS(UAnimNotify_PlayNiagaraEffect, 71149144);
