...
static struct FScriptStruct_EngineSettings_StaticRegisterNativesFAutoCompleteCommand
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAutoCompleteCommand>(FName(TEXT("AutoCompleteCommand")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAutoCompleteCommand_Hash() { return 1675968741U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDisplayHelpInAutoComplete_MetaData[];
#endif
		static void NewProp_bDisplayHelpInAutoComplete_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDisplayHelpInAutoComplete;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UConsoleSettings_Statics::NewProp_ManualAutoCompleteList = { "ManualAutoCompleteList", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConsoleSettings, ManualAutoCompleteList), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UConsoleSettings_Statics::NewProp_ManualAutoCompleteList_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsoleSettings_Statics::NewProp_ManualAutoCompleteList_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UConsoleSettings_Statics::NewProp_AutoCompleteMapPaths = { "AutoCompleteMapPaths", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConsoleSettings, AutoCompleteMapPaths), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UConsoleSettings_Statics::NewProp_AutoCompleteMapPaths_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsoleSettings_Statics::NewProp_AutoCompleteMapPaths_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UConsoleSettings_Statics::NewProp_BackgroundOpacityPercentage = { "BackgroundOpacityPercentage", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConsoleSettings, BackgroundOpacityPercentage), METADATA_PARAMS(Z_Construct_UClass_UConsoleSettings_Statics::NewProp_BackgroundOpacityPercentage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsoleSettings_Statics::NewProp_BackgroundOpacityPercentage_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UConsoleSettings_Statics::NewProp_bDisplayHelpInAutoComplete_MetaData[] = {
		{ "Category", "AutoComplete" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UConsoleSettings_Statics::NewProp_bDisplayHelpInAutoComplete = { "bDisplayHelpInAutoComplete", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UConsoleSettings), &Z_Construct_UClass_UConsoleSettings_Statics::NewProp_bDisplayHelpInAutoComplete_SetBit, METADATA_PARAMS(Z_Construct_UClass_UConsoleSettings_Statics::NewProp_bDisplayHelpInAutoComplete_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsoleSettings_Statics::NewProp_bDisplayHelpInAutoComplete_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UConsoleSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UConsoleSettings_Statics::NewProp_bDisplayHelpInAutoComplete,
	...
	IMPLEMENT_CLASS(UConsoleSettings, 1641309682);
