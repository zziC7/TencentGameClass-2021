...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxSpectators = { "MaxSpectators", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameSessionSettings, MaxSpectators), METADATA_PARAMS(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxSpectators_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxSpectators_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UGameSessionSettings, 3103232374);
