...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPropertyValueOption_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UPropertyValueOption_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UPropertyValueOption()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UPropertyValueOption_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UPropertyValueOption, 4255344610);
	template<> VARIANTMANAGERCONTENT_API UClass* StaticClass<UPropertyValueOption>()
	{
		return UPropertyValueOption::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UPropertyValueOption(Z_Construct_UClass_UPropertyValueOption, &UPropertyValueOption::StaticClass, TEXT("/Script/VariantManagerContent"), TEXT("UPropertyValueOption"), false, nullptr, nullptr, nullptr);
