...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraScriptSourceBase_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraScriptSourceBase_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UNiagaraScriptSourceBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UNiagaraScriptSourceBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UNiagaraScriptSourceBase, 3555816098);
	template<> NIAGARA_API UClass* StaticClass<UNiagaraScriptSourceBase>()
	{
		return UNiagaraScriptSourceBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UNiagaraScriptSourceBase(Z_Construct_UClass_UNiagaraScriptSourceBase, &UNiagaraScriptSourceBase::StaticClass, TEXT("/Script/Niagara"), TEXT("UNiagaraScriptSourceBase"), false, nullptr, nullptr, nullptr);
