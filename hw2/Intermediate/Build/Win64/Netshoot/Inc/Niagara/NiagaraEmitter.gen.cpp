...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Niagara_EParticleAllocationMode_Hash() { return 3143096702U; }
	...
	uint32 Get_Z_Construct_UEnum_Niagara_EScriptExecutionMode_Hash() { return 422505001U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraDetailsLevelScaleOverrides
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraDetailsLevelScaleOverrides>(FName(TEXT("NiagaraDetailsLevelScaleOverrides")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraDetailsLevelScaleOverrides_Hash() { return 3815326668U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraEventScriptProperties
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraEventScriptProperties>(FName(TEXT("NiagaraEventScriptProperties")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraEventScriptProperties_Hash() { return 1831127478U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraEmitterScriptProperties
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraEmitterScriptProperties>(FName(TEXT("NiagaraEmitterScriptProperties")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraEmitterScriptProperties_Hash() { return 406260293U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraEventGeneratorProperties
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraEventGeneratorProperties>(FName(TEXT("NiagaraEventGeneratorProperties")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraEventGeneratorProperties_Hash() { return 2948968286U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraEventReceiverProperties
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraEventReceiverProperties>(FName(TEXT("NiagaraEventReceiverProperties")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraEventReceiverProperties_Hash() { return 2330056171U; }
	...
	struct Z_Construct_UClass_UNiagaraEmitter_Statics
	{
		...
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_AttributesToPreserve_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AttributesToPreserve_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_AttributesToPreserve;
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bCombineEventSpawn_MetaData[];
#endif
		static void NewProp_bCombineEventSpawn_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bCombineEventSpawn;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EmitterSpawnScriptProps = { "EmitterSpawnScriptProps", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraEmitter, EmitterSpawnScriptProps), Z_Construct_UScriptStruct_FNiagaraEmitterScriptProperties, METADATA_PARAMS(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EmitterSpawnScriptProps_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EmitterSpawnScriptProps_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EmitterUpdateScriptProps = { "EmitterUpdateScriptProps", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraEmitter, EmitterUpdateScriptProps), Z_Construct_UScriptStruct_FNiagaraEmitterScriptProperties, METADATA_PARAMS(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EmitterUpdateScriptProps_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EmitterUpdateScriptProps_MetaData)) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_AttributesToPreserve_Inner = { "AttributesToPreserve", nullptr, (EPropertyFlags)0x0000000800000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_AttributesToPreserve_MetaData[] = {
		{ "Category", "Emitter" },
		{ "Comment", "/** A whitelist of Particle attributes (e.g. \"Particle.Position\" or \"Particle.Age\") that will not be removed from the DataSet  even if they aren't read by the VM.\n\x09    Used in conjunction with UNiagaraSystem::bTrimAttributes */" },
		{ "ModuleRelativePath", "Classes/NiagaraEmitter.h" },
		{ "ToolTip", "A whitelist of Particle attributes (e.g. \"Particle.Position\" or \"Particle.Age\") that will not be removed from the DataSet  even if they aren't read by the VM.\n          Used in conjunction with UNiagaraSystem::bTrimAttributes" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_AttributesToPreserve = { "AttributesToPreserve", nullptr, (EPropertyFlags)0x0010040800000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraEmitter, AttributesToPreserve), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_AttributesToPreserve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_AttributesToPreserve_MetaData)) };
#endif // WITH_EDITORONLY_DATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_bCombineEventSpawn_MetaData[] = {
		{ "Category", "Emitter" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_bBakeOutRapidIteration_MetaData[] = {
		...
		{ "DisplayName", "Supports Baked Rapid Iteration" },
		{ "ModuleRelativePath", "Classes/NiagaraEmitter.h" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_bIsTemplateAsset = { "bIsTemplateAsset", nullptr, (EPropertyFlags)0x0010000820000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UNiagaraEmitter), &Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_bIsTemplateAsset_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_bIsTemplateAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_bIsTemplateAsset_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_TemplateSpecification_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_TemplateSpecification_MetaData[] = {
		{ "Category", "Asset Options" },
		{ "ModuleRelativePath", "Classes/NiagaraEmitter.h" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_TemplateSpecification = { "TemplateSpecification", nullptr, (EPropertyFlags)0x0010050800000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraEmitter, TemplateSpecification), Z_Construct_UEnum_Niagara_ENiagaraScriptTemplateSpecification, METADATA_PARAMS(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_TemplateSpecification_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_TemplateSpecification_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_Category_MetaData[] = {
		{ "Category", "Script" },
...
#endif
	const UE4CodeGen_Private::FTextPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_Category = { "Category", nullptr, (EPropertyFlags)0x0010010800000001, UE4CodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraEmitter, Category), METADATA_PARAMS(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_Category_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_Category_MetaData)) };
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EditorParameters_MetaData[] = {
		{ "Comment", "/** Wrapper for editor only parameters. */" },
		{ "ModuleRelativePath", "Classes/NiagaraEmitter.h" },
		{ "ToolTip", "Wrapper for editor only parameters." },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EditorParameters = { "EditorParameters", nullptr, (EPropertyFlags)0x0040000800000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraEmitter, EditorParameters), Z_Construct_UClass_UNiagaraEditorParametersAdapterBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EditorParameters_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EditorParameters_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_ParameterDefinitionsSubscriptions_Inner = { "ParameterDefinitionsSubscriptions", nullptr, (EPropertyFlags)0x0000000800000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FParameterDefinitionsSubscription, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_ParameterDefinitionsSubscriptions_MetaData[] = {
		{ "Comment", "/** Subscriptions to definitions of parameters. */" },
		{ "ModuleRelativePath", "Classes/NiagaraEmitter.h" },
		{ "ToolTip", "Subscriptions to definitions of parameters." },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_ParameterDefinitionsSubscriptions = { "ParameterDefinitionsSubscriptions", nullptr, (EPropertyFlags)0x0040000800000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraEmitter, ParameterDefinitionsSubscriptions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_ParameterDefinitionsSubscriptions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_ParameterDefinitionsSubscriptions_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_MessageKeyToMessageMap_ValueProp = { "MessageKeyToMessageMap", nullptr, (EPropertyFlags)0x0000000800000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_UNiagaraMessageDataBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_MessageKeyToMessageMap_Key_KeyProp = { "MessageKeyToMessageMap_Key", nullptr, (EPropertyFlags)0x0000000800000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_MessageKeyToMessageMap_MetaData[] = {
		{ "Comment", "/** Messages associated with the Emitter asset. */" },
		{ "ModuleRelativePath", "Classes/NiagaraEmitter.h" },
		{ "ToolTip", "Messages associated with the Emitter asset." },
	};
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_MessageKeyToMessageMap = { "MessageKeyToMessageMap", nullptr, (EPropertyFlags)0x0040000800000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraEmitter, MessageKeyToMessageMap), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_MessageKeyToMessageMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_MessageKeyToMessageMap_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNiagaraEmitter_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_AttributesToPreserve_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_AttributesToPreserve,
#endif // WITH_EDITORONLY_DATA
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_bCombineEventSpawn,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_TemplateSpecification_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_TemplateSpecification,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_TemplateAssetDescription,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_Category,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_EditorParameters,
#endif // WITH_EDITORONLY_DATA
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_ParameterDefinitionsSubscriptions_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_ParameterDefinitionsSubscriptions,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_MessageKeyToMessageMap_ValueProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_MessageKeyToMessageMap_Key_KeyProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraEmitter_Statics::NewProp_MessageKeyToMessageMap,
#endif // WITH_EDITORONLY_DATA
	};
	...
	IMPLEMENT_CLASS(UNiagaraEmitter, 390366831);
