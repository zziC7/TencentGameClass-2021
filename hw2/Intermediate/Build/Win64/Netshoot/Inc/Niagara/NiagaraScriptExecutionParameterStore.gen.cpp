...
class UScriptStruct* FNiagaraScriptInstanceParameterStore::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern NIAGARA_API uint32 Get_Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraScriptInstanceParameterStore"), sizeof(FNiagaraScriptInstanceParameterStore), Get_Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FNiagaraScriptInstanceParameterStore(FNiagaraScriptInstanceParameterStore::StaticStruct, TEXT("/Script/Niagara"), TEXT("NiagaraScriptInstanceParameterStore"), false, nullptr, nullptr);
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraScriptInstanceParameterStore
{
	FScriptStruct_Niagara_StaticRegisterNativesFNiagaraScriptInstanceParameterStore()
	{
		UScriptStruct::DeferCppStructOps<FNiagaraScriptInstanceParameterStore>(FName(TEXT("NiagaraScriptInstanceParameterStore")));
	}
} ScriptStruct_Niagara_StaticRegisterNativesFNiagaraScriptInstanceParameterStore;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore_Statics::Struct_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore_Statics::ReturnStructParams = {
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_Niagara();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("NiagaraScriptInstanceParameterStore"), sizeof(FNiagaraScriptInstanceParameterStore), Get_Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore_Hash() { return 115360730U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraScriptExecutionParameterStore
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraScriptExecutionParameterStore>(FName(TEXT("NiagaraScriptExecutionParameterStore")));
	}
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddedParameterSize = { "PaddedParameterSize", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScriptExecutionParameterStore, PaddedParameterSize), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddedParameterSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddedParameterSize_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddingInfo = { "PaddingInfo", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScriptExecutionParameterStore, PaddingInfo), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddingInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddingInfo_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Hash() { return 582319442U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraScriptExecutionPaddingInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraScriptExecutionPaddingInfo>(FName(TEXT("NiagaraScriptExecutionPaddingInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Hash() { return 2901978785U; }
