...
static struct FScriptStruct_Niagara_StaticRegisterNativesFMovieSceneNiagaraSystemTrackImplementation
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneNiagaraSystemTrackImplementation>(FName(TEXT("MovieSceneNiagaraSystemTrackImplementation")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneNiagaraSystemTrackImplementation_Hash() { return 1446233944U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFMovieSceneNiagaraSystemTrackTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneNiagaraSystemTrackTemplate>(FName(TEXT("MovieSceneNiagaraSystemTrackTemplate")));
	}
