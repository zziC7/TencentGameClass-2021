...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraGraphViewSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraGraphViewSettings>(FName(TEXT("NiagaraGraphViewSettings")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraGraphViewSettings_Hash() { return 153387232U; }
	...
	IMPLEMENT_CLASS(UNiagaraEditorDataBase, 784295149);
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraEditorParametersAdapterBase_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UNiagaraEditorParametersAdapterBase_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UNiagaraEditorParametersAdapterBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UNiagaraEditorParametersAdapterBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UNiagaraEditorParametersAdapterBase, 2830386902);
	template<> NIAGARA_API UClass* StaticClass<UNiagaraEditorParametersAdapterBase>()
	{
		return UNiagaraEditorParametersAdapterBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UNiagaraEditorParametersAdapterBase(Z_Construct_UClass_UNiagaraEditorParametersAdapterBase, &UNiagaraEditorParametersAdapterBase::StaticClass, TEXT("/Script/Niagara"), TEXT("UNiagaraEditorParametersAdapterBase"), false, nullptr, nullptr, nullptr);
