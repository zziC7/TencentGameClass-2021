...
static struct FScriptStruct_Engine_StaticRegisterNativesFBranchingPointNotifyPayload
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBranchingPointNotifyPayload>(FName(TEXT("BranchingPointNotifyPayload")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBranchingPointNotifyPayload_Hash() { return 930350674U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimNotify_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAnimNotify_GetNotifyName, "GetNotifyName" }, // 4057673420
		{ &Z_Construct_UFunction_UAnimNotify_Received_Notify, "Received_Notify" }, // 433234856
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAnimNotify, 1973973476);
