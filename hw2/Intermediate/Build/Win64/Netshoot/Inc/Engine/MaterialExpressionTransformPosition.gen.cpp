...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMaterialPositionTransformSource_Hash() { return 782915633U; }
	UEnum* Z_Construct_UEnum_Engine_EMaterialPositionTransformSource()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "TRANSFORMPOSSOURCE_Particle.Comment", "/** Particle space */" },
	...
	IMPLEMENT_CLASS(UMaterialExpressionTransformPosition, 430023618);
