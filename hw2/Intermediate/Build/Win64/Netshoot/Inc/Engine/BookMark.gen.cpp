...
static struct FScriptStruct_Engine_StaticRegisterNativesFBookmarkJumpToSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBookmarkJumpToSettings>(FName(TEXT("BookmarkJumpToSettings")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBookmarkJumpToSettings_Hash() { return 3699355582U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBookMark_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBookMark, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UBookMark_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBookMark_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UBookMark, 239685480);
