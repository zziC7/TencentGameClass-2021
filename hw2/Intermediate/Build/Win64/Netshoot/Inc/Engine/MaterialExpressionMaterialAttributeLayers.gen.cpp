...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMaterialExpressionMaterialAttributeLayers_Statics::NewProp_LayerCallers = { "LayerCallers", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionMaterialAttributeLayers, LayerCallers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionMaterialAttributeLayers_Statics::NewProp_LayerCallers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionMaterialAttributeLayers_Statics::NewProp_LayerCallers_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMaterialExpressionMaterialAttributeLayers, 700510730);
