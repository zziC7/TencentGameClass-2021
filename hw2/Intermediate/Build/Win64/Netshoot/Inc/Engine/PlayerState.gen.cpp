...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PlayerState_eventIsOnlyASpectator_Parms), &Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::Function_MetaDataParams[] = {
		{ "Category", "PlayerState" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_APlayerState, nullptr, "IsOnlyASpectator", nullptr, nullptr, sizeof(PlayerState_eventIsOnlyASpectator_Parms), Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_APlayerState_IsOnlyASpectator()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_APlayerState_IsOnlyASpectator_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APlayerState_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_APlayerState_IsOnlyASpectator, "IsOnlyASpectator" }, // 700715882
	...
	IMPLEMENT_CLASS(APlayerState, 717720854);
