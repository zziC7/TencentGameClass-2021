...
static struct FScriptStruct_Engine_StaticRegisterNativesFAssetMapping
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAssetMapping>(FName(TEXT("AssetMapping")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAssetMapping_Hash() { return 376772438U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAssetMappingTable_Statics::NewProp_MappedAssets = { "MappedAssets", nullptr, (EPropertyFlags)0x0040000000020041, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAssetMappingTable, MappedAssets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAssetMappingTable_Statics::NewProp_MappedAssets_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAssetMappingTable_Statics::NewProp_MappedAssets_MetaData)) };
	...
	IMPLEMENT_CLASS(UAssetMappingTable, 2919352728);
