...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParticleModuleSubUVBase_Statics::Class_MetaDataParams[] = {
		{ "DisplayName", "SubUV" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleSubUVBase_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UParticleModuleSubUVBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UParticleModuleSubUVBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UParticleModuleSubUVBase, 1676581712);
