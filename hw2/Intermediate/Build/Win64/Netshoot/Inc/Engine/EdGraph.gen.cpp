...
static struct FScriptStruct_Engine_StaticRegisterNativesFGraphReference
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGraphReference>(FName(TEXT("GraphReference")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FGraphReference_Hash() { return 2712577060U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_Nodes = { "Nodes", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEdGraph, Nodes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEdGraph_Statics::NewProp_Nodes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEdGraph_Statics::NewProp_Nodes_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UEdGraph, 719158652);
