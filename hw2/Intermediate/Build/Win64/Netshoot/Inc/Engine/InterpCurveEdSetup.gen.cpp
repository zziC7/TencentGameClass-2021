...
static struct FScriptStruct_Engine_StaticRegisterNativesFCurveEdTab
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCurveEdTab>(FName(TEXT("CurveEdTab")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCurveEdTab_Statics::NewProp_Curves = { "Curves", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveEdTab, Curves), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveEdTab_Statics::NewProp_Curves_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveEdTab_Statics::NewProp_Curves_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCurveEdTab_Statics::NewProp_ViewStartInput = { "ViewStartInput", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveEdTab, ViewStartInput), METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveEdTab_Statics::NewProp_ViewStartInput_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveEdTab_Statics::NewProp_ViewStartInput_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FCurveEdTab_Hash() { return 4062792390U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFCurveEdEntry
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCurveEdEntry>(FName(TEXT("CurveEdEntry")));
	}
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FCurveEdEntry_Statics::NewProp_bHideCurve = { "bHideCurve", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveEdEntry, bHideCurve), METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveEdEntry_Statics::NewProp_bHideCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveEdEntry_Statics::NewProp_bHideCurve_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FCurveEdEntry_Statics::NewProp_bClamp = { "bClamp", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveEdEntry, bClamp), METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveEdEntry_Statics::NewProp_bClamp_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveEdEntry_Statics::NewProp_bClamp_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCurveEdEntry_Statics::NewProp_ClampHigh = { "ClampHigh", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveEdEntry, ClampHigh), METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveEdEntry_Statics::NewProp_ClampHigh_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveEdEntry_Statics::NewProp_ClampHigh_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FCurveEdEntry_Hash() { return 2377284206U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInterpCurveEdSetup_Statics::NewProp_Tabs = { "Tabs", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpCurveEdSetup, Tabs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInterpCurveEdSetup_Statics::NewProp_Tabs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpCurveEdSetup_Statics::NewProp_Tabs_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UInterpCurveEdSetup_Statics::NewProp_ActiveTab_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Engine/InterpCurveEdSetup.h" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UInterpCurveEdSetup_Statics::NewProp_ActiveTab = { "ActiveTab", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpCurveEdSetup, ActiveTab), METADATA_PARAMS(Z_Construct_UClass_UInterpCurveEdSetup_Statics::NewProp_ActiveTab_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpCurveEdSetup_Statics::NewProp_ActiveTab_MetaData)) };
	...
	IMPLEMENT_CLASS(UInterpCurveEdSetup, 901341735);
