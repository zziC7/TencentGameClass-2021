...
static struct FScriptStruct_Engine_StaticRegisterNativesFSourceEffectChainEntry
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSourceEffectChainEntry>(FName(TEXT("SourceEffectChainEntry")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSourceEffectChainEntry_Hash() { return 3974580655U; }
	...
	IMPLEMENT_CLASS(USoundEffectSourcePreset, 2423475930);
	...
	IMPLEMENT_CLASS(USoundEffectSourcePresetChain, 3780834800);
