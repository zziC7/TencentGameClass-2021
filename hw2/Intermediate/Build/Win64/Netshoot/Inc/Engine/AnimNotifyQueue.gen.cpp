...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNotifyQueue
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNotifyQueue>(FName(TEXT("AnimNotifyQueue")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimNotifyQueue_Statics::NewProp_AnimNotifies = { "AnimNotifies", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyQueue, AnimNotifies), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyQueue_Statics::NewProp_AnimNotifies_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyQueue_Statics::NewProp_AnimNotifies_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FAnimNotifyQueue_Statics::NewProp_UnfilteredMontageAnimNotifies = { "UnfilteredMontageAnimNotifies", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyQueue, UnfilteredMontageAnimNotifies), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyQueue_Statics::NewProp_UnfilteredMontageAnimNotifies_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyQueue_Statics::NewProp_UnfilteredMontageAnimNotifies_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNotifyQueue_Hash() { return 4001157511U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNotifyArray
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNotifyArray>(FName(TEXT("AnimNotifyArray")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNotifyArray_Hash() { return 4221901861U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNotifyEventReference
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNotifyEventReference>(FName(TEXT("AnimNotifyEventReference")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNotifyEventReference_Hash() { return 1460070965U; }
