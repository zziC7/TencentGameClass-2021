...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBrushComponent_Statics::NewProp_Brush = { "Brush", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBrushComponent, Brush), Z_Construct_UClass_UModel, METADATA_PARAMS(Z_Construct_UClass_UBrushComponent_Statics::NewProp_Brush_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBrushComponent_Statics::NewProp_Brush_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBrushComponent_Statics::NewProp_BrushBodySetup = { "BrushBodySetup", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBrushComponent, BrushBodySetup), Z_Construct_UClass_UBodySetup_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBrushComponent_Statics::NewProp_BrushBodySetup_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBrushComponent_Statics::NewProp_BrushBodySetup_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBrushComponent_Statics::NewProp_PrePivot = { "PrePivot", nullptr, (EPropertyFlags)0x0010000820000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBrushComponent, PrePivot_DEPRECATED), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UBrushComponent_Statics::NewProp_PrePivot_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBrushComponent_Statics::NewProp_PrePivot_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(UBrushComponent, 2120373826);
