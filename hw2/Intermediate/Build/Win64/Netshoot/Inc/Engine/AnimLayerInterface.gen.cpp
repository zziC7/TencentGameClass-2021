...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimLayerInterface_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAnimLayerInterface_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UAnimLayerInterface()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAnimLayerInterface_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAnimLayerInterface, 2212010184);
	template<> ENGINE_API UClass* StaticClass<UAnimLayerInterface>()
	{
		return UAnimLayerInterface::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAnimLayerInterface(Z_Construct_UClass_UAnimLayerInterface, &UAnimLayerInterface::StaticClass, TEXT("/Script/Engine"), TEXT("UAnimLayerInterface"), false, nullptr, nullptr, nullptr);
