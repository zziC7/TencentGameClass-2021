...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_Min = { "Min", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDistributionVectorUniform, Min), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_Min_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_Min_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bLockAxes = { "bLockAxes", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UDistributionVectorUniform), &Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bLockAxes_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bLockAxes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDistributionVectorUniform_Statics::NewProp_bLockAxes_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UDistributionVectorUniform, 4226296938);
