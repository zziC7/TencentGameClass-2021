...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ELocationSkelVertSurfaceSource_Hash() { return 2029146273U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParticleModuleLocationSkelVertSurface_Statics::NewProp_ValidAssociatedBones = { "ValidAssociatedBones", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleLocationSkelVertSurface, ValidAssociatedBones), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleLocationSkelVertSurface_Statics::NewProp_ValidAssociatedBones_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleLocationSkelVertSurface_Statics::NewProp_ValidAssociatedBones_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UParticleModuleLocationSkelVertSurface, 1155284226);
