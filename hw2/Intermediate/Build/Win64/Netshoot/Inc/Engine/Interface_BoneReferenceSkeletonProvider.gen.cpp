...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBoneReferenceSkeletonProvider_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBoneReferenceSkeletonProvider_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UBoneReferenceSkeletonProvider()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UBoneReferenceSkeletonProvider_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UBoneReferenceSkeletonProvider, 3283860166);
	template<> ENGINE_API UClass* StaticClass<UBoneReferenceSkeletonProvider>()
	{
		return UBoneReferenceSkeletonProvider::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UBoneReferenceSkeletonProvider(Z_Construct_UClass_UBoneReferenceSkeletonProvider, &UBoneReferenceSkeletonProvider::StaticClass, TEXT("/Script/Engine"), TEXT("UBoneReferenceSkeletonProvider"), false, nullptr, nullptr, nullptr);
