...
static struct FScriptStruct_Engine_StaticRegisterNativesFStreamingLevelsToConsider
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStreamingLevelsToConsider>(FName(TEXT("StreamingLevelsToConsider")));
	}
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FStreamingLevelsToConsider_Statics::NewProp_StreamingLevels_Inner = { "StreamingLevels", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_ULevelStreaming_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FStreamingLevelsToConsider_Hash() { return 694778412U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFLevelCollection
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLevelCollection>(FName(TEXT("LevelCollection")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FLevelCollection_Hash() { return 2319948921U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFEndPhysicsTickFunction
{
	...
	{
		UScriptStruct::DeferCppStructOps<FEndPhysicsTickFunction>(FName(TEXT("EndPhysicsTickFunction")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStartPhysicsTickFunction
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStartPhysicsTickFunction>(FName(TEXT("StartPhysicsTickFunction")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFLevelViewportInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLevelViewportInfo>(FName(TEXT("LevelViewportInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FLevelViewportInfo_Hash() { return 2743847587U; }
...
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PhysicsField_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_PhysicsField;
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ComponentsThatNeedPreEndOfFrameSync_ElementProp;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ComponentsThatNeedPreEndOfFrameSync_MetaData[];
#endif
		static const UE4CodeGen_Private::FSetPropertyParams NewProp_ComponentsThatNeedPreEndOfFrameSync;
...
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWorld_Statics::NewProp_PhysicsField_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UWorld_Statics::NewProp_PhysicsField = { "PhysicsField", nullptr, (EPropertyFlags)0x0010000000082008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWorld, PhysicsField), Z_Construct_UClass_UPhysicsFieldComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UWorld_Statics::NewProp_PhysicsField_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorld_Statics::NewProp_PhysicsField_MetaData)) };
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWorld_Statics::NewProp_ComponentsThatNeedPreEndOfFrameSync_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FSetPropertyParams Z_Construct_UClass_UWorld_Statics::NewProp_ComponentsThatNeedPreEndOfFrameSync = { "ComponentsThatNeedPreEndOfFrameSync", nullptr, (EPropertyFlags)0x0040008400002008, UE4CodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWorld, ComponentsThatNeedPreEndOfFrameSync), METADATA_PARAMS(Z_Construct_UClass_UWorld_Statics::NewProp_ComponentsThatNeedPreEndOfFrameSync_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorld_Statics::NewProp_ComponentsThatNeedPreEndOfFrameSync_MetaData)) };
...
#endif // WITH_EDITORONLY_DATA
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWorld_Statics::NewProp_PhysicsField,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWorld_Statics::NewProp_ComponentsThatNeedPreEndOfFrameSync_ElementProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UWorld_Statics::NewProp_ComponentsThatNeedPreEndOfFrameSync,
	...
	IMPLEMENT_CLASS(UWorld, 2745230619);
