...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundNodeEditorData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSoundNodeEditorData>(FName(TEXT("SoundNodeEditorData")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundCue_Statics::NewProp_PitchMultiplier = { "PitchMultiplier", nullptr, (EPropertyFlags)0x0010010000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundCue, PitchMultiplier), METADATA_PARAMS(Z_Construct_UClass_USoundCue_Statics::NewProp_PitchMultiplier_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundCue_Statics::NewProp_PitchMultiplier_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USoundCue, 88368345);
