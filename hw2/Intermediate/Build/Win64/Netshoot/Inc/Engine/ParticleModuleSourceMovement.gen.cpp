...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSourceMovement_Statics::NewProp_SourceMovementScale = { "SourceMovementScale", nullptr, (EPropertyFlags)0x0010008000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleSourceMovement, SourceMovementScale), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSourceMovement_Statics::NewProp_SourceMovementScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSourceMovement_Statics::NewProp_SourceMovementScale_MetaData)) };
	...
	IMPLEMENT_CLASS(UParticleModuleSourceMovement, 1649504240);
