...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDeviceProfileManager_Statics::NewProp_Profiles = { "Profiles", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDeviceProfileManager, Profiles), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UDeviceProfileManager_Statics::NewProp_Profiles_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDeviceProfileManager_Statics::NewProp_Profiles_MetaData)) };
	...
	IMPLEMENT_CLASS(UDeviceProfileManager, 4278589723);
