...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimSingleNodeInstanceProxy
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimSingleNodeInstanceProxy>(FName(TEXT("AnimSingleNodeInstanceProxy")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNode_SingleNode
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_SingleNode>(FName(TEXT("AnimNode_SingleNode")));
	}
