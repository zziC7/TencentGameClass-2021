...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USoundNodeMixer_Statics::NewProp_InputVolume = { "InputVolume", nullptr, (EPropertyFlags)0x0010000000000049, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeMixer, InputVolume), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_USoundNodeMixer_Statics::NewProp_InputVolume_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeMixer_Statics::NewProp_InputVolume_MetaData)) };
	...
	IMPLEMENT_CLASS(USoundNodeMixer, 578754469);
