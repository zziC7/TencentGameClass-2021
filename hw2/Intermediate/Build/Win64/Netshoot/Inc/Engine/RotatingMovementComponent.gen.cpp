...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_RotationRate = { "RotationRate", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URotatingMovementComponent, RotationRate), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_RotationRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_RotationRate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_PivotTranslation = { "PivotTranslation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URotatingMovementComponent, PivotTranslation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_PivotTranslation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_PivotTranslation_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_bRotationInLocalSpace = { "bRotationInLocalSpace", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(URotatingMovementComponent), &Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_bRotationInLocalSpace_SetBit, METADATA_PARAMS(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_bRotationInLocalSpace_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URotatingMovementComponent_Statics::NewProp_bRotationInLocalSpace_MetaData)) };
	...
	IMPLEMENT_CLASS(URotatingMovementComponent, 59224649);
