...
static struct FScriptStruct_Engine_StaticRegisterNativesFBoolTrackKey
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBoolTrackKey>(FName(TEXT("BoolTrackKey")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBoolTrackKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBoolTrackKey, Time), METADATA_PARAMS(Z_Construct_UScriptStruct_FBoolTrackKey_Statics::NewProp_Time_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBoolTrackKey_Statics::NewProp_Time_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FBoolTrackKey_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FBoolTrackKey), &Z_Construct_UScriptStruct_FBoolTrackKey_Statics::NewProp_Value_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FBoolTrackKey_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBoolTrackKey_Statics::NewProp_Value_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FBoolTrackKey_Hash() { return 2664574653U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInterpTrackBoolProp_Statics::NewProp_BoolTrack = { "BoolTrack", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackBoolProp, BoolTrack), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackBoolProp_Statics::NewProp_BoolTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackBoolProp_Statics::NewProp_BoolTrack_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UInterpTrackBoolProp_Statics::NewProp_PropertyName = { "PropertyName", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackBoolProp, PropertyName), METADATA_PARAMS(Z_Construct_UClass_UInterpTrackBoolProp_Statics::NewProp_PropertyName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackBoolProp_Statics::NewProp_PropertyName_MetaData)) };
	...
	IMPLEMENT_CLASS(UInterpTrackBoolProp, 2707284162);
