...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FFieldPathPropertyParams NewProp_InterpProperty;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFieldPathPropertyParams Z_Construct_UClass_UInterpTrackInstProperty_Statics::NewProp_InterpProperty = { "InterpProperty", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::FieldPath, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackInstProperty, InterpProperty), &FProperty::StaticClass, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackInstProperty_Statics::NewProp_InterpProperty_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackInstProperty_Statics::NewProp_InterpProperty_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInterpTrackInstProperty, 373858767);
