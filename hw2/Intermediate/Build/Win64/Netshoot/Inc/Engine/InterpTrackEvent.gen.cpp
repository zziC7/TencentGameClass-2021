...
static struct FScriptStruct_Engine_StaticRegisterNativesFEventTrackKey
{
	...
	{
		UScriptStruct::DeferCppStructOps<FEventTrackKey>(FName(TEXT("EventTrackKey")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FEventTrackKey_Hash() { return 1713162319U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInterpTrackEvent_Statics::NewProp_EventTrack = { "EventTrack", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackEvent, EventTrack), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackEvent_Statics::NewProp_EventTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackEvent_Statics::NewProp_EventTrack_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UInterpTrackEvent_Statics::NewProp_bFireEventsWhenForwards = { "bFireEventsWhenForwards", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UInterpTrackEvent), &Z_Construct_UClass_UInterpTrackEvent_Statics::NewProp_bFireEventsWhenForwards_SetBit, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackEvent_Statics::NewProp_bFireEventsWhenForwards_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackEvent_Statics::NewProp_bFireEventsWhenForwards_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInterpTrackEvent, 3824064592);
