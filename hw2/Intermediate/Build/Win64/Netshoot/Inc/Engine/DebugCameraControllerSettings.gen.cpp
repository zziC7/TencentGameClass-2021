...
static struct FScriptStruct_Engine_StaticRegisterNativesFDebugCameraControllerSettingsViewModeIndex
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDebugCameraControllerSettingsViewModeIndex>(FName(TEXT("DebugCameraControllerSettingsViewModeIndex")));
	}
	...
	IMPLEMENT_CLASS(UDebugCameraControllerSettings, 1699977275);
