...
static_assert(std::is_polymorphic<FAtmospherePrecomputeInstanceData>() == std::is_polymorphic<FSceneComponentInstanceData>(), "USTRUCT FAtmospherePrecomputeInstanceData cannot be polymorphic unless super FSceneComponentInstanceData is polymorphic");
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAtmospherePrecomputeInstanceData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAtmospherePrecomputeInstanceData>(FName(TEXT("AtmospherePrecomputeInstanceData")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAtmospherePrecomputeParameters
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAtmospherePrecomputeParameters>(FName(TEXT("AtmospherePrecomputeParameters")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAtmospherePrecomputeParameters_Hash() { return 263517827U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAtmosphericFogComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAtmosphericFogComponent_SetPrecomputeParams, "SetPrecomputeParams" }, // 462354126
	...
	IMPLEMENT_CLASS(UAtmosphericFogComponent, 555603449);
