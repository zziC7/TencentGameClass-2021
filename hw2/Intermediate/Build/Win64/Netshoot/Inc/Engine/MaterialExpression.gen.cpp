...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UScriptStruct_FMaterialAttributesInput_Hash() { return 4097839925U; }
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FExpressionInput_Statics::Struct_MetaDataParams[] = {
		{ "Comment", "//@warning: FExpressionInput is mirrored in MaterialExpressionIO.h and manually \"subclassed\" in Material.h (FMaterialInput)\n" },
		{ "ModuleRelativePath", "Classes/Materials/MaterialExpression.h" },
		{ "ToolTip", "@warning: FExpressionInput is mirrored in MaterialExpressionIO.h and manually \"subclassed\" in Material.h (FMaterialInput)" },
	};
#endif
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FExpressionInput_Statics::NewProp_InputName = { "InputName", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExpressionInput, InputName), METADATA_PARAMS(Z_Construct_UScriptStruct_FExpressionInput_Statics::NewProp_InputName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExpressionInput_Statics::NewProp_InputName_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FExpressionInput_Hash() { return 707820292U; }
