...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreamingTimeThreshold = { "TilesStreamingTimeThreshold", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWorldComposition, TilesStreamingTimeThreshold), METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreamingTimeThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreamingTimeThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_RebaseOriginDistance = { "RebaseOriginDistance", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWorldComposition, RebaseOriginDistance), METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_RebaseOriginDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_RebaseOriginDistance_MetaData)) };
	...
	IMPLEMENT_CLASS(UWorldComposition, 4238703788);
