...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionParticleSubUVProperties_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionParticleSubUVProperties_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMaterialExpressionParticleSubUVProperties()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMaterialExpressionParticleSubUVProperties_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMaterialExpressionParticleSubUVProperties, 1559727038);
	template<> ENGINE_API UClass* StaticClass<UMaterialExpressionParticleSubUVProperties>()
	{
		return UMaterialExpressionParticleSubUVProperties::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMaterialExpressionParticleSubUVProperties(Z_Construct_UClass_UMaterialExpressionParticleSubUVProperties, &UMaterialExpressionParticleSubUVProperties::StaticClass, TEXT("/Script/Engine"), TEXT("UMaterialExpressionParticleSubUVProperties"), false, nullptr, nullptr, nullptr);
