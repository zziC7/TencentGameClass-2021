...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimationRecordingSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimationRecordingSettings>(FName(TEXT("AnimationRecordingSettings")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bRecordCurves_MetaData[];
#endif
		static void NewProp_bRecordCurves_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bRecordCurves;
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_TangentMode = { "TangentMode", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimationRecordingSettings, TangentMode), Z_Construct_UEnum_Engine_ERichCurveTangentMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_TangentMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_TangentMode_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_bRecordTransforms_MetaData[] = {
		{ "Category", "Settings" },
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_bRecordCurves_MetaData[] = {
		{ "Category", "Settings" },
		{ "Comment", "/** Whether or not to record curves*/" },
		{ "ModuleRelativePath", "Classes/Animation/AnimationRecordingSettings.h" },
		{ "ToolTip", "Whether or not to record curves" },
	};
#endif
	void Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_bRecordCurves_SetBit(void* Obj)
	{
		((FAnimationRecordingSettings*)Obj)->bRecordCurves = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_bRecordCurves = { "bRecordCurves", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimationRecordingSettings), &Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_bRecordCurves_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_bRecordCurves_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_bRecordCurves_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_bRecordTransforms,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimationRecordingSettings_Statics::NewProp_bRecordCurves,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimationRecordingSettings_Hash() { return 1009133249U; }
