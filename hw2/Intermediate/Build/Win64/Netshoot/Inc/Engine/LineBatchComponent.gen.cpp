...
static struct FScriptStruct_Engine_StaticRegisterNativesFBatchedPoint
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBatchedPoint>(FName(TEXT("BatchedPoint")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBatchedPoint_Statics::NewProp_PointSize = { "PointSize", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBatchedPoint, PointSize), METADATA_PARAMS(Z_Construct_UScriptStruct_FBatchedPoint_Statics::NewProp_PointSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBatchedPoint_Statics::NewProp_PointSize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBatchedPoint_Statics::NewProp_RemainingLifeTime = { "RemainingLifeTime", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBatchedPoint, RemainingLifeTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FBatchedPoint_Statics::NewProp_RemainingLifeTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBatchedPoint_Statics::NewProp_RemainingLifeTime_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FBatchedPoint_Hash() { return 1909710405U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFBatchedLine
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBatchedLine>(FName(TEXT("BatchedLine")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBatchedLine_Hash() { return 958452517U; }
	...
	IMPLEMENT_CLASS(ULineBatchComponent, 272901041);
