...
static struct FScriptStruct_Engine_StaticRegisterNativesFKSphereElem
{
	...
	{
		UScriptStruct::DeferCppStructOps<FKSphereElem>(FName(TEXT("KSphereElem")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKSphereElem_Statics::NewProp_TM = { "TM", nullptr, (EPropertyFlags)0x0010000820000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKSphereElem, TM_DEPRECATED), Z_Construct_UScriptStruct_FMatrix, METADATA_PARAMS(Z_Construct_UScriptStruct_FKSphereElem_Statics::NewProp_TM_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKSphereElem_Statics::NewProp_TM_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FKSphereElem_Hash() { return 1040343008U; }
