...
static struct FScriptStruct_Engine_StaticRegisterNativesFNavAvoidanceData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNavAvoidanceData>(FName(TEXT("NavAvoidanceData")));
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAvoidanceManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAvoidanceManager_GetAvoidanceVelocityForComponent, "GetAvoidanceVelocityForComponent" }, // 1813821058
		...
		{ &Z_Construct_UFunction_UAvoidanceManager_RegisterMovementComponent, "RegisterMovementComponent" }, // 3690618840
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAvoidanceManager, 3760182868);
