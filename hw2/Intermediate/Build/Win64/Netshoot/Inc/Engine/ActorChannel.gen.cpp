...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UActorChannel_Statics::NewProp_CreateSubObjects = { "CreateSubObjects", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UActorChannel, CreateSubObjects), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UActorChannel_Statics::NewProp_CreateSubObjects_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UActorChannel_Statics::NewProp_CreateSubObjects_MetaData)) };
	...
	IMPLEMENT_CLASS(UActorChannel, 1312919258);
