...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDamageType_Statics::NewProp_bCausedByWorld = { "bCausedByWorld", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UDamageType), &Z_Construct_UClass_UDamageType_Statics::NewProp_bCausedByWorld_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDamageType_Statics::NewProp_bCausedByWorld_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDamageType_Statics::NewProp_bCausedByWorld_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDamageType_Statics::NewProp_bRadialDamageVelChange = { "bRadialDamageVelChange", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UDamageType), &Z_Construct_UClass_UDamageType_Statics::NewProp_bRadialDamageVelChange_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDamageType_Statics::NewProp_bRadialDamageVelChange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDamageType_Statics::NewProp_bRadialDamageVelChange_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDamageType_Statics::NewProp_DamageImpulse = { "DamageImpulse", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDamageType, DamageImpulse), METADATA_PARAMS(Z_Construct_UClass_UDamageType_Statics::NewProp_DamageImpulse_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDamageType_Statics::NewProp_DamageImpulse_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDamageType_Statics::NewProp_DestructibleImpulse = { "DestructibleImpulse", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDamageType, DestructibleImpulse), METADATA_PARAMS(Z_Construct_UClass_UDamageType_Statics::NewProp_DestructibleImpulse_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDamageType_Statics::NewProp_DestructibleImpulse_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDamageType_Statics::NewProp_DamageFalloff = { "DamageFalloff", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDamageType, DamageFalloff), METADATA_PARAMS(Z_Construct_UClass_UDamageType_Statics::NewProp_DamageFalloff_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDamageType_Statics::NewProp_DamageFalloff_MetaData)) };
	...
	IMPLEMENT_CLASS(UDamageType, 1409546822);
