...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_USoundNodeSwitch_Statics::NewProp_IntParameterName = { "IntParameterName", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeSwitch, IntParameterName), METADATA_PARAMS(Z_Construct_UClass_USoundNodeSwitch_Statics::NewProp_IntParameterName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeSwitch_Statics::NewProp_IntParameterName_MetaData)) };
	...
	IMPLEMENT_CLASS(USoundNodeSwitch, 2074648131);
