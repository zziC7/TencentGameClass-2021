...
static struct FScriptStruct_Engine_StaticRegisterNativesFPassiveSoundMixModifier
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPassiveSoundMixModifier>(FName(TEXT("PassiveSoundMixModifier")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPassiveSoundMixModifier_Hash() { return 1202623760U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundClassProperties
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSoundClassProperties>(FName(TEXT("SoundClassProperties")));
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSoundClassProperties_Statics::NewProp_ModulationSettings_MetaData[] = {
		{ "Category", "Modulation" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSoundClassProperties_Statics::NewProp_ModulationSettings = { "ModulationSettings", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSoundClassProperties, ModulationSettings), Z_Construct_UScriptStruct_FSoundModulationDefaultSettings, METADATA_PARAMS(Z_Construct_UScriptStruct_FSoundClassProperties_Statics::NewProp_ModulationSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundClassProperties_Statics::NewProp_ModulationSettings_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSoundClassProperties_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSoundClassProperties_Statics::NewProp_ModulationSettings,
	...
	uint32 Get_Z_Construct_UScriptStruct_FSoundClassProperties_Hash() { return 1182485513U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundClassEditorData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSoundClassEditorData>(FName(TEXT("SoundClassEditorData")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USoundClass_Statics::NewProp_ParentClass = { "ParentClass", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundClass, ParentClass), Z_Construct_UClass_USoundClass_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USoundClass_Statics::NewProp_ParentClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundClass_Statics::NewProp_ParentClass_MetaData)) };
	...
	IMPLEMENT_CLASS(USoundClass, 4238535885);
