...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ALightmassPortal_Statics::NewProp_PortalComponent = { "PortalComponent", nullptr, (EPropertyFlags)0x00400000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALightmassPortal, PortalComponent), Z_Construct_UClass_ULightmassPortalComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ALightmassPortal_Statics::NewProp_PortalComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALightmassPortal_Statics::NewProp_PortalComponent_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ALightmassPortal, 2595538245);
