...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCameraAnim_Statics::NewProp_CameraInterpGroup = { "CameraInterpGroup", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCameraAnim, CameraInterpGroup), Z_Construct_UClass_UInterpGroup_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCameraAnim_Statics::NewProp_CameraInterpGroup_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraAnim_Statics::NewProp_CameraInterpGroup_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCameraAnim_Statics::NewProp_BoundingBox = { "BoundingBox", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCameraAnim, BoundingBox), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(Z_Construct_UClass_UCameraAnim_Statics::NewProp_BoundingBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraAnim_Statics::NewProp_BoundingBox_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCameraAnim_Statics::NewProp_bRelativeToInitialTransform = { "bRelativeToInitialTransform", nullptr, (EPropertyFlags)0x0010000000010001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UCameraAnim), &Z_Construct_UClass_UCameraAnim_Statics::NewProp_bRelativeToInitialTransform_SetBit, METADATA_PARAMS(Z_Construct_UClass_UCameraAnim_Statics::NewProp_bRelativeToInitialTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraAnim_Statics::NewProp_bRelativeToInitialTransform_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCameraAnim_Statics::NewProp_bRelativeToInitialFOV = { "bRelativeToInitialFOV", nullptr, (EPropertyFlags)0x0010000000010001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UCameraAnim), &Z_Construct_UClass_UCameraAnim_Statics::NewProp_bRelativeToInitialFOV_SetBit, METADATA_PARAMS(Z_Construct_UClass_UCameraAnim_Statics::NewProp_bRelativeToInitialFOV_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraAnim_Statics::NewProp_bRelativeToInitialFOV_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCameraAnim_Statics::NewProp_BaseFOV = { "BaseFOV", nullptr, (EPropertyFlags)0x0010000000010001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCameraAnim, BaseFOV), METADATA_PARAMS(Z_Construct_UClass_UCameraAnim_Statics::NewProp_BaseFOV_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraAnim_Statics::NewProp_BaseFOV_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCameraAnim, 961608684);
