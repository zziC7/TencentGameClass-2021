...
static struct FScriptStruct_Engine_StaticRegisterNativesFAutoCompleteNode
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAutoCompleteNode>(FName(TEXT("AutoCompleteNode")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAutoCompleteNode_Hash() { return 3686439510U; }
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_White = { "DefaultTexture_White", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConsole, DefaultTexture_White), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_White_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_White_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UConsole_Statics::NewProp_HistoryBuffer = { "HistoryBuffer", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConsole, HistoryBuffer), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UConsole_Statics::NewProp_HistoryBuffer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsole_Statics::NewProp_HistoryBuffer_MetaData)) };
	...
	IMPLEMENT_CLASS(UConsole, 1970401411);
