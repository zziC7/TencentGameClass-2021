...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ENotifyTriggerMode_Hash() { return 763319779U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EBlendSpaceAxis_Hash() { return 1792246699U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFPerBoneInterpolation
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPerBoneInterpolation>(FName(TEXT("PerBoneInterpolation")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPerBoneInterpolation_Hash() { return 3932175270U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFGridBlendSample
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGridBlendSample>(FName(TEXT("GridBlendSample")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FGridBlendSample_Hash() { return 2876853827U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFEditorElement
{
	...
	{
		UScriptStruct::DeferCppStructOps<FEditorElement>(FName(TEXT("EditorElement")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FEditorElement_Hash() { return 168638897U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFBlendSample
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBlendSample>(FName(TEXT("BlendSample")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBlendSample_Hash() { return 1026887242U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFBlendParameter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBlendParameter>(FName(TEXT("BlendParameter")));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlendParameter_Statics::NewProp_Min_MetaData[] = {
		{ "Category", "BlendParameter" },
		{ "Comment", "/** Min value for this parameter. */" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlendParameter_Statics::NewProp_Max_MetaData[] = {
		{ "Category", "BlendParameter" },
		{ "Comment", "/** Max value for this parameter. */" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlendParameter_Statics::NewProp_GridNum_MetaData[] = {
		{ "Category", "BlendParameter" },
		{ "ClampMin", "1" },
		{ "Comment", "/** The number of grid divisions for this parameter (axis). */" },
	...
	uint32 Get_Z_Construct_UScriptStruct_FBlendParameter_Hash() { return 3977352986U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFInterpolationParameter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FInterpolationParameter>(FName(TEXT("InterpolationParameter")));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FInterpolationParameter_Statics::NewProp_InterpolationTime_MetaData[] = {
		{ "Category", "Parameter" },
		{ "Comment", "/** Interpolation Time for input, when it gets input, it will use this time to interpolate to target, used for smoother interpolation. */" },
		{ "ModuleRelativePath", "Classes/Animation/BlendSpaceBase.h" },
	...
	uint32 Get_Z_Construct_UScriptStruct_FInterpolationParameter_Hash() { return 1999696565U; }
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_bRotationBlendInMeshSpace_MetaData[] = {
		{ "Comment", "/**\n\x09* When you use blend per bone, allows rotation to blend in mesh space. This only works if this does not contain additive animation samples\n\x09* This is more performance intensive\n\x09*/" },
		{ "ModuleRelativePath", "Classes/Animation/BlendSpaceBase.h" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_InterpolationParam_MetaData[] = {
		...
		{ "Comment", "/** Input interpolation parameter for all 3 axis, for each axis input, decide how you'd like to interpolate input to*/" },
		{ "ModuleRelativePath", "Classes/Animation/BlendSpaceBase.h" },
		{ "ToolTip", "Input interpolation parameter for all 3 axis, for each axis input, decide how you'd like to interpolate input to" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_InterpolationParam = { "InterpolationParam", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, CPP_ARRAY_DIM(InterpolationParam, UBlendSpaceBase), STRUCT_OFFSET(UBlendSpaceBase, InterpolationParam), Z_Construct_UScriptStruct_FInterpolationParameter, METADATA_PARAMS(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_InterpolationParam_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_InterpolationParam_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_TargetWeightInterpolationSpeedPerSec_MetaData[] = {
		...
		{ "Comment", "/**\n\x09* Target weight interpolation. When target samples are set, how fast you'd like to get to target. Improve target blending.\n\x09* i.e. for locomotion, if you interpolate input, when you move from left to right rapidly, you'll interpolate through forward, but if you use target weight interpolation,\n\x09* you'll skip forward, but interpolate between left to right\n\x09*/" },
		{ "ModuleRelativePath", "Classes/Animation/BlendSpaceBase.h" },
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_NotifyTriggerMode = { "NotifyTriggerMode", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpaceBase, NotifyTriggerMode), Z_Construct_UEnum_Engine_ENotifyTriggerMode, METADATA_PARAMS(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_NotifyTriggerMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_NotifyTriggerMode_MetaData)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_PerBoneBlend_MetaData[] = {
		{ "Category", "SampleInterpolation" },
		{ "Comment", "/**\n\x09* Define target weight interpolation per bone. This will blend in different speed per each bone setting\n\x09*/" },
		{ "ModuleRelativePath", "Classes/Animation/BlendSpaceBase.h" },
		{ "ToolTip", "Define target weight interpolation per bone. This will blend in different speed per each bone setting" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_PerBoneBlend = { "PerBoneBlend", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpaceBase, PerBoneBlend), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_PerBoneBlend_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_PerBoneBlend_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_SampleIndexWithMarkers = { "SampleIndexWithMarkers", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpaceBase, SampleIndexWithMarkers), METADATA_PARAMS(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_SampleIndexWithMarkers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_SampleIndexWithMarkers_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_SampleData = { "SampleData", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpaceBase, SampleData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_SampleData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_SampleData_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_GridSamples = { "GridSamples", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpaceBase, GridSamples), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_GridSamples_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpaceBase_Statics::NewProp_GridSamples_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBlendSpaceBase_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpaceBase_Statics::PropPointers),
		0,
		0x008800A1u,
		METADATA_PARAMS(Z_Construct_UClass_UBlendSpaceBase_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpaceBase_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UBlendSpaceBase, 306388468);
