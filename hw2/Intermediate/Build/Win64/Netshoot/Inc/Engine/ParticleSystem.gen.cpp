...
static struct FScriptStruct_Engine_StaticRegisterNativesFNamedEmitterMaterial
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNamedEmitterMaterial>(FName(TEXT("NamedEmitterMaterial")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFLODSoloTrack
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLODSoloTrack>(FName(TEXT("LODSoloTrack")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFParticleSystemLOD
{
	...
	{
		UScriptStruct::DeferCppStructOps<FParticleSystemLOD>(FName(TEXT("ParticleSystemLOD")));
	}
