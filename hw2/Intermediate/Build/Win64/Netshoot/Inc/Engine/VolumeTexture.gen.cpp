...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVolumeTexture_Statics::NewProp_Source2DTileSizeX = { "Source2DTileSizeX", nullptr, (EPropertyFlags)0x0010000800000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVolumeTexture, Source2DTileSizeX), METADATA_PARAMS(Z_Construct_UClass_UVolumeTexture_Statics::NewProp_Source2DTileSizeX_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVolumeTexture_Statics::NewProp_Source2DTileSizeX_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UVolumeTexture_Statics::NewProp_Source2DTileSizeY = { "Source2DTileSizeY", nullptr, (EPropertyFlags)0x0010000800000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVolumeTexture, Source2DTileSizeY), METADATA_PARAMS(Z_Construct_UClass_UVolumeTexture_Statics::NewProp_Source2DTileSizeY_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVolumeTexture_Statics::NewProp_Source2DTileSizeY_MetaData)) };
	...
	IMPLEMENT_CLASS(UVolumeTexture, 2659008079);
