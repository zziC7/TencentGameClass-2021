...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ETextureColorChannel_Hash() { return 708524888U; }
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Threshold = { "Threshold", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionAntialiasedTextureMask, Threshold), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Threshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Threshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Channel = { "Channel", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionAntialiasedTextureMask, Channel), Z_Construct_UEnum_Engine_ETextureColorChannel, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Channel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Channel_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialExpressionAntialiasedTextureMask, 2493469685);
