...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_SubImageIndex = { "SubImageIndex", nullptr, (EPropertyFlags)0x0010008000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleSubUV, SubImageIndex), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_SubImageIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSubUV_Statics::NewProp_SubImageIndex_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UParticleModuleSubUV, 4251141018);
