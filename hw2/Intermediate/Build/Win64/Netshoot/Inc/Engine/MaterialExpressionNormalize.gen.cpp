...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionNormalize_Statics::NewProp_VectorInput = { "VectorInput", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionNormalize, VectorInput), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionNormalize_Statics::NewProp_VectorInput_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionNormalize_Statics::NewProp_VectorInput_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialExpressionNormalize, 3924665892);
