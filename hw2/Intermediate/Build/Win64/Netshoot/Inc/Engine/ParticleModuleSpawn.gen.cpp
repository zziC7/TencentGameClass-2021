...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_RateScale = { "RateScale", nullptr, (EPropertyFlags)0x0010008000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleSpawn, RateScale), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_RateScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_RateScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstList = { "BurstList", nullptr, (EPropertyFlags)0x0010000002000009, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleSpawn, BurstList), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstList_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstList_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstScale = { "BurstScale", nullptr, (EPropertyFlags)0x0010008000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleSpawn, BurstScale), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawn_Statics::NewProp_BurstScale_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UParticleModuleSpawn, 2398977411);
