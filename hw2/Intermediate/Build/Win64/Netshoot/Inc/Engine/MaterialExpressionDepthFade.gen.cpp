...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionDepthFade_Statics::NewProp_FadeDistance = { "FadeDistance", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionDepthFade, FadeDistance), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionDepthFade_Statics::NewProp_FadeDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionDepthFade_Statics::NewProp_FadeDistance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionDepthFade_Statics::NewProp_OpacityDefault = { "OpacityDefault", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionDepthFade, OpacityDefault), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionDepthFade_Statics::NewProp_OpacityDefault_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionDepthFade_Statics::NewProp_OpacityDefault_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionDepthFade_Statics::NewProp_FadeDistanceDefault = { "FadeDistanceDefault", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionDepthFade, FadeDistanceDefault), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionDepthFade_Statics::NewProp_FadeDistanceDefault_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionDepthFade_Statics::NewProp_FadeDistanceDefault_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialExpressionDepthFade, 1541542194);
