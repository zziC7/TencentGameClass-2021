...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDistributionVectorParticleParameter_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDistributionVectorParticleParameter_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UDistributionVectorParticleParameter()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDistributionVectorParticleParameter_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UDistributionVectorParticleParameter, 3087420584);
	template<> ENGINE_API UClass* StaticClass<UDistributionVectorParticleParameter>()
	{
		return UDistributionVectorParticleParameter::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UDistributionVectorParticleParameter(Z_Construct_UClass_UDistributionVectorParticleParameter, &UDistributionVectorParticleParameter::StaticClass, TEXT("/Script/Engine"), TEXT("UDistributionVectorParticleParameter"), false, nullptr, nullptr, nullptr);
