...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UInterpTrackLinearColorProp_Statics::NewProp_PropertyName = { "PropertyName", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackLinearColorProp, PropertyName), METADATA_PARAMS(Z_Construct_UClass_UInterpTrackLinearColorProp_Statics::NewProp_PropertyName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackLinearColorProp_Statics::NewProp_PropertyName_MetaData)) };
	...
	IMPLEMENT_CLASS(UInterpTrackLinearColorProp, 2966745329);
