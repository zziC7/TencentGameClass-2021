...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionPreSkinnedLocalBounds_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionPreSkinnedLocalBounds_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMaterialExpressionPreSkinnedLocalBounds()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMaterialExpressionPreSkinnedLocalBounds_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMaterialExpressionPreSkinnedLocalBounds, 1833971097);
	template<> ENGINE_API UClass* StaticClass<UMaterialExpressionPreSkinnedLocalBounds>()
	{
		return UMaterialExpressionPreSkinnedLocalBounds::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMaterialExpressionPreSkinnedLocalBounds(Z_Construct_UClass_UMaterialExpressionPreSkinnedLocalBounds, &UMaterialExpressionPreSkinnedLocalBounds::StaticClass, TEXT("/Script/Engine"), TEXT("UMaterialExpressionPreSkinnedLocalBounds"), false, nullptr, nullptr, nullptr);
