...
static struct FScriptStruct_Engine_StaticRegisterNativesFBuilderPoly
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBuilderPoly>(FName(TEXT("BuilderPoly")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FBuilderPoly_Statics::NewProp_VertexIndices = { "VertexIndices", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBuilderPoly, VertexIndices), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FBuilderPoly_Statics::NewProp_VertexIndices_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBuilderPoly_Statics::NewProp_VertexIndices_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FBuilderPoly_Hash() { return 873913078U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBrushBuilder_Statics::NewProp_Vertices = { "Vertices", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBrushBuilder, Vertices), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBrushBuilder_Statics::NewProp_Vertices_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBrushBuilder_Statics::NewProp_Vertices_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBrushBuilder_Statics::NewProp_Polys = { "Polys", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBrushBuilder, Polys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBrushBuilder_Statics::NewProp_Polys_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBrushBuilder_Statics::NewProp_Polys_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UBrushBuilder, 2200453029);
