...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DeepShadowLayerDistribution_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_DeepShadowLayerDistribution;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULightComponentBase_Statics::NewProp_DeepShadowLayerDistribution_MetaData[] = {
		{ "Category", "Light" },
		{ "ClampMax", "1.0" },
		{ "ClampMin", "0.0" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULightComponentBase_Statics::NewProp_DeepShadowLayerDistribution = { "DeepShadowLayerDistribution", nullptr, (EPropertyFlags)0x0010040000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULightComponentBase, DeepShadowLayerDistribution), METADATA_PARAMS(Z_Construct_UClass_ULightComponentBase_Statics::NewProp_DeepShadowLayerDistribution_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULightComponentBase_Statics::NewProp_DeepShadowLayerDistribution_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULightComponentBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULightComponentBase_Statics::NewProp_DeepShadowLayerDistribution,
	...
	IMPLEMENT_CLASS(ULightComponentBase, 1577547693);
