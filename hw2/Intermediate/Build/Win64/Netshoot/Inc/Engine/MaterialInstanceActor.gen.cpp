...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AMaterialInstanceActor_Statics::NewProp_TargetActors = { "TargetActors", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMaterialInstanceActor, TargetActors), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AMaterialInstanceActor_Statics::NewProp_TargetActors_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMaterialInstanceActor_Statics::NewProp_TargetActors_MetaData)) };
	...
	IMPLEMENT_CLASS(AMaterialInstanceActor, 526407055);
