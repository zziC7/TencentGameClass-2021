...
static struct FScriptStruct_Engine_StaticRegisterNativesFKeyHandleLookupTable
{
	...
	{
		UScriptStruct::DeferCppStructOps<FKeyHandleLookupTable>(FName(TEXT("KeyHandleLookupTable")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FKeyHandleLookupTable_Hash() { return 3232286079U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFKeyHandleMap
{
	...
	{
		UScriptStruct::DeferCppStructOps<FKeyHandleMap>(FName(TEXT("KeyHandleMap")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FKeyHandleMap_Hash() { return 191813862U; }
