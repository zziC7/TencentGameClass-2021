...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionDeltaTime_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionDeltaTime_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMaterialExpressionDeltaTime()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMaterialExpressionDeltaTime_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMaterialExpressionDeltaTime, 656185086);
	template<> ENGINE_API UClass* StaticClass<UMaterialExpressionDeltaTime>()
	{
		return UMaterialExpressionDeltaTime::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMaterialExpressionDeltaTime(Z_Construct_UClass_UMaterialExpressionDeltaTime, &UMaterialExpressionDeltaTime::StaticClass, TEXT("/Script/Engine"), TEXT("UMaterialExpressionDeltaTime"), false, nullptr, nullptr, nullptr);
