...
static struct FScriptStruct_Engine_StaticRegisterNativesFRawDistributionFloat
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRawDistributionFloat>(FName(TEXT("RawDistributionFloat")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FRawDistributionFloat_Statics::NewProp_Distribution = { "Distribution", nullptr, (EPropertyFlags)0x0010000002080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRawDistributionFloat, Distribution), Z_Construct_UClass_UDistributionFloat_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FRawDistributionFloat_Statics::NewProp_Distribution_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRawDistributionFloat_Statics::NewProp_Distribution_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FRawDistributionFloat_Hash() { return 437518523U; }
	...
	uint32 Get_Z_Construct_UScriptStruct_FFloatDistribution_Hash() { return 3960344701U; }
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDistributionFloat_Statics::NewProp_bCanBeBaked = { "bCanBeBaked", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UDistributionFloat), &Z_Construct_UClass_UDistributionFloat_Statics::NewProp_bCanBeBaked_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDistributionFloat_Statics::NewProp_bCanBeBaked_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDistributionFloat_Statics::NewProp_bCanBeBaked_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UDistributionFloat, 1680245954);
