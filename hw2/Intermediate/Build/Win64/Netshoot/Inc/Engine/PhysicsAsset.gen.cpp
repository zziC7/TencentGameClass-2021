...
// End Cross Module References
	static UEnum* EPhysicsAssetSolverType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Engine_EPhysicsAssetSolverType, Z_Construct_UPackage__Script_Engine(), TEXT("EPhysicsAssetSolverType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EPhysicsAssetSolverType(EPhysicsAssetSolverType_StaticEnum, TEXT("/Script/Engine"), TEXT("EPhysicsAssetSolverType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Engine_EPhysicsAssetSolverType_Hash() { return 4186130174U; }
	UEnum* Z_Construct_UEnum_Engine_EPhysicsAssetSolverType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EPhysicsAssetSolverType"), 0, Get_Z_Construct_UEnum_Engine_EPhysicsAssetSolverType_Hash(), false);
#else
...
static struct FScriptStruct_Engine_StaticRegisterNativesFPhysicalAnimationProfile
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPhysicalAnimationProfile>(FName(TEXT("PhysicalAnimationProfile")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPhysicalAnimationProfile_Hash() { return 2709423838U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFSolverIterations
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSolverIterations>(FName(TEXT("SolverIterations")));
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_FixedTimeStep_MetaData[] = {
		{ "Category", "SolverSettings" },
		{ "ClampMin", "0" },
		{ "Comment", "/**\n\x09 * [Chaos Only]\n\x09 * The recommended fixed timestep for the solver if supported (e.g., in RigidBody Anim Node). 0 to run with variable timestep.\n\x09 * NOTE: If this value is non-zero and less than the current frame time, physics will step multiple times.\n\x09 */" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/PhysicsAsset.h" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_FixedTimeStep = { "FixedTimeStep", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSolverIterations, FixedTimeStep), METADATA_PARAMS(Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_FixedTimeStep_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_FixedTimeStep_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSolverIterations_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_FixedTimeStep,
	...
	uint32 Get_Z_Construct_UScriptStruct_FSolverIterations_Hash() { return 1133605546U; }
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverIterations_MetaData[] = {
		{ "Category", "SolverSettings" },
		{ "Comment", "/** [Chaos Only] Recommended solver settings. */" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/PhysicsAsset.h" },
		{ "ToolTip", "[Chaos Only] Recommended solver settings." },
	};
#endif
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverType_MetaData[] = {
		{ "Category", "SolverSettings" },
		{ "Comment", "/** [Chaos Only] Solver type used in physics asset editor. */" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/PhysicsAsset.h" },
		{ "ToolTip", "[Chaos Only] Solver type used in physics asset editor." },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverType = { "SolverType", nullptr, (EPropertyFlags)0x0010040000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, SolverType), Z_Construct_UEnum_Engine_EPhysicsAssetSolverType, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverType_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPhysicsAsset_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverType_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverType,
	...
	IMPLEMENT_CLASS(UPhysicsAsset, 3711361742);
	...
	IMPLEMENT_CLASS(USkeletalBodySetup, 1503070728);
