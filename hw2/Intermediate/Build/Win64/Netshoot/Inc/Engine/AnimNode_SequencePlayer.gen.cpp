...
static_assert(std::is_polymorphic<FAnimNode_SequencePlayer>() == std::is_polymorphic<FAnimNode_AssetPlayerBase>(), "USTRUCT FAnimNode_SequencePlayer cannot be polymorphic unless super FAnimNode_AssetPlayerBase is polymorphic");
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimNode_SequencePlayer
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_SequencePlayer>(FName(TEXT("AnimNode_SequencePlayer")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Hash() { return 332547938U; }
