...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_VirtualTextureComponent = { "VirtualTextureComponent", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARuntimeVirtualTextureVolume, VirtualTextureComponent), Z_Construct_UClass_URuntimeVirtualTextureComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_VirtualTextureComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_VirtualTextureComponent_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_Box = { "Box", nullptr, (EPropertyFlags)0x0010000800082008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARuntimeVirtualTextureVolume, Box), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_Box_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_Box_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(ARuntimeVirtualTextureVolume, 811871809);
