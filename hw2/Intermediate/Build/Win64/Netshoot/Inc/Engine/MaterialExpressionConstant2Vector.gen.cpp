...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_R = { "R", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionConstant2Vector, R), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_R_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_R_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_G = { "G", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionConstant2Vector, G), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_G_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionConstant2Vector_Statics::NewProp_G_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialExpressionConstant2Vector, 671625672);
