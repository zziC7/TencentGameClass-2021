...
static struct FScriptStruct_Engine_StaticRegisterNativesFVirtualTextureSpacePoolConfig
{
	...
	{
		UScriptStruct::DeferCppStructOps<FVirtualTextureSpacePoolConfig>(FName(TEXT("VirtualTextureSpacePoolConfig")));
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_ScalabilityGroup_MetaData[] = {
		{ "Comment", "/** Scalability group index that gives the size scale. */" },
		{ "ModuleRelativePath", "Classes/VT/VirtualTexturePoolConfig.h" },
		{ "ToolTip", "Scalability group index that gives the size scale." },
	};
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_ScalabilityGroup = { "ScalabilityGroup", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FVirtualTextureSpacePoolConfig, ScalabilityGroup), METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_ScalabilityGroup_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_ScalabilityGroup_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Statics::NewProp_ScalabilityGroup,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FVirtualTextureSpacePoolConfig_Hash() { return 2411407710U; }
	...
	IMPLEMENT_CLASS(UVirtualTexturePoolConfig, 3791005908);
