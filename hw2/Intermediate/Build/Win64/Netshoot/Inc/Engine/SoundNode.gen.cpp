...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USoundNode_Statics::NewProp_ChildNodes = { "ChildNodes", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNode, ChildNodes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_USoundNode_Statics::NewProp_ChildNodes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNode_Statics::NewProp_ChildNodes_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USoundNode, 3010808973);
