...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Synthesis_ESubmixEffectConvolutionReverbBlockSize_Hash() { return 3314554739U; }
...
static struct FScriptStruct_Synthesis_StaticRegisterNativesFSubmixEffectConvolutionReverbSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSubmixEffectConvolutionReverbSettings>(FName(TEXT("SubmixEffectConvolutionReverbSettings")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bMixInputChannelFormatToImpulseResponseFormat_MetaData[];
#endif
		static void NewProp_bMixInputChannelFormatToImpulseResponseFormat_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bMixInputChannelFormatToImpulseResponseFormat;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bMixReverbOutputToOutputChannelFormat_MetaData[];
#endif
		static void NewProp_bMixReverbOutputToOutputChannelFormat_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bMixReverbOutputToOutputChannelFormat;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bBypass_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bBypass = { "bBypass", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSubmixEffectConvolutionReverbSettings), &Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bBypass_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bBypass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bBypass_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bMixInputChannelFormatToImpulseResponseFormat_MetaData[] = {
		{ "Category", "SubmixEffectPreset" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bMixReverbOutputToOutputChannelFormat = { "bMixReverbOutputToOutputChannelFormat", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSubmixEffectConvolutionReverbSettings), &Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bMixReverbOutputToOutputChannelFormat_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bMixReverbOutputToOutputChannelFormat_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bMixReverbOutputToOutputChannelFormat_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bBypass,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bMixInputChannelFormatToImpulseResponseFormat,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Statics::NewProp_bMixReverbOutputToOutputChannelFormat,
	...
	uint32 Get_Z_Construct_UScriptStruct_FSubmixEffectConvolutionReverbSettings_Hash() { return 1832777091U; }
	...
	struct Z_Construct_UClass_UAudioImpulseResponse_Statics
	{
		...
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_NormalizationVolumeDb;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bTrueStereo_MetaData[];
#endif
		static void NewProp_bTrueStereo_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bTrueStereo;
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAudioImpulseResponse_Statics::NewProp_NormalizationVolumeDb = { "NormalizationVolumeDb", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAudioImpulseResponse, NormalizationVolumeDb), METADATA_PARAMS(Z_Construct_UClass_UAudioImpulseResponse_Statics::NewProp_NormalizationVolumeDb_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAudioImpulseResponse_Statics::NewProp_NormalizationVolumeDb_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAudioImpulseResponse_Statics::NewProp_bTrueStereo_MetaData[] = {
		{ "Category", "SubmixEffectPreset" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAudioImpulseResponse_Statics::NewProp_bTrueStereo = { "bTrueStereo", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAudioImpulseResponse), &Z_Construct_UClass_UAudioImpulseResponse_Statics::NewProp_bTrueStereo_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAudioImpulseResponse_Statics::NewProp_bTrueStereo_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAudioImpulseResponse_Statics::NewProp_bTrueStereo_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAudioImpulseResponse_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAudioImpulseResponse_Statics::NewProp_bTrueStereo,
	...
	IMPLEMENT_CLASS(UAudioImpulseResponse, 2728682519);
	...
	IMPLEMENT_CLASS(USubmixEffectConvolutionReverbPreset, 2275180548);
