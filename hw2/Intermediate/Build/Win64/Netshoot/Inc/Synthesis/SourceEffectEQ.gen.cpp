...
static struct FScriptStruct_Synthesis_StaticRegisterNativesFSourceEffectEQSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSourceEffectEQSettings>(FName(TEXT("SourceEffectEQSettings")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSourceEffectEQSettings_Hash() { return 705413312U; }
...
static struct FScriptStruct_Synthesis_StaticRegisterNativesFSourceEffectEQBand
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSourceEffectEQBand>(FName(TEXT("SourceEffectEQBand")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSourceEffectEQBand_Hash() { return 4224383932U; }
