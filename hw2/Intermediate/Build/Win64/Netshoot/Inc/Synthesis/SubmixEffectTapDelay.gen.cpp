...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Synthesis_ETapLineMode_Hash() { return 3941351200U; }
...
static struct FScriptStruct_Synthesis_StaticRegisterNativesFSubmixEffectTapDelaySettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSubmixEffectTapDelaySettings>(FName(TEXT("SubmixEffectTapDelaySettings")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSubmixEffectTapDelaySettings_Hash() { return 643591388U; }
...
static struct FScriptStruct_Synthesis_StaticRegisterNativesFTapDelayInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FTapDelayInfo>(FName(TEXT("TapDelayInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FTapDelayInfo_Hash() { return 1347142734U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USubmixEffectTapDelayPreset_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_USubmixEffectTapDelayPreset_GetTap, "GetTap" }, // 3982157510
		{ &Z_Construct_UFunction_USubmixEffectTapDelayPreset_GetTapIds, "GetTapIds" }, // 1776970122
		...
		{ &Z_Construct_UFunction_USubmixEffectTapDelayPreset_SetTap, "SetTap" }, // 3600718596
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USubmixEffectTapDelayPreset, 4031088738);
