...
// End Cross Module References
	static UEnum* EStereoDelayFiltertype_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_EStereoDelayFiltertype, Z_Construct_UPackage__Script_Synthesis(), TEXT("EStereoDelayFiltertype"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EStereoDelayFiltertype(EStereoDelayFiltertype_StaticEnum, TEXT("/Script/Synthesis"), TEXT("EStereoDelayFiltertype"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Synthesis_EStereoDelayFiltertype_Hash() { return 3085280668U; }
	UEnum* Z_Construct_UEnum_Synthesis_EStereoDelayFiltertype()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Synthesis();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EStereoDelayFiltertype"), 0, Get_Z_Construct_UEnum_Synthesis_EStereoDelayFiltertype_Hash(), false);
#else
	...
	uint32 Get_Z_Construct_UEnum_Synthesis_EStereoDelaySourceEffect_Hash() { return 1915539605U; }
...
static struct FScriptStruct_Synthesis_StaticRegisterNativesFSourceEffectStereoDelaySettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSourceEffectStereoDelaySettings>(FName(TEXT("SourceEffectStereoDelaySettings")));
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_DryLevel_MetaData[] = {
		{ "Category", "SourceEffect|Preset" },
		{ "ClampMax", "1.0" },
		{ "ClampMin", "0.0" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_DryLevel = { "DryLevel", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectStereoDelaySettings, DryLevel), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_DryLevel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_DryLevel_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_bFilterEnabled_MetaData[] = {
		{ "Category", "SourceEffect|Preset" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_bFilterEnabled = { "bFilterEnabled", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSourceEffectStereoDelaySettings), &Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_bFilterEnabled_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_bFilterEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_bFilterEnabled_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterType_MetaData[] = {
		{ "Category", "SourceEffect|Preset" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterType = { "FilterType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectStereoDelaySettings, FilterType), Z_Construct_UEnum_Synthesis_EStereoDelayFiltertype, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterType_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterFrequency_MetaData[] = {
		{ "Category", "SourceEffect|Preset" },
		{ "ClampMax", "20000" },
		{ "ClampMin", "20.0" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterFrequency = { "FilterFrequency", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectStereoDelaySettings, FilterFrequency), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterFrequency_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterFrequency_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterQ_MetaData[] = {
		{ "Category", "SourceEffect|Preset" },
		{ "ClampMax", "10.0" },
		{ "ClampMin", "0.5" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterQ = { "FilterQ", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectStereoDelaySettings, FilterQ), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterQ_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterQ_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_DryLevel,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_bFilterEnabled,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterType_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterType,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterFrequency,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Statics::NewProp_FilterQ,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FSourceEffectStereoDelaySettings_Hash() { return 777231370U; }
