...
static struct FScriptStruct_Paper2D_StaticRegisterNativesFPaperTileSetTerrain
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPaperTileSetTerrain>(FName(TEXT("PaperTileSetTerrain")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPaperTileSetTerrain_Hash() { return 148499889U; }
...
static struct FScriptStruct_Paper2D_StaticRegisterNativesFPaperTileMetadata
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPaperTileMetadata>(FName(TEXT("PaperTileMetadata")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPaperTileMetadata_Hash() { return 3560900384U; }
	...
	IMPLEMENT_CLASS(UPaperTileSet, 2909299257);
