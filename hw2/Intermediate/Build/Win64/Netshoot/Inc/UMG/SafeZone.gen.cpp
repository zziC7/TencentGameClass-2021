...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USafeZone_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USafeZone_SetSidesToPad, "SetSidesToPad" }, // 395926272
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USafeZone_Statics::NewProp_PadTop = { "PadTop", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USafeZone), &Z_Construct_UClass_USafeZone_Statics::NewProp_PadTop_SetBit, METADATA_PARAMS(Z_Construct_UClass_USafeZone_Statics::NewProp_PadTop_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USafeZone_Statics::NewProp_PadTop_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USafeZone_Statics::NewProp_PadBottom = { "PadBottom", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USafeZone), &Z_Construct_UClass_USafeZone_Statics::NewProp_PadBottom_SetBit, METADATA_PARAMS(Z_Construct_UClass_USafeZone_Statics::NewProp_PadBottom_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USafeZone_Statics::NewProp_PadBottom_MetaData)) };
	...
	IMPLEMENT_CLASS(USafeZone, 1094371210);
