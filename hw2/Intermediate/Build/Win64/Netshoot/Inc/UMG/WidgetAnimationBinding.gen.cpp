...
static struct FScriptStruct_UMG_StaticRegisterNativesFWidgetAnimationBinding
{
	...
	{
		UScriptStruct::DeferCppStructOps<FWidgetAnimationBinding>(FName(TEXT("WidgetAnimationBinding")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_WidgetName = { "WidgetName", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWidgetAnimationBinding, WidgetName), METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_WidgetName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_WidgetName_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FWidgetAnimationBinding_Hash() { return 1393981752U; }
