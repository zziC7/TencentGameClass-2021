...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::NewProp_Content = { "Content", nullptr, (EPropertyFlags)0x0010000000080080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Overlay_eventAddChildToOverlay_Parms, Content), Z_Construct_UClass_UWidget_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::NewProp_Content_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UOverlay_AddChildToOverlay_Statics::NewProp_Content_MetaData)) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOverlay_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOverlay_AddChildToOverlay, "AddChildToOverlay" }, // 137314708
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UOverlay, 4117419962);
