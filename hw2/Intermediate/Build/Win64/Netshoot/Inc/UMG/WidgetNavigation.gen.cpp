...
static struct FScriptStruct_UMG_StaticRegisterNativesFWidgetNavigationData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FWidgetNavigationData>(FName(TEXT("WidgetNavigationData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FWidgetNavigationData_Hash() { return 2329812523U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Up = { "Up", nullptr, (EPropertyFlags)0x0010008000000015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Up), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Up_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Up_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Left = { "Left", nullptr, (EPropertyFlags)0x0010008000000015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Left), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Left_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Left_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Right = { "Right", nullptr, (EPropertyFlags)0x0010008000000015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Right), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Right_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Right_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Previous = { "Previous", nullptr, (EPropertyFlags)0x0010008000000015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Previous), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Previous_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Previous_MetaData)) };
	...
	IMPLEMENT_CLASS(UWidgetNavigation, 2063500064);
