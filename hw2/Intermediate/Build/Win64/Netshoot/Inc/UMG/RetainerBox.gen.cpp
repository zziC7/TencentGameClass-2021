...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URetainerBox_GetEffectMaterial_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URetainerBox, nullptr, "GetEffectMaterial", nullptr, nullptr, sizeof(RetainerBox_eventGetEffectMaterial_Parms), Z_Construct_UFunction_URetainerBox_GetEffectMaterial_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URetainerBox_GetEffectMaterial_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URetainerBox_GetEffectMaterial_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_URetainerBox_GetEffectMaterial_Statics::Function_MetaDataParams)) };
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URetainerBox_SetEffectMaterial_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URetainerBox, nullptr, "SetEffectMaterial", nullptr, nullptr, sizeof(RetainerBox_eventSetEffectMaterial_Parms), Z_Construct_UFunction_URetainerBox_SetEffectMaterial_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URetainerBox_SetEffectMaterial_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URetainerBox_SetEffectMaterial_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_URetainerBox_SetEffectMaterial_Statics::Function_MetaDataParams)) };
	...
	struct Z_Construct_UFunction_URetainerBox_SetRenderingPhase_Statics
	{
		...
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_RenderPhase;
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_URetainerBox_SetRenderingPhase_Statics::NewProp_RenderPhase = { "RenderPhase", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RetainerBox_eventSetRenderingPhase_Parms, RenderPhase), METADATA_PARAMS(nullptr, 0) };
	...
	struct Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics
	{
		...
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bInRetainRendering;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::NewProp_bInRetainRendering = { "bInRetainRendering", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(RetainerBox_eventSetRetainRendering_Parms), &Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::NewProp_bInRetainRendering_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::NewProp_bInRetainRendering,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::Function_MetaDataParams[] = {
		{ "Category", "Retainer" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URetainerBox, nullptr, "SetRetainRendering", nullptr, nullptr, sizeof(RetainerBox_eventSetRetainRendering_Parms), Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_URetainerBox_SetRetainRendering()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_URetainerBox_SetRetainRendering_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bRetainRender_MetaData[];
#endif
		static void NewProp_bRetainRender_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bRetainRender;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URetainerBox_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URetainerBox_GetEffectMaterial, "GetEffectMaterial" }, // 2100844690
		{ &Z_Construct_UFunction_URetainerBox_RequestRender, "RequestRender" }, // 152326480
		{ &Z_Construct_UFunction_URetainerBox_SetEffectMaterial, "SetEffectMaterial" }, // 803347249
		{ &Z_Construct_UFunction_URetainerBox_SetRenderingPhase, "SetRenderingPhase" }, // 1637051789
		{ &Z_Construct_UFunction_URetainerBox_SetRetainRendering, "SetRetainRendering" }, // 1502836608
		{ &Z_Construct_UFunction_URetainerBox_SetTextureParameter, "SetTextureParameter" }, // 1608182353
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_URetainerBox_Statics::NewProp_bRetainRender_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_URetainerBox_Statics::NewProp_bRetainRender = { "bRetainRender", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(URetainerBox), &Z_Construct_UClass_URetainerBox_Statics::NewProp_bRetainRender_SetBit, METADATA_PARAMS(Z_Construct_UClass_URetainerBox_Statics::NewProp_bRetainRender_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URetainerBox_Statics::NewProp_bRetainRender_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_URetainerBox_Statics::NewProp_PhaseCount = { "PhaseCount", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URetainerBox, PhaseCount), METADATA_PARAMS(Z_Construct_UClass_URetainerBox_Statics::NewProp_PhaseCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URetainerBox_Statics::NewProp_PhaseCount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_URetainerBox_Statics::NewProp_TextureParameter = { "TextureParameter", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URetainerBox, TextureParameter), METADATA_PARAMS(Z_Construct_UClass_URetainerBox_Statics::NewProp_TextureParameter_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URetainerBox_Statics::NewProp_TextureParameter_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_URetainerBox_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_URetainerBox_Statics::NewProp_bRetainRender,
	...
	IMPLEMENT_CLASS(URetainerBox, 1873657029);
