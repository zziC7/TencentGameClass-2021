...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MenuAnchor_eventGetUserWidget_Parms, ReturnValue), Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::NewProp_ReturnValue_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/Components/MenuAnchor.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMenuAnchor, nullptr, "GetUserWidget__DelegateSignature", nullptr, nullptr, sizeof(MenuAnchor_eventGetUserWidget_Parms), Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00120000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature_Statics::FuncParams);
		}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OnGetUserMenuContentEvent_MetaData[];
#endif
		static const UE4CodeGen_Private::FDelegatePropertyParams NewProp_OnGetUserMenuContentEvent;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenuAnchor_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature, "GetUserWidget__DelegateSignature" }, // 313185148
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMenuAnchor_Statics::NewProp_OnGetUserMenuContentEvent_MetaData[] = {
		{ "Category", "Events" },
...
#endif
	const UE4CodeGen_Private::FDelegatePropertyParams Z_Construct_UClass_UMenuAnchor_Statics::NewProp_OnGetUserMenuContentEvent = { "OnGetUserMenuContentEvent", nullptr, (EPropertyFlags)0x0010000000080001, UE4CodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMenuAnchor, OnGetUserMenuContentEvent), Z_Construct_UDelegateFunction_UMenuAnchor_GetUserWidget__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UMenuAnchor_Statics::NewProp_OnGetUserMenuContentEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMenuAnchor_Statics::NewProp_OnGetUserMenuContentEvent_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMenuAnchor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMenuAnchor_Statics::NewProp_OnGetUserMenuContentEvent,
	...
	IMPLEMENT_CLASS(UMenuAnchor, 2920490393);
