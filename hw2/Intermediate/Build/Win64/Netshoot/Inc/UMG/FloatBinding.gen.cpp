...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UFloatBinding_GetValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UFloatBinding, nullptr, "GetValue", nullptr, nullptr, sizeof(FloatBinding_eventGetValue_Parms), Z_Construct_UFunction_UFloatBinding_GetValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UFloatBinding_GetValue_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x40020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UFloatBinding_GetValue_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UFloatBinding_GetValue_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFloatBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFloatBinding_GetValue, "GetValue" }, // 659089336
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UFloatBinding, 2805223178);
