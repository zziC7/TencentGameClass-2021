...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_NavigationSystem_ERuntimeGenerationType_Hash() { return 4238183239U; }
...
static struct FScriptStruct_NavigationSystem_StaticRegisterNativesFSupportedAreaData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSupportedAreaData>(FName(TEXT("SupportedAreaData")));
	}
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSupportedAreaData_Statics::NewProp_AreaID = { "AreaID", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSupportedAreaData, AreaID), METADATA_PARAMS(Z_Construct_UScriptStruct_FSupportedAreaData_Statics::NewProp_AreaID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSupportedAreaData_Statics::NewProp_AreaID_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FSupportedAreaData_Hash() { return 2697768323U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAutoDestroyWhenNoNavigation_MetaData[];
#endif
		static void NewProp_bAutoDestroyWhenNoNavigation_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAutoDestroyWhenNoNavigation;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANavigationData_Statics::NewProp_bAutoDestroyWhenNoNavigation_MetaData[] = {
		{ "Category", "Runtime" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ANavigationData_Statics::NewProp_bAutoDestroyWhenNoNavigation = { "bAutoDestroyWhenNoNavigation", nullptr, (EPropertyFlags)0x0020080000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ANavigationData), &Z_Construct_UClass_ANavigationData_Statics::NewProp_bAutoDestroyWhenNoNavigation_SetBit, METADATA_PARAMS(Z_Construct_UClass_ANavigationData_Statics::NewProp_bAutoDestroyWhenNoNavigation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANavigationData_Statics::NewProp_bAutoDestroyWhenNoNavigation_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANavigationData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANavigationData_Statics::NewProp_bAutoDestroyWhenNoNavigation,
	...
	IMPLEMENT_CLASS(ANavigationData, 3705187850);
