...
static struct FScriptStruct_NavigationSystem_StaticRegisterNativesFNavGraphNode
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNavGraphNode>(FName(TEXT("NavGraphNode")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewProp_Owner = { "Owner", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNavGraphNode, Owner), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewProp_Owner_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewProp_Owner_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FNavGraphNode_Hash() { return 2727540979U; }
...
static struct FScriptStruct_NavigationSystem_StaticRegisterNativesFNavGraphEdge
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNavGraphEdge>(FName(TEXT("NavGraphEdge")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNavGraphEdge_Hash() { return 3223506723U; }
	...
	IMPLEMENT_CLASS(ANavigationGraph, 2488322887);
