...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFSubjectFrameHandle
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSubjectFrameHandle>(FName(TEXT("SubjectFrameHandle")));
	}
...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFLiveLinkTransform
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLiveLinkTransform>(FName(TEXT("LiveLinkTransform")));
	}
...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFCachedSubjectFrame
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCachedSubjectFrame>(FName(TEXT("CachedSubjectFrame")));
	}
...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFSubjectMetadata
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSubjectMetadata>(FName(TEXT("SubjectMetadata")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSubjectMetadata_Hash() { return 2004020443U; }
