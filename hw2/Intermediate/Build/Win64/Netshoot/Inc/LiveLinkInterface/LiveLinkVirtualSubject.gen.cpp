...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_bRebroadcastSubject_MetaData[] = {
		{ "Category", "LiveLink" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_bRebroadcastSubject = { "bRebroadcastSubject", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ULiveLinkVirtualSubject), &Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_bRebroadcastSubject_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_bRebroadcastSubject_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_bRebroadcastSubject_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULiveLinkVirtualSubject_Statics::NewProp_bRebroadcastSubject,
	};
	...
	IMPLEMENT_CLASS(ULiveLinkVirtualSubject, 3702876033);
