...
static_assert(std::is_polymorphic<FVehicleAnimInstanceProxy>() == std::is_polymorphic<FAnimInstanceProxy>(), "USTRUCT FVehicleAnimInstanceProxy cannot be polymorphic unless super FAnimInstanceProxy is polymorphic");
...
static struct FScriptStruct_PhysXVehicles_StaticRegisterNativesFVehicleAnimInstanceProxy
{
	...
	{
		UScriptStruct::DeferCppStructOps<FVehicleAnimInstanceProxy>(FName(TEXT("VehicleAnimInstanceProxy")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVehicleAnimInstanceProxy_Hash() { return 1811614943U; }
	...
	IMPLEMENT_CLASS(UVehicleAnimInstance, 2987231428);
