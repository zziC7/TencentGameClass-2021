...
static_assert(std::is_polymorphic<FAnimNode_WheelHandler>() == std::is_polymorphic<FAnimNode_SkeletalControlBase>(), "USTRUCT FAnimNode_WheelHandler cannot be polymorphic unless super FAnimNode_SkeletalControlBase is polymorphic");
...
static struct FScriptStruct_PhysXVehicles_StaticRegisterNativesFAnimNode_WheelHandler
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_WheelHandler>(FName(TEXT("AnimNode_WheelHandler")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_WheelHandler_Hash() { return 630953423U; }
