...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_InnerConeAngle_MetaData[] = {
		{ "ModuleRelativePath", "Public/ObjectTemplates/DatasmithSpotLightComponentTemplate.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_InnerConeAngle = { "InnerConeAngle", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithSpotLightComponentTemplate, InnerConeAngle), METADATA_PARAMS(Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_InnerConeAngle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_InnerConeAngle_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_OuterConeAngle_MetaData[] = {
		{ "ModuleRelativePath", "Public/ObjectTemplates/DatasmithSpotLightComponentTemplate.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_OuterConeAngle = { "OuterConeAngle", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithSpotLightComponentTemplate, OuterConeAngle), METADATA_PARAMS(Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_OuterConeAngle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_OuterConeAngle_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_InnerConeAngle,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::NewProp_OuterConeAngle,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UDatasmithSpotLightComponentTemplate()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDatasmithSpotLightComponentTemplate_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UDatasmithSpotLightComponentTemplate, 1252326770);
	template<> DATASMITHCONTENT_API UClass* StaticClass<UDatasmithSpotLightComponentTemplate>()
	{
		return UDatasmithSpotLightComponentTemplate::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UDatasmithSpotLightComponentTemplate(Z_Construct_UClass_UDatasmithSpotLightComponentTemplate, &UDatasmithSpotLightComponentTemplate::StaticClass, TEXT("/Script/DatasmithContent"), TEXT("UDatasmithSpotLightComponentTemplate"), false, nullptr, nullptr, nullptr);
