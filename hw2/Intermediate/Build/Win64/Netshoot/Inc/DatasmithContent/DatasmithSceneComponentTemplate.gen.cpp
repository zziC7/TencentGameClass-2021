...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_bVisible_MetaData[] = {
		{ "ModuleRelativePath", "Public/ObjectTemplates/DatasmithSceneComponentTemplate.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_bVisible = { "bVisible", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UDatasmithSceneComponentTemplate), &Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_bVisible_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_bVisible_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_bVisible_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDatasmithSceneComponentTemplate_Statics::NewProp_bVisible,
	...
	IMPLEMENT_CLASS(UDatasmithSceneComponentTemplate, 1833658177);
