...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithMeshSectionInfoMapTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithMeshSectionInfoMapTemplate>(FName(TEXT("DatasmithMeshSectionInfoMapTemplate")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithMeshSectionInfoMapTemplate_Hash() { return 1594232267U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithMeshSectionInfoTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithMeshSectionInfoTemplate>(FName(TEXT("DatasmithMeshSectionInfoTemplate")));
	}
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithStaticMaterialTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithStaticMaterialTemplate>(FName(TEXT("DatasmithStaticMaterialTemplate")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithStaticMaterialTemplate_Hash() { return 2159823856U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithMeshBuildSettingsTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithMeshBuildSettingsTemplate>(FName(TEXT("DatasmithMeshBuildSettingsTemplate")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithMeshBuildSettingsTemplate_Hash() { return 117259696U; }
	...
	IMPLEMENT_CLASS(UDatasmithStaticMeshTemplate, 3677755295);
