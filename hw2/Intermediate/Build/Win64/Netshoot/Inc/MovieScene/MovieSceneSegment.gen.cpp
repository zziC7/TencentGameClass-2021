...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_MovieScene_ESectionEvaluationFlags_Hash() { return 1617728973U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSegment
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneSegment>(FName(TEXT("MovieSceneSegment")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSegment_Hash() { return 2811168091U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFSectionEvaluationData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSectionEvaluationData>(FName(TEXT("SectionEvaluationData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSectionEvaluationData_Hash() { return 1021381638U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSegmentIdentifier
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneSegmentIdentifier>(FName(TEXT("MovieSceneSegmentIdentifier")));
	}
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier_Statics::NewProp_IdentifierIndex = { "IdentifierIndex", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSegmentIdentifier, IdentifierIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier_Statics::NewProp_IdentifierIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier_Statics::NewProp_IdentifierIndex_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier_Hash() { return 2252373607U; }
