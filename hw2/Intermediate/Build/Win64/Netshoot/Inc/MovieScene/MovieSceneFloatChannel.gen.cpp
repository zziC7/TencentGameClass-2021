...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneFloatChannel
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneFloatChannel>(FName(TEXT("MovieSceneFloatChannel")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneFloatChannel_Statics::NewProp_Times = { "Times", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneFloatChannel, Times), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneFloatChannel_Statics::NewProp_Times_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneFloatChannel_Statics::NewProp_Times_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneFloatChannel_Statics::NewProp_Values = { "Values", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneFloatChannel, Values), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneFloatChannel_Statics::NewProp_Values_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneFloatChannel_Statics::NewProp_Values_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneFloatChannel_Hash() { return 882196163U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneFloatValue
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneFloatValue>(FName(TEXT("MovieSceneFloatValue")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PaddingByte_MetaData[];
#endif
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_PaddingByte;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const UE4CodeGen_Private::FStructParams ReturnStructParams;
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneFloatValue_Statics::NewProp_Tangent = { "Tangent", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneFloatValue, Tangent), Z_Construct_UScriptStruct_FMovieSceneTangentData, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneFloatValue_Statics::NewProp_Tangent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneFloatValue_Statics::NewProp_Tangent_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneFloatValue_Statics::NewProp_PaddingByte_MetaData[] = {
		{ "ModuleRelativePath", "Public/Channels/MovieSceneFloatChannel.h" },
	};
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMovieSceneFloatValue_Statics::NewProp_PaddingByte = { "PaddingByte", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneFloatValue, PaddingByte), nullptr, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneFloatValue_Statics::NewProp_PaddingByte_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneFloatValue_Statics::NewProp_PaddingByte_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FMovieSceneFloatValue_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FMovieSceneFloatValue_Statics::NewProp_PaddingByte,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneFloatValue_Hash() { return 343110753U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneTangentData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneTangentData>(FName(TEXT("MovieSceneTangentData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTangentData_Hash() { return 2752248468U; }
