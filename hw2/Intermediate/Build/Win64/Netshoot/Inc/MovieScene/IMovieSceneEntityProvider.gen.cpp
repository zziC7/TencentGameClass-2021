...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneEntityProvider_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneEntityProvider_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMovieSceneEntityProvider()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMovieSceneEntityProvider_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMovieSceneEntityProvider, 2272612962);
	template<> MOVIESCENE_API UClass* StaticClass<UMovieSceneEntityProvider>()
	{
		return UMovieSceneEntityProvider::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMovieSceneEntityProvider(Z_Construct_UClass_UMovieSceneEntityProvider, &UMovieSceneEntityProvider::StaticClass, TEXT("/Script/MovieScene"), TEXT("UMovieSceneEntityProvider"), false, nullptr, nullptr, nullptr);
