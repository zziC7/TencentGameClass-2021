...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSequenceTransform
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneSequenceTransform>(FName(TEXT("MovieSceneSequenceTransform")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSequenceTransform_Hash() { return 1367420363U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneNestedSequenceTransform
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneNestedSequenceTransform>(FName(TEXT("MovieSceneNestedSequenceTransform")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneNestedSequenceTransform_Hash() { return 1372205392U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneWarpCounter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneWarpCounter>(FName(TEXT("MovieSceneWarpCounter")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneWarpCounter_Hash() { return 1051351781U; }
