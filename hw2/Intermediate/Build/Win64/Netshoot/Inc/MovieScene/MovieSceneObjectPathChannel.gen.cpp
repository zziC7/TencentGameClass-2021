...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneObjectPathChannel
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneObjectPathChannel>(FName(TEXT("MovieSceneObjectPathChannel")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneObjectPathChannel_Hash() { return 2914526705U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneObjectPathChannelKeyValue
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneObjectPathChannelKeyValue>(FName(TEXT("MovieSceneObjectPathChannelKeyValue")));
	}
...
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UScriptStruct_FMovieSceneObjectPathChannelKeyValue_Statics::NewProp_SoftPtr = { "SoftPtr", nullptr, (EPropertyFlags)0x0044000000000000, UE4CodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneObjectPathChannelKeyValue, SoftPtr), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneObjectPathChannelKeyValue_Statics::NewProp_SoftPtr_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneObjectPathChannelKeyValue_Statics::NewProp_SoftPtr_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FMovieSceneObjectPathChannelKeyValue_Statics::NewProp_HardPtr = { "HardPtr", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneObjectPathChannelKeyValue, HardPtr), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneObjectPathChannelKeyValue_Statics::NewProp_HardPtr_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneObjectPathChannelKeyValue_Statics::NewProp_HardPtr_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneObjectPathChannelKeyValue_Hash() { return 4154963754U; }
