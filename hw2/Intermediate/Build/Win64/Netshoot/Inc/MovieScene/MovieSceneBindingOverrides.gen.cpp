...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneBindingOverrideData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneBindingOverrideData>(FName(TEXT("MovieSceneBindingOverrideData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneBindingOverrideData_Hash() { return 3110762678U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneBindingOverrides_Statics::NewProp_BindingData = { "BindingData", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneBindingOverrides, BindingData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneBindingOverrides_Statics::NewProp_BindingData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneBindingOverrides_Statics::NewProp_BindingData_MetaData)) };
	...
	IMPLEMENT_CLASS(UMovieSceneBindingOverrides, 2438944560);
