...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFTestMovieSceneEvalTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FTestMovieSceneEvalTemplate>(FName(TEXT("TestMovieSceneEvalTemplate")));
	}
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UTestMovieSceneTrack_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UTestMovieSceneTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UTestMovieSceneTrack, IMovieSceneTrackTemplateProducer), false },
		};
	...
	IMPLEMENT_CLASS(UTestMovieSceneTrack, 3143817091);
	...
	IMPLEMENT_CLASS(UTestMovieSceneSection, 6756470);
	...
	IMPLEMENT_CLASS(UTestMovieSceneSequence, 3370293636);
	...
	IMPLEMENT_CLASS(UTestMovieSceneSubTrack, 1468193122);
	...
	IMPLEMENT_CLASS(UTestMovieSceneSubSection, 34984217);
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Tests/MovieSceneTestObjects.h" },
		{ "ModuleRelativePath", "Private/Tests/MovieSceneTestObjects.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::NewProp_SectionArray_Inner = { "SectionArray", nullptr, (EPropertyFlags)0x0000000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::NewProp_SectionArray_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Private/Tests/MovieSceneTestObjects.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::NewProp_SectionArray = { "SectionArray", nullptr, (EPropertyFlags)0x0010008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTestMovieSceneEvalHookTrack, SectionArray), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::NewProp_SectionArray_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::NewProp_SectionArray_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::NewProp_SectionArray_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::NewProp_SectionArray,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UTestMovieSceneEvalHookTrack()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UTestMovieSceneEvalHookTrack_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UTestMovieSceneEvalHookTrack, 2082373927);
	template<> MOVIESCENE_API UClass* StaticClass<UTestMovieSceneEvalHookTrack>()
	{
		return UTestMovieSceneEvalHookTrack::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UTestMovieSceneEvalHookTrack(Z_Construct_UClass_UTestMovieSceneEvalHookTrack, &UTestMovieSceneEvalHookTrack::StaticClass, TEXT("/Script/MovieScene"), TEXT("UTestMovieSceneEvalHookTrack"), false, nullptr, nullptr, nullptr);
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTestMovieSceneEvalHookSection_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Tests/MovieSceneTestObjects.h" },
		{ "ModuleRelativePath", "Private/Tests/MovieSceneTestObjects.h" },
		{ "ObjectInitializerConstructorDeclared", "" },
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UTestMovieSceneEvalHookSection_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UTestMovieSceneEvalHookSection()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UTestMovieSceneEvalHookSection_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UTestMovieSceneEvalHookSection, 4125941088);
	template<> MOVIESCENE_API UClass* StaticClass<UTestMovieSceneEvalHookSection>()
	{
		return UTestMovieSceneEvalHookSection::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UTestMovieSceneEvalHookSection(Z_Construct_UClass_UTestMovieSceneEvalHookSection, &UTestMovieSceneEvalHookSection::StaticClass, TEXT("/Script/MovieScene"), TEXT("UTestMovieSceneEvalHookSection"), false, nullptr, nullptr, nullptr);
