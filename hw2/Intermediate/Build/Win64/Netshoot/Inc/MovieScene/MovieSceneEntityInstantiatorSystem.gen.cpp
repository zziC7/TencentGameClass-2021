...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneEntityInstantiatorSystem_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneEntityInstantiatorSystem_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMovieSceneEntityInstantiatorSystem()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMovieSceneEntityInstantiatorSystem_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMovieSceneEntityInstantiatorSystem, 1311667076);
	template<> MOVIESCENE_API UClass* StaticClass<UMovieSceneEntityInstantiatorSystem>()
	{
		return UMovieSceneEntityInstantiatorSystem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMovieSceneEntityInstantiatorSystem(Z_Construct_UClass_UMovieSceneEntityInstantiatorSystem, &UMovieSceneEntityInstantiatorSystem::StaticClass, TEXT("/Script/MovieScene"), TEXT("UMovieSceneEntityInstantiatorSystem"), false, nullptr, nullptr, nullptr);
