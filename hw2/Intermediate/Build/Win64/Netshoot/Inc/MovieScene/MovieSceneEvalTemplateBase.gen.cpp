...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEvalTemplateBase
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneEvalTemplateBase>(FName(TEXT("MovieSceneEvalTemplateBase")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEvalTemplateBase_Hash() { return 1376479557U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneEmptyStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneEmptyStruct>(FName(TEXT("MovieSceneEmptyStruct")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEmptyStruct_Hash() { return 714188648U; }
