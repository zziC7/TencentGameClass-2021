...
static struct FScriptStruct_HeadMountedDisplay_StaticRegisterNativesFXRDeviceId
{
	...
	{
		UScriptStruct::DeferCppStructOps<FXRDeviceId>(FName(TEXT("XRDeviceId")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewProp_SystemName = { "SystemName", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRDeviceId, SystemName), METADATA_PARAMS(Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewProp_SystemName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewProp_SystemName_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FXRDeviceId_Hash() { return 3582653926U; }
