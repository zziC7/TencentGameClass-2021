...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFSlateFontInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSlateFontInfo>(FName(TEXT("SlateFontInfo")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LetterSpacing_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_LetterSpacing;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSlateFontInfo_Statics::NewProp_LetterSpacing_MetaData[] = {
		{ "Category", "SlateStyleRules" },
		{ "ClampMax", "10000" },
		{ "ClampMin", "-1000" },
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSlateFontInfo_Statics::NewProp_LetterSpacing = { "LetterSpacing", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSlateFontInfo, LetterSpacing), METADATA_PARAMS(Z_Construct_UScriptStruct_FSlateFontInfo_Statics::NewProp_LetterSpacing_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSlateFontInfo_Statics::NewProp_LetterSpacing_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSlateFontInfo_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSlateFontInfo_Statics::NewProp_LetterSpacing,
#if WITH_EDITORONLY_DATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FSlateFontInfo_Hash() { return 386307909U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFFontOutlineSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FFontOutlineSettings>(FName(TEXT("FontOutlineSettings")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FFontOutlineSettings_Hash() { return 3479412882U; }
