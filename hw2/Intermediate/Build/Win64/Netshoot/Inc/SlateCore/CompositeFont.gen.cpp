...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EFontLayoutMethod_Hash() { return 2576598053U; }
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EFontLoadingPolicy_Hash() { return 739644139U; }
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_EFontHinting_Hash() { return 1260361610U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFCompositeFont
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCompositeFont>(FName(TEXT("CompositeFont")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FCompositeFont_Hash() { return 4183160232U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFCompositeSubFont
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCompositeSubFont>(FName(TEXT("CompositeSubFont")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FCompositeSubFont_Hash() { return 2054510293U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFCompositeFallbackFont
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCompositeFallbackFont>(FName(TEXT("CompositeFallbackFont")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCompositeFallbackFont_Statics::NewProp_ScalingFactor = { "ScalingFactor", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCompositeFallbackFont, ScalingFactor), METADATA_PARAMS(Z_Construct_UScriptStruct_FCompositeFallbackFont_Statics::NewProp_ScalingFactor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCompositeFallbackFont_Statics::NewProp_ScalingFactor_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FCompositeFallbackFont_Hash() { return 2440299352U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFTypeface
{
	...
	{
		UScriptStruct::DeferCppStructOps<FTypeface>(FName(TEXT("Typeface")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FTypeface_Statics::NewProp_Fonts = { "Fonts", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTypeface, Fonts), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FTypeface_Statics::NewProp_Fonts_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTypeface_Statics::NewProp_Fonts_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FTypeface_Hash() { return 46204506U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFTypefaceEntry
{
	...
	{
		UScriptStruct::DeferCppStructOps<FTypefaceEntry>(FName(TEXT("TypefaceEntry")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FTypefaceEntry_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTypefaceEntry, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FTypefaceEntry_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTypefaceEntry_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FTypefaceEntry_Hash() { return 3143562638U; }
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFFontData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FFontData>(FName(TEXT("FontData")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FFontData_Statics::NewProp_FontData = { "FontData", nullptr, (EPropertyFlags)0x0040000820000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFontData, FontData_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FFontData_Statics::NewProp_FontData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFontData_Statics::NewProp_FontData_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FFontData_Hash() { return 853518962U; }
