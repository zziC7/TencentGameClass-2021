...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_SlateCore_ESlateColorStylingMode_Hash() { return 2834750170U; }
	UEnum* Z_Construct_UEnum_SlateCore_ESlateColorStylingMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "UseColor_Specified_Link.Comment", "/** Color value is stored in the linked color. */" },
				{ "UseColor_Specified_Link.Hidden", "" },
				{ "UseColor_Specified_Link.Name", "ESlateColorStylingMode::UseColor_Specified_Link" },
...
static struct FScriptStruct_SlateCore_StaticRegisterNativesFSlateColor
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSlateColor>(FName(TEXT("SlateColor")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSlateColor_Hash() { return 2846282931U; }
