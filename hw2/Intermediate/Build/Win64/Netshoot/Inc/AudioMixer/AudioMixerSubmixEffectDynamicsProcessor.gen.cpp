...
// End Cross Module References
	static UEnum* ESubmixEffectDynamicsKeySource_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_AudioMixer_ESubmixEffectDynamicsKeySource, Z_Construct_UPackage__Script_AudioMixer(), TEXT("ESubmixEffectDynamicsKeySource"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ESubmixEffectDynamicsKeySource(ESubmixEffectDynamicsKeySource_StaticEnum, TEXT("/Script/AudioMixer"), TEXT("ESubmixEffectDynamicsKeySource"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_AudioMixer_ESubmixEffectDynamicsKeySource_Hash() { return 3096602519U; }
	UEnum* Z_Construct_UEnum_AudioMixer_ESubmixEffectDynamicsKeySource()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_AudioMixer();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ESubmixEffectDynamicsKeySource"), 0, Get_Z_Construct_UEnum_AudioMixer_ESubmixEffectDynamicsKeySource_Hash(), false);
#else
	...
	uint32 Get_Z_Construct_UEnum_AudioMixer_ESubmixEffectDynamicsChannelLinkMode_Hash() { return 3567178768U; }
	...
	uint32 Get_Z_Construct_UEnum_AudioMixer_ESubmixEffectDynamicsPeakMode_Hash() { return 500745712U; }
	...
	uint32 Get_Z_Construct_UEnum_AudioMixer_ESubmixEffectDynamicsProcessorType_Hash() { return 3653793992U; }
...
static struct FScriptStruct_AudioMixer_StaticRegisterNativesFSubmixEffectDynamicsProcessorSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSubmixEffectDynamicsProcessorSettings>(FName(TEXT("SubmixEffectDynamicsProcessorSettings")));
	}
	...
	struct Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_KeySource_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_KeySource_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_KeySource;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ExternalAudioBus_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExternalAudioBus;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_KeySource_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_KeySource_MetaData[] = {
		{ "Category", "Sidechain" },
		{ "EditCondition", "!bBypass" },
		{ "ModuleRelativePath", "Classes/SubmixEffects/AudioMixerSubmixEffectDynamicsProcessor.h" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_KeySource = { "KeySource", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSubmixEffectDynamicsProcessorSettings, KeySource), Z_Construct_UEnum_AudioMixer_ESubmixEffectDynamicsKeySource, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_KeySource_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_KeySource_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_ExternalAudioBus_MetaData[] = {
		{ "Category", "Sidechain" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_ExternalAudioBus = { "ExternalAudioBus", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSubmixEffectDynamicsProcessorSettings, ExternalAudioBus), Z_Construct_UClass_UAudioBus_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_ExternalAudioBus_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_ExternalAudioBus_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_bBypass_MetaData[] = {
		{ "Category", "General" },
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_KeySource_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_KeySource,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_ExternalAudioBus,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Statics::NewProp_bBypass,
	...
	uint32 Get_Z_Construct_UScriptStruct_FSubmixEffectDynamicsProcessorSettings_Hash() { return 4131697919U; }
...
static struct FScriptStruct_AudioMixer_StaticRegisterNativesFSubmixEffectDynamicProcessorFilterSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSubmixEffectDynamicProcessorFilterSettings>(FName(TEXT("SubmixEffectDynamicProcessorFilterSettings")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSubmixEffectDynamicProcessorFilterSettings_Hash() { return 3736066446U; }
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_ResetKey_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Effects" },
		{ "ModuleRelativePath", "Classes/SubmixEffects/AudioMixerSubmixEffectDynamicsProcessor.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_ResetKey_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USubmixEffectDynamicsProcessorPreset, nullptr, "ResetKey", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_ResetKey_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_ResetKey_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_ResetKey()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_ResetKey_Statics::FuncParams);
		}
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::NewProp_AudioBus = { "AudioBus", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SubmixEffectDynamicsProcessorPreset_eventSetAudioBus_Parms, AudioBus), Z_Construct_UClass_UAudioBus_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::NewProp_AudioBus,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Effects" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USubmixEffectDynamicsProcessorPreset, nullptr, "SetAudioBus", nullptr, nullptr, sizeof(SubmixEffectDynamicsProcessorPreset_eventSetAudioBus_Parms), Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USubmixEffectDynamicsProcessorPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_ResetKey, "ResetKey" }, // 1443146477
		{ &Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetAudioBus, "SetAudioBus" }, // 3086251087
		{ &Z_Construct_UFunction_USubmixEffectDynamicsProcessorPreset_SetExternalSubmix, "SetExternalSubmix" }, // 3849283572
	...
	IMPLEMENT_CLASS(USubmixEffectDynamicsProcessorPreset, 1731884816);
