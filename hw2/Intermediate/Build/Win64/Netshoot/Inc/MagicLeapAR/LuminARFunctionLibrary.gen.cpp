...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULuminARSessionFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULuminARSessionFunctionLibrary_StartLuminARSession, "StartLuminARSession" }, // 3063617067
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ULuminARSessionFunctionLibrary, 3740223699);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULuminARFrameFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULuminARFrameFunctionLibrary_GetTrackingState, "GetTrackingState" }, // 2096251318
		{ &Z_Construct_UFunction_ULuminARFrameFunctionLibrary_LuminARLineTrace, "LuminARLineTrace" }, // 2729838538
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ULuminARFrameFunctionLibrary, 3129622531);
	...
	DEFINE_FUNCTION(ULuminARImageTrackingFunctionLibrary::execAddLuminRuntimeCandidateImageEx)
	{
		...
		P_GET_ENUM(EMagicLeapImageTargetOrientation,Z_Param_InAxisOrientation);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(ULuminARCandidateImage**)Z_Param__Result=ULuminARImageTrackingFunctionLibrary::AddLuminRuntimeCandidateImageEx(Z_Param_SessionConfig,Z_Param_CandidateTexture,Z_Param_FriendlyName,Z_Param_PhysicalWidth,Z_Param_bUseUnreliablePose,Z_Param_bImageIsStationary,EMagicLeapImageTargetOrientation(Z_Param_InAxisOrientation));
		P_NATIVE_END;
	}
	...
	void ULuminARImageTrackingFunctionLibrary::StaticRegisterNativesULuminARImageTrackingFunctionLibrary()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "AddLuminRuntimeCandidateImageEx", &ULuminARImageTrackingFunctionLibrary::execAddLuminRuntimeCandidateImageEx },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImage_Statics::Function_MetaDataParams[] = {
		...
		{ "DeprecatedFunction", "" },
		{ "DeprecatedMessage", "Deprecated & will be removed in 0.26.0. Use AddLuminRuntimeCandidateImageEx() instead." },
	...
	struct Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics
	{
		struct LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms
		{
			UARSessionConfig* SessionConfig;
			UTexture2D* CandidateTexture;
			FString FriendlyName;
		...
		static void NewProp_bImageIsStationary_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bImageIsStationary;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_InAxisOrientation_Underlying;
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_InAxisOrientation;
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ReturnValue;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_SessionConfig = { "SessionConfig", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms, SessionConfig), Z_Construct_UClass_UARSessionConfig_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_CandidateTexture = { "CandidateTexture", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms, CandidateTexture), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_FriendlyName = { "FriendlyName", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms, FriendlyName), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_PhysicalWidth = { "PhysicalWidth", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms, PhysicalWidth), METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_bUseUnreliablePose_SetBit(void* Obj)
	{
		((LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms*)Obj)->bUseUnreliablePose = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_bUseUnreliablePose = { "bUseUnreliablePose", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms), &Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_bUseUnreliablePose_SetBit, METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_bImageIsStationary_SetBit(void* Obj)
	{
		((LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms*)Obj)->bImageIsStationary = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_bImageIsStationary = { "bImageIsStationary", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms), &Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_bImageIsStationary_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_InAxisOrientation_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_InAxisOrientation = { "InAxisOrientation", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms, InAxisOrientation), Z_Construct_UEnum_MagicLeapImageTracker_EMagicLeapImageTargetOrientation, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms, ReturnValue), Z_Construct_UClass_ULuminARCandidateImage_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_SessionConfig,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_CandidateTexture,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_FriendlyName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_PhysicalWidth,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_bUseUnreliablePose,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_bImageIsStationary,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_InAxisOrientation_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_InAxisOrientation,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::Function_MetaDataParams[] = {
		{ "Category", "LuminAR|Image Tracking" },
		{ "Keywords", "lumin ar augmentedreality augmented reality candidate image" },
		{ "ModuleRelativePath", "Public/LuminARFunctionLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULuminARImageTrackingFunctionLibrary, nullptr, "AddLuminRuntimeCandidateImageEx", nullptr, nullptr, sizeof(LuminARImageTrackingFunctionLibrary_eventAddLuminRuntimeCandidateImageEx_Parms), Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULuminARImageTrackingFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImage, "AddLuminRuntimeCandidateImage" }, // 3370397945
		{ &Z_Construct_UFunction_ULuminARImageTrackingFunctionLibrary_AddLuminRuntimeCandidateImageEx, "AddLuminRuntimeCandidateImageEx" }, // 856725106
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ULuminARImageTrackingFunctionLibrary, 3072220856);
