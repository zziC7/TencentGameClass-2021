...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_NiagaraShader_FNiagaraCompileEventSeverity_Hash() { return 2732927649U; }
...
static struct FScriptStruct_NiagaraShader_StaticRegisterNativesFNiagaraDataInterfaceGPUParamInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraDataInterfaceGPUParamInfo>(FName(TEXT("NiagaraDataInterfaceGPUParamInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraDataInterfaceGPUParamInfo_Hash() { return 2283553761U; }
...
static struct FScriptStruct_NiagaraShader_StaticRegisterNativesFNiagaraDataInterfaceGeneratedFunction
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraDataInterfaceGeneratedFunction>(FName(TEXT("NiagaraDataInterfaceGeneratedFunction")));
	}
...
static struct FScriptStruct_NiagaraShader_StaticRegisterNativesFNiagaraCompileEvent
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraCompileEvent>(FName(TEXT("NiagaraCompileEvent")));
	}
...
#endif
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_ShortDescription;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDismissable_MetaData[];
#endif
		static void NewProp_bDismissable_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDismissable;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_ShortDescription_MetaData[] = {
		{ "Comment", "/** A short, optional description of the event. */" },
		{ "ModuleRelativePath", "Public/NiagaraShared.h" },
		{ "ToolTip", "A short, optional description of the event." },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_ShortDescription = { "ShortDescription", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraCompileEvent, ShortDescription), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_ShortDescription_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_ShortDescription_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_bDismissable_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_bDismissable = { "bDismissable", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FNiagaraCompileEvent), &Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_bDismissable_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_bDismissable_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_bDismissable_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_ShortDescription,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraCompileEvent_Statics::NewProp_bDismissable,
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraCompileEvent_Hash() { return 3913157914U; }
