...
static struct FScriptStruct_OculusMR_StaticRegisterNativesFTrackedCamera
{
	...
	{
		UScriptStruct::DeferCppStructOps<FTrackedCamera>(FName(TEXT("TrackedCamera")));
	}
...
#endif
		static const UE4CodeGen_Private::FDoublePropertyParams NewProp_UpdateTime;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UpdateTime_MetaData[] = {
		{ "Comment", "/** The time that this camera was updated */" },
		{ "ModuleRelativePath", "Private/OculusMR_State.h" },
		{ "ToolTip", "The time that this camera was updated" },
	};
#endif
	const UE4CodeGen_Private::FDoublePropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UpdateTime = { "UpdateTime", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, UpdateTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UpdateTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UpdateTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_RawRotation = { "RawRotation", nullptr, (EPropertyFlags)0x0010000020000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, RawRotation_DEPRECATED), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_RawRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_RawRotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_RawOffset = { "RawOffset", nullptr, (EPropertyFlags)0x0010000020000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, RawOffset_DEPRECATED), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_RawOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_RawOffset_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FTrackedCamera_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UpdateTime,
	...
	uint32 Get_Z_Construct_UScriptStruct_FTrackedCamera_Hash() { return 3026871728U; }
	...
	IMPLEMENT_CLASS(UOculusMR_State, 4027134573);
