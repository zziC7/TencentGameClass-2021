...
// End Cross Module References
	...
	struct Z_Construct_UClass_AOculusMR_CastingCameraActor_Statics
	{
		...
		static const UE4CodeGen_Private::FDoublePropertyParams NewProp_PoseTimes_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PoseTimes_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_PoseTimes;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FDoublePropertyParams Z_Construct_UClass_AOculusMR_CastingCameraActor_Statics::NewProp_PoseTimes_Inner = { "PoseTimes", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AOculusMR_CastingCameraActor_Statics::NewProp_PoseTimes_MetaData[] = {
		{ "ModuleRelativePath", "Private/OculusMR_CastingCameraActor.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AOculusMR_CastingCameraActor_Statics::NewProp_PoseTimes = { "PoseTimes", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOculusMR_CastingCameraActor, PoseTimes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AOculusMR_CastingCameraActor_Statics::NewProp_PoseTimes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AOculusMR_CastingCameraActor_Statics::NewProp_PoseTimes_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AOculusMR_CastingCameraActor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AOculusMR_CastingCameraActor_Statics::NewProp_PoseTimes_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AOculusMR_CastingCameraActor_Statics::NewProp_PoseTimes,
	...
	IMPLEMENT_CLASS(AOculusMR_CastingCameraActor, 695981721);
