...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneGeometryCollectionTrack_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneGeometryCollectionTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneGeometryCollectionTrack, IMovieSceneTrackTemplateProducer), false },
		};
	...
	IMPLEMENT_CLASS(UMovieSceneGeometryCollectionTrack, 1057188186);
