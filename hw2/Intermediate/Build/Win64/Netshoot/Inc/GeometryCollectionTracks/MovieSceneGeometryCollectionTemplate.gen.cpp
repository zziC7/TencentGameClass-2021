...
static struct FScriptStruct_GeometryCollectionTracks_StaticRegisterNativesFMovieSceneGeometryCollectionSectionTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneGeometryCollectionSectionTemplate>(FName(TEXT("MovieSceneGeometryCollectionSectionTemplate")));
	}
...
static struct FScriptStruct_GeometryCollectionTracks_StaticRegisterNativesFMovieSceneGeometryCollectionSectionTemplateParameters
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneGeometryCollectionSectionTemplateParameters>(FName(TEXT("MovieSceneGeometryCollectionSectionTemplateParameters")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Hash() { return 2228482379U; }
