...
static struct FScriptStruct_AIModule_StaticRegisterNativesFBlackboardEntry
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBlackboardEntry>(FName(TEXT("BlackboardEntry")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_EntryCategory_MetaData[];
#endif
		static const UE4CodeGen_Private::FNamePropertyParams NewProp_EntryCategory;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlackboardEntry_Statics::NewProp_EntryCategory_MetaData[] = {
		{ "Category", "Blackboard" },
		{ "ModuleRelativePath", "Classes/BehaviorTree/BlackboardData.h" },
	};
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FBlackboardEntry_Statics::NewProp_EntryCategory = { "EntryCategory", nullptr, (EPropertyFlags)0x0010000800000001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlackboardEntry, EntryCategory), METADATA_PARAMS(Z_Construct_UScriptStruct_FBlackboardEntry_Statics::NewProp_EntryCategory_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlackboardEntry_Statics::NewProp_EntryCategory_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FBlackboardEntry_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FBlackboardEntry_Statics::NewProp_EntryCategory,
#endif // WITH_EDITORONLY_DATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FBlackboardEntry_Hash() { return 1425533177U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBlackboardData_Statics::NewProp_Keys = { "Keys", nullptr, (EPropertyFlags)0x0010008000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlackboardData, Keys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBlackboardData_Statics::NewProp_Keys_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlackboardData_Statics::NewProp_Keys_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UBlackboardData, 3283800298);
