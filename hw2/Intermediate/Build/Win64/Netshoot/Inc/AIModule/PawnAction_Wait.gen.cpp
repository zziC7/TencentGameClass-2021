...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPawnAction_Wait_Statics::NewProp_TimeToWait = { "TimeToWait", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPawnAction_Wait, TimeToWait), METADATA_PARAMS(Z_Construct_UClass_UPawnAction_Wait_Statics::NewProp_TimeToWait_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPawnAction_Wait_Statics::NewProp_TimeToWait_MetaData)) };
	...
	IMPLEMENT_CLASS(UPawnAction_Wait, 587351124);
