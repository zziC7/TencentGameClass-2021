...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAITeamStimulusEvent
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAITeamStimulusEvent>(FName(TEXT("AITeamStimulusEvent")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAITeamStimulusEvent_Hash() { return 2882193811U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAISense_Team_Statics::NewProp_RegisteredEvents = { "RegisteredEvents", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Team, RegisteredEvents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAISense_Team_Statics::NewProp_RegisteredEvents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Team_Statics::NewProp_RegisteredEvents_MetaData)) };
	...
	IMPLEMENT_CLASS(UAISense_Team, 1325092752);
