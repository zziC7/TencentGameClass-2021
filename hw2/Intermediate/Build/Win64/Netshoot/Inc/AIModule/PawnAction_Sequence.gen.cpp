...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPawnAction_Sequence_Statics::NewProp_ActionSequence = { "ActionSequence", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPawnAction_Sequence, ActionSequence), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPawnAction_Sequence_Statics::NewProp_ActionSequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPawnAction_Sequence_Statics::NewProp_ActionSequence_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UPawnAction_Sequence, 4227423364);
