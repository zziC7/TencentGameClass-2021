...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EBTBlackboardRestart_Hash() { return 734745502U; }
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_IntValue = { "IntValue", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_Blackboard, IntValue), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_IntValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_IntValue_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_FloatValue = { "FloatValue", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_Blackboard, FloatValue), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_FloatValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_FloatValue_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_StringValue = { "StringValue", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_Blackboard, StringValue), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_StringValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_StringValue_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_CachedDescription = { "CachedDescription", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_Blackboard, CachedDescription), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_CachedDescription_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_CachedDescription_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_OperationType = { "OperationType", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_Blackboard, OperationType), nullptr, METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_OperationType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_OperationType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_NotifyObserver = { "NotifyObserver", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_Blackboard, NotifyObserver), Z_Construct_UEnum_AIModule_EBTBlackboardRestart, METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_NotifyObserver_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_NotifyObserver_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_TextOperation = { "TextOperation", nullptr, (EPropertyFlags)0x0020080800000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_Blackboard, TextOperation), Z_Construct_UEnum_AIModule_ETextKeyOperation, METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_TextOperation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Blackboard_Statics::NewProp_TextOperation_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(UBTDecorator_Blackboard, 1211682314);
