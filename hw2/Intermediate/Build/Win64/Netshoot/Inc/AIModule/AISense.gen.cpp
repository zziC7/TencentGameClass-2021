...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISense_Statics::NewProp_DefaultExpirationAge = { "DefaultExpirationAge", nullptr, (EPropertyFlags)0x0020080000024015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense, DefaultExpirationAge), METADATA_PARAMS(Z_Construct_UClass_UAISense_Statics::NewProp_DefaultExpirationAge_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Statics::NewProp_DefaultExpirationAge_MetaData)) };
	...
	IMPLEMENT_CLASS(UAISense, 3653008847);
