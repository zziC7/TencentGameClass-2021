...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTDecorator_TimeLimit_Statics::NewProp_TimeLimit = { "TimeLimit", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_TimeLimit, TimeLimit), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_TimeLimit_Statics::NewProp_TimeLimit_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_TimeLimit_Statics::NewProp_TimeLimit_MetaData)) };
	...
	IMPLEMENT_CLASS(UBTDecorator_TimeLimit, 2741750371);
