...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UAIDataProvider_QueryParams_Statics::NewProp_ParamName = { "ParamName", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAIDataProvider_QueryParams, ParamName), METADATA_PARAMS(Z_Construct_UClass_UAIDataProvider_QueryParams_Statics::NewProp_ParamName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAIDataProvider_QueryParams_Statics::NewProp_ParamName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAIDataProvider_QueryParams_Statics::NewProp_FloatValue = { "FloatValue", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAIDataProvider_QueryParams, FloatValue), METADATA_PARAMS(Z_Construct_UClass_UAIDataProvider_QueryParams_Statics::NewProp_FloatValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAIDataProvider_QueryParams_Statics::NewProp_FloatValue_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAIDataProvider_QueryParams_Statics::NewProp_IntValue = { "IntValue", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAIDataProvider_QueryParams, IntValue), METADATA_PARAMS(Z_Construct_UClass_UAIDataProvider_QueryParams_Statics::NewProp_IntValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAIDataProvider_QueryParams_Statics::NewProp_IntValue_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAIDataProvider_QueryParams, 4227522109);
