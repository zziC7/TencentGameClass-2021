...
static struct FScriptStruct_AIModule_StaticRegisterNativesFBehaviorTreeTemplateInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBehaviorTreeTemplateInfo>(FName(TEXT("BehaviorTreeTemplateInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBehaviorTreeTemplateInfo_Hash() { return 2827200123U; }
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_MaxDebuggerSteps = { "MaxDebuggerSteps", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBehaviorTreeManager, MaxDebuggerSteps), METADATA_PARAMS(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_MaxDebuggerSteps_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_MaxDebuggerSteps_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_LoadedTemplates = { "LoadedTemplates", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBehaviorTreeManager, LoadedTemplates), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_LoadedTemplates_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_LoadedTemplates_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_ActiveComponents = { "ActiveComponents", nullptr, (EPropertyFlags)0x0020088000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBehaviorTreeManager, ActiveComponents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_ActiveComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_ActiveComponents_MetaData)) };
	...
	IMPLEMENT_CLASS(UBehaviorTreeManager, 2302200465);
