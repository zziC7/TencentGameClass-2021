...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAITouchEvent
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAITouchEvent>(FName(TEXT("AITouchEvent")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FAITouchEvent_Statics::NewProp_TouchReceiver = { "TouchReceiver", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAITouchEvent, TouchReceiver), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAITouchEvent_Statics::NewProp_TouchReceiver_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAITouchEvent_Statics::NewProp_TouchReceiver_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAITouchEvent_Hash() { return 2667867490U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAISense_Touch_Statics::NewProp_RegisteredEvents = { "RegisteredEvents", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Touch, RegisteredEvents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAISense_Touch_Statics::NewProp_RegisteredEvents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Touch_Statics::NewProp_RegisteredEvents_MetaData)) };
	...
	IMPLEMENT_CLASS(UAISense_Touch, 1640117045);
