...
static struct FScriptStruct_OnlineSubsystem_StaticRegisterNativesFNamedInterfaceDef
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNamedInterfaceDef>(FName(TEXT("NamedInterfaceDef")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNamedInterfaceDef_Hash() { return 2641024538U; }
...
static struct FScriptStruct_OnlineSubsystem_StaticRegisterNativesFNamedInterface
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNamedInterface>(FName(TEXT("NamedInterface")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNamedInterface_Hash() { return 4182240278U; }
	...
	IMPLEMENT_CLASS(UNamedInterfaces, 4230279432);
