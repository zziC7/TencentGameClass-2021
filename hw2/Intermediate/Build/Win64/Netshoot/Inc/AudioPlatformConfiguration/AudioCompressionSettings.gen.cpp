...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AudioPlatformConfiguration_ESoundwaveSampleRateSettings_Hash() { return 857083869U; }
...
static struct FScriptStruct_AudioPlatformConfiguration_StaticRegisterNativesFPlatformRuntimeAudioCompressionOverrides
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPlatformRuntimeAudioCompressionOverrides>(FName(TEXT("PlatformRuntimeAudioCompressionOverrides")));
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPlatformRuntimeAudioCompressionOverrides_Statics::NewProp_bOverrideCompressionTimes_MetaData[] = {
		...
		{ "Comment", "// Set this to true to override Sound Groups and use the Duration Threshold value to determine whether a sound should be fully decompressed during initial loading.\n" },
		{ "ModuleRelativePath", "Public/AudioCompressionSettings.h" },
	...
	uint32 Get_Z_Construct_UScriptStruct_FPlatformRuntimeAudioCompressionOverrides_Hash() { return 721248119U; }
