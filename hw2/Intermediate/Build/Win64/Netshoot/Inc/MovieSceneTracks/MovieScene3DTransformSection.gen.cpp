...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_MovieSceneTracks_EShow3DTrajectory_Hash() { return 1531247892U; }
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneTransformMask
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneTransformMask>(FName(TEXT("MovieSceneTransformMask")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTransformMask_Hash() { return 652854967U; }
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieScene3DTransformKeyStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieScene3DTransformKeyStruct>(FName(TEXT("MovieScene3DTransformKeyStruct")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScene3DTransformKeyStruct_Hash() { return 2868618280U; }
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieScene3DScaleKeyStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieScene3DScaleKeyStruct>(FName(TEXT("MovieScene3DScaleKeyStruct")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScene3DScaleKeyStruct_Hash() { return 2162699276U; }
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieScene3DRotationKeyStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieScene3DRotationKeyStruct>(FName(TEXT("MovieScene3DRotationKeyStruct")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScene3DRotationKeyStruct_Hash() { return 2566363340U; }
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieScene3DLocationKeyStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieScene3DLocationKeyStruct>(FName(TEXT("MovieScene3DLocationKeyStruct")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScene3DLocationKeyStruct_Hash() { return 868685740U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_ManualWeight = { "ManualWeight", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieScene3DTransformSection, ManualWeight), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_ManualWeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_ManualWeight_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_bUseQuaternionInterpolation = { "bUseQuaternionInterpolation", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieScene3DTransformSection), &Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_bUseQuaternionInterpolation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_bUseQuaternionInterpolation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_bUseQuaternionInterpolation_MetaData)) };
#if WITH_EDITORONLY_DATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_Show3DTrajectory = { "Show3DTrajectory", nullptr, (EPropertyFlags)0x0040000800000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieScene3DTransformSection, Show3DTrajectory), Z_Construct_UEnum_MovieSceneTracks_EShow3DTrajectory, METADATA_PARAMS(Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_Show3DTrajectory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DTransformSection_Statics::NewProp_Show3DTrajectory_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieScene3DTransformSection_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieScene3DTransformSection_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneEntityProvider_NoRegister, (int32)VTABLE_OFFSET(UMovieScene3DTransformSection, IMovieSceneEntityProvider), false },
		};
	...
	IMPLEMENT_CLASS(UMovieScene3DTransformSection, 4079834137);
