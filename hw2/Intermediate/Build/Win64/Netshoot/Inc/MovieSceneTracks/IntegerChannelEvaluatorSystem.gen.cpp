...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UIntegerChannelEvaluatorSystem_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UIntegerChannelEvaluatorSystem_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UIntegerChannelEvaluatorSystem()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UIntegerChannelEvaluatorSystem_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UIntegerChannelEvaluatorSystem, 2436163824);
	template<> MOVIESCENETRACKS_API UClass* StaticClass<UIntegerChannelEvaluatorSystem>()
	{
		return UIntegerChannelEvaluatorSystem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UIntegerChannelEvaluatorSystem(Z_Construct_UClass_UIntegerChannelEvaluatorSystem, &UIntegerChannelEvaluatorSystem::StaticClass, TEXT("/Script/MovieSceneTracks"), TEXT("UIntegerChannelEvaluatorSystem"), false, nullptr, nullptr, nullptr);
