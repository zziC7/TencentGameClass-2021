...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneColorSectionTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneColorSectionTemplate>(FName(TEXT("MovieSceneColorSectionTemplate")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneColorSectionTemplate_Statics::NewProp_Curves = { "Curves", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, CPP_ARRAY_DIM(Curves, FMovieSceneColorSectionTemplate), STRUCT_OFFSET(FMovieSceneColorSectionTemplate, Curves), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneColorSectionTemplate_Statics::NewProp_Curves_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneColorSectionTemplate_Statics::NewProp_Curves_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneColorSectionTemplate_Hash() { return 3479950351U; }
