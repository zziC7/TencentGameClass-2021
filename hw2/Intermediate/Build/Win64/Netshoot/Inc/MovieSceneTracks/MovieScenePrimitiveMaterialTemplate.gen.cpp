...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieScenePrimitiveMaterialTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieScenePrimitiveMaterialTemplate>(FName(TEXT("MovieScenePrimitiveMaterialTemplate")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieScenePrimitiveMaterialTemplate_Statics::NewProp_MaterialChannel = { "MaterialChannel", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieScenePrimitiveMaterialTemplate, MaterialChannel), Z_Construct_UScriptStruct_FMovieSceneObjectPathChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScenePrimitiveMaterialTemplate_Statics::NewProp_MaterialChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScenePrimitiveMaterialTemplate_Statics::NewProp_MaterialChannel_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieScenePrimitiveMaterialTemplate_Hash() { return 4132923548U; }
