...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneInterrogatedPropertyInstantiatorSystem_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneInterrogatedPropertyInstantiatorSystem_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMovieSceneInterrogatedPropertyInstantiatorSystem()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMovieSceneInterrogatedPropertyInstantiatorSystem_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMovieSceneInterrogatedPropertyInstantiatorSystem, 4261636148);
	template<> MOVIESCENETRACKS_API UClass* StaticClass<UMovieSceneInterrogatedPropertyInstantiatorSystem>()
	{
		return UMovieSceneInterrogatedPropertyInstantiatorSystem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMovieSceneInterrogatedPropertyInstantiatorSystem(Z_Construct_UClass_UMovieSceneInterrogatedPropertyInstantiatorSystem, &UMovieSceneInterrogatedPropertyInstantiatorSystem::StaticClass, TEXT("/Script/MovieSceneTracks"), TEXT("UMovieSceneInterrogatedPropertyInstantiatorSystem"), false, nullptr, nullptr, nullptr);
