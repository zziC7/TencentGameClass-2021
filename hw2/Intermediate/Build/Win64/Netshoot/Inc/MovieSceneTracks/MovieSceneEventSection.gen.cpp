...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneEventSectionData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneEventSectionData>(FName(TEXT("MovieSceneEventSectionData")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_Times = { "Times", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEventSectionData, Times), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_Times_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_Times_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyValues = { "KeyValues", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEventSectionData, KeyValues), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyValues_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyValues_MetaData)) };
#if WITH_EDITORONLY_DATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyTimes = { "KeyTimes", nullptr, (EPropertyFlags)0x0040000820000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEventSectionData, KeyTimes_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyTimes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyTimes_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Hash() { return 4207340201U; }
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFEventPayload
{
	...
	{
		UScriptStruct::DeferCppStructOps<FEventPayload>(FName(TEXT("EventPayload")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FEventPayload_Hash() { return 850901023U; }
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneEventParameters
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneEventParameters>(FName(TEXT("MovieSceneEventParameters")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneEventParameters_Hash() { return 4231434684U; }
	...
	IMPLEMENT_CLASS(UMovieSceneEventSection, 2807506602);
