...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_MovieSceneTracks_MovieScene3DPathSection_Axis_Hash() { return 519352734U; }
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_UpAxisEnum = { "UpAxisEnum", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieScene3DPathSection, UpAxisEnum), Z_Construct_UEnum_MovieSceneTracks_MovieScene3DPathSection_Axis, METADATA_PARAMS(Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_UpAxisEnum_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_UpAxisEnum_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_bFollow = { "bFollow", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UMovieScene3DPathSection), &Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_bFollow_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_bFollow_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_bFollow_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_bForceUpright = { "bForceUpright", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UMovieScene3DPathSection), &Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_bForceUpright_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_bForceUpright_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DPathSection_Statics::NewProp_bForceUpright_MetaData)) };
	...
	IMPLEMENT_CLASS(UMovieScene3DPathSection, 2616675577);
