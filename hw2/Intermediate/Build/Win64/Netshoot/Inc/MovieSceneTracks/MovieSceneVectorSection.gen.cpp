...
static_assert(std::is_polymorphic<FMovieSceneVector4KeyStruct>() == std::is_polymorphic<FMovieSceneVectorKeyStructBase>(), "USTRUCT FMovieSceneVector4KeyStruct cannot be polymorphic unless super FMovieSceneVectorKeyStructBase is polymorphic");
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneVector4KeyStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneVector4KeyStruct>(FName(TEXT("MovieSceneVector4KeyStruct")));
	}
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneVector4KeyStruct_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneVector4KeyStruct_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneVector4KeyStruct_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneVector4KeyStruct_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneVector4KeyStruct_Hash() { return 1829009979U; }

static_assert(std::is_polymorphic<FMovieSceneVectorKeyStruct>() == std::is_polymorphic<FMovieSceneVectorKeyStructBase>(), "USTRUCT FMovieSceneVectorKeyStruct cannot be polymorphic unless super FMovieSceneVectorKeyStructBase is polymorphic");
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneVectorKeyStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneVectorKeyStruct>(FName(TEXT("MovieSceneVectorKeyStruct")));
	}
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneVectorKeyStruct_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneVectorKeyStruct_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneVectorKeyStruct_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneVectorKeyStruct_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneVectorKeyStruct_Hash() { return 2293587435U; }

static_assert(std::is_polymorphic<FMovieSceneVector2DKeyStruct>() == std::is_polymorphic<FMovieSceneVectorKeyStructBase>(), "USTRUCT FMovieSceneVector2DKeyStruct cannot be polymorphic unless super FMovieSceneVectorKeyStructBase is polymorphic");
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneVector2DKeyStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneVector2DKeyStruct>(FName(TEXT("MovieSceneVector2DKeyStruct")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneVector2DKeyStruct_Hash() { return 3314334129U; }

static_assert(std::is_polymorphic<FMovieSceneVectorKeyStructBase>() == std::is_polymorphic<FMovieSceneKeyStruct>(), "USTRUCT FMovieSceneVectorKeyStructBase cannot be polymorphic unless super FMovieSceneKeyStruct is polymorphic");
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneVectorKeyStructBase
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneVectorKeyStructBase>(FName(TEXT("MovieSceneVectorKeyStructBase")));
	}
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneVectorKeyStructBase_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneVectorKeyStructBase_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneVectorKeyStructBase_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneVectorKeyStructBase_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneVectorKeyStructBase_Hash() { return 2191490370U; }
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneVectorSection_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneVectorSection_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneEntityProvider_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneVectorSection, IMovieSceneEntityProvider), false },
		};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneVectorSection_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneVectorSection_Statics::PropPointers),
		UE_ARRAY_COUNT(InterfaceParams),
		0x002800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneVectorSection_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneVectorSection_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UMovieSceneVectorSection, 580226126);
