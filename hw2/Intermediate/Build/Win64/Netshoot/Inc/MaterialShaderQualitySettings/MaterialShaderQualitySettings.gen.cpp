...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UMaterialShaderQualitySettings_Statics::NewProp_ForwardSettingMap = { "ForwardSettingMap", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialShaderQualitySettings, ForwardSettingMap), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMaterialShaderQualitySettings_Statics::NewProp_ForwardSettingMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialShaderQualitySettings_Statics::NewProp_ForwardSettingMap_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialShaderQualitySettings, 4163555688);
