...
#define Engine_Plugins_Lumin_MagicLeapPassableWorld_Source_MagicLeapARPin_Public_MagicLeapARPinFunctionLibrary_h_12_RPC_WRAPPERS \
 \
	DECLARE_FUNCTION(execSetContentBindingSaveGameUserIndex); \
	DECLARE_FUNCTION(execGetContentBindingSaveGameUserIndex); \
	DECLARE_FUNCTION(execUnBindToOnMagicLeapContentBindingFoundDelegate); \
	DECLARE_FUNCTION(execBindToOnMagicLeapContentBindingFoundDelegate); \
	DECLARE_FUNCTION(execGetGlobalQueryFilter); \
	DECLARE_FUNCTION(execSetGlobalQueryFilter); \
	DECLARE_FUNCTION(execUnBindToOnMagicLeapARPinUpdatedDelegate); \
	DECLARE_FUNCTION(execBindToOnMagicLeapARPinUpdatedDelegate); \
	DECLARE_FUNCTION(execParseStringToARPinId); \
	DECLARE_FUNCTION(execARPinIdToString); \
	...
	DECLARE_FUNCTION(execQueryARPins); \
