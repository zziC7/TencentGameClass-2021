...
void EmptyLinkFunctionForGeneratedCodeMagicLeapARPin_init() {}
	...
	MAGICLEAPARPIN_API UFunction* Z_Construct_UDelegateFunction_MagicLeapARPin_MagicLeapContentBindingFoundMultiDelegate__DelegateSignature();
	...
	UPackage* Z_Construct_UPackage__Script_MagicLeapARPin()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_MagicLeapARPin_MagicLeapContentBindingFoundDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_MagicLeapARPin_MagicLeapContentBindingFoundMultiDelegate__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UMagicLeapARPinComponent_MagicLeapARPinDataLoadAttemptCompleted__DelegateSignature,
			};
