...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AugmentedReality_EARDepthAccuracy_Hash() { return 2345805704U; }
	...
	uint32 Get_Z_Construct_UEnum_AugmentedReality_EARDepthQuality_Hash() { return 3799056868U; }
	...
	uint32 Get_Z_Construct_UEnum_AugmentedReality_EARTextureType_Hash() { return 2420796551U; }
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UARTexture_Statics::NewProp_TextureType = { "TextureType", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARTexture, TextureType), Z_Construct_UEnum_AugmentedReality_EARTextureType, METADATA_PARAMS(Z_Construct_UClass_UARTexture_Statics::NewProp_TextureType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARTexture_Statics::NewProp_TextureType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UARTexture_Statics::NewProp_Timestamp = { "Timestamp", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARTexture, Timestamp), METADATA_PARAMS(Z_Construct_UClass_UARTexture_Statics::NewProp_Timestamp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARTexture_Statics::NewProp_Timestamp_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UARTexture, 2360289671);
	...
	IMPLEMENT_CLASS(UARTextureCameraImage, 1403452512);
	...
	IMPLEMENT_CLASS(UARTextureCameraDepth, 1670748187);
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAREnvironmentCaptureProbeTexture_Statics::NewProp_TextureType = { "TextureType", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAREnvironmentCaptureProbeTexture, TextureType), Z_Construct_UEnum_AugmentedReality_EARTextureType, METADATA_PARAMS(Z_Construct_UClass_UAREnvironmentCaptureProbeTexture_Statics::NewProp_TextureType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAREnvironmentCaptureProbeTexture_Statics::NewProp_TextureType_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAREnvironmentCaptureProbeTexture, 1284176006);
