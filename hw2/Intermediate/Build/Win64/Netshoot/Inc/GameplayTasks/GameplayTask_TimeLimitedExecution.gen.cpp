...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGameplayTask_TimeLimitedExecution_Statics::FuncInfo[] = {
		{ &Z_Construct_UDelegateFunction_UGameplayTask_TimeLimitedExecution_TaskFinishDelegate__DelegateSignature, "TaskFinishDelegate__DelegateSignature" }, // 1056854899
	};
#endif //WITH_EDITOR
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UGameplayTask_TimeLimitedExecution_Statics::NewProp_OnTimeExpired = { "OnTimeExpired", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameplayTask_TimeLimitedExecution, OnTimeExpired), Z_Construct_UDelegateFunction_UGameplayTask_TimeLimitedExecution_TaskFinishDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UGameplayTask_TimeLimitedExecution_Statics::NewProp_OnTimeExpired_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayTask_TimeLimitedExecution_Statics::NewProp_OnTimeExpired_MetaData)) };
	...
	IMPLEMENT_CLASS(UGameplayTask_TimeLimitedExecution, 386209793);
