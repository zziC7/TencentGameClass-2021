...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMobileInstalledContent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMobileInstalledContent_Mount, "Mount" }, // 1866292221
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMobileInstalledContent, 3787461436);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMobilePendingContent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMobilePendingContent_StartInstall, "StartInstall" }, // 1953370190
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMobilePendingContent, 2273888696);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMobilePatchingLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMobilePatchingLibrary_GetInstalledContent, "GetInstalledContent" }, // 3111274243
		{ &Z_Construct_UFunction_UMobilePatchingLibrary_GetSupportedPlatformNames, "GetSupportedPlatformNames" }, // 1676318010
		{ &Z_Construct_UFunction_UMobilePatchingLibrary_HasActiveWiFiConnection, "HasActiveWiFiConnection" }, // 1839071804
		{ &Z_Construct_UFunction_UMobilePatchingLibrary_RequestContent, "RequestContent" }, // 593040989
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMobilePatchingLibrary, 300385850);
