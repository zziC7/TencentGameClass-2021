...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGeometryCache_Statics::NewProp_Hash_MetaData[] = {
		{ "ModuleRelativePath", "Classes/GeometryCache.h" },
	};
#endif
	const UE4CodeGen_Private::FFInt64PropertyParams Z_Construct_UClass_UGeometryCache_Statics::NewProp_Hash = { "Hash", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::UInt64, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCache, Hash), METADATA_PARAMS(Z_Construct_UClass_UGeometryCache_Statics::NewProp_Hash_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCache_Statics::NewProp_Hash_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGeometryCache_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGeometryCache_Statics::NewProp_Hash,
	};
	...
	IMPLEMENT_CLASS(UGeometryCache, 3451323633);
