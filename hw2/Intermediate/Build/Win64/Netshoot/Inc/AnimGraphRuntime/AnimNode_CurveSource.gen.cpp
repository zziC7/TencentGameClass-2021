...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_CurveSource
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_CurveSource>(FName(TEXT("AnimNode_CurveSource")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_SourceBinding = { "SourceBinding", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_CurveSource, SourceBinding), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_SourceBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_SourceBinding_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_Alpha = { "Alpha", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_CurveSource, Alpha), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_Alpha_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_Alpha_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_CurveSource_Hash() { return 72190821U; }
