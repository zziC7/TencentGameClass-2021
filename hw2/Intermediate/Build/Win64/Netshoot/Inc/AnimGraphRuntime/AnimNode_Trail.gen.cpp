...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_Trail
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_Trail>(FName(TEXT("AnimNode_Trail")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_Trail_Hash() { return 3442424938U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFRotationLimit
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRotationLimit>(FName(TEXT("RotationLimit")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRotationLimit_Statics::NewProp_LimitMin = { "LimitMin", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRotationLimit, LimitMin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FRotationLimit_Statics::NewProp_LimitMin_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRotationLimit_Statics::NewProp_LimitMin_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FRotationLimit_Hash() { return 3022935954U; }
