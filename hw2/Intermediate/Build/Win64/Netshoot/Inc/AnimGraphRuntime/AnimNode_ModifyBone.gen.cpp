...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EBoneModificationMode_Hash() { return 4288684667U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_ModifyBone
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_ModifyBone>(FName(TEXT("AnimNode_ModifyBone")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ModifyBone_Statics::NewProp_BoneToModify = { "BoneToModify", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ModifyBone, BoneToModify), Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ModifyBone_Statics::NewProp_BoneToModify_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ModifyBone_Statics::NewProp_BoneToModify_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ModifyBone_Hash() { return 2200649411U; }
