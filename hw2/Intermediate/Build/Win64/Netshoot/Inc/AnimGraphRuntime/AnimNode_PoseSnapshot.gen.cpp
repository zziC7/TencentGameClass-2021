...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ESnapshotSourceMode_Hash() { return 3653241339U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_PoseSnapshot
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_PoseSnapshot>(FName(TEXT("AnimNode_PoseSnapshot")));
	}
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_PoseSnapshot, Mode), Z_Construct_UEnum_AnimGraphRuntime_ESnapshotSourceMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Mode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Mode_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Hash() { return 2507080295U; }
