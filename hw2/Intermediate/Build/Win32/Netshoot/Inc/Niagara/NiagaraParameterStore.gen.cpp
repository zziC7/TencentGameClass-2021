...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraParameterStore
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraParameterStore>(FName(TEXT("NiagaraParameterStore")));
	}
	...
	struct Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics
	{
		...
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_ParameterGuidMapping_ValueProp;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_ParameterGuidMapping_Key_KeyProp;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ParameterGuidMapping_MetaData[];
#endif
		static const UE4CodeGen_Private::FMapPropertyParams NewProp_ParameterGuidMapping;
#endif // WITH_EDITORONLY_DATA
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::NewProp_ParameterGuidMapping_ValueProp = { "ParameterGuidMapping", nullptr, (EPropertyFlags)0x0000000800000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::NewProp_ParameterGuidMapping_Key_KeyProp = { "ParameterGuidMapping_Key", nullptr, (EPropertyFlags)0x0000000800000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::NewProp_ParameterGuidMapping_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::NewProp_ParameterGuidMapping = { "ParameterGuidMapping", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraParameterStore, ParameterGuidMapping), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::NewProp_ParameterGuidMapping_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::NewProp_ParameterGuidMapping_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::NewProp_ParameterGuidMapping_ValueProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::NewProp_ParameterGuidMapping_Key_KeyProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraParameterStore_Statics::NewProp_ParameterGuidMapping,
#endif // WITH_EDITORONLY_DATA
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraParameterStore_Hash() { return 86870138U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraVariableWithOffset
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraVariableWithOffset>(FName(TEXT("NiagaraVariableWithOffset")));
	}
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraBoundParameter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraBoundParameter>(FName(TEXT("NiagaraBoundParameter")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraBoundParameter_Hash() { return 2748649957U; }
