...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Niagara_ENiagaraVariantMode_Hash() { return 2766415992U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraVariant
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraVariant>(FName(TEXT("NiagaraVariant")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Object = { "Object", nullptr, (EPropertyFlags)0x0042000000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraVariant, Object), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Object_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Object_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_DataInterface = { "DataInterface", nullptr, (EPropertyFlags)0x0042000000080009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraVariant, DataInterface), Z_Construct_UClass_UNiagaraDataInterface_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_DataInterface_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_DataInterface_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraVariant_Hash() { return 3490792692U; }
