...
// End Cross Module References
	static UEnum* ENiagaraRibbonUVDistributionMode_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraRibbonUVDistributionMode, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraRibbonUVDistributionMode"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ENiagaraRibbonUVDistributionMode(ENiagaraRibbonUVDistributionMode_StaticEnum, TEXT("/Script/Niagara"), TEXT("ENiagaraRibbonUVDistributionMode"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonUVDistributionMode_Hash() { return 2105913658U; }
	UEnum* Z_Construct_UEnum_Niagara_ENiagaraRibbonUVDistributionMode()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Niagara();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ENiagaraRibbonUVDistributionMode"), 0, Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonUVDistributionMode_Hash(), false);
#else
	...
	static UEnum* ENiagaraRibbonUVEdgeMode_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraRibbonUVEdgeMode, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraRibbonUVEdgeMode"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ENiagaraRibbonUVEdgeMode(ENiagaraRibbonUVEdgeMode_StaticEnum, TEXT("/Script/Niagara"), TEXT("ENiagaraRibbonUVEdgeMode"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonUVEdgeMode_Hash() { return 4031218677U; }
	UEnum* Z_Construct_UEnum_Niagara_ENiagaraRibbonUVEdgeMode()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Niagara();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ENiagaraRibbonUVEdgeMode"), 0, Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonUVEdgeMode_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	uint32 Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonTessellationMode_Hash() { return 792537672U; }
	...
	static UEnum* ENiagaraRibbonShapeMode_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraRibbonShapeMode, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraRibbonShapeMode"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ENiagaraRibbonShapeMode(ENiagaraRibbonShapeMode_StaticEnum, TEXT("/Script/Niagara"), TEXT("ENiagaraRibbonShapeMode"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonShapeMode_Hash() { return 206967142U; }
	UEnum* Z_Construct_UEnum_Niagara_ENiagaraRibbonShapeMode()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Niagara();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ENiagaraRibbonShapeMode"), 0, Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonShapeMode_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	uint32 Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonDrawDirection_Hash() { return 3664100861U; }
	...
	uint32 Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonAgeOffsetMode_Hash() { return 1982049667U; }
	...
	uint32 Get_Z_Construct_UEnum_Niagara_ENiagaraRibbonFacingMode_Hash() { return 2884737849U; }
...
class UScriptStruct* FNiagaraRibbonUVSettings::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern NIAGARA_API uint32 Get_Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraRibbonUVSettings"), sizeof(FNiagaraRibbonUVSettings), Get_Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FNiagaraRibbonUVSettings(FNiagaraRibbonUVSettings::StaticStruct, TEXT("/Script/Niagara"), TEXT("NiagaraRibbonUVSettings"), false, nullptr, nullptr);
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraRibbonUVSettings
{
	FScriptStruct_Niagara_StaticRegisterNativesFNiagaraRibbonUVSettings()
	{
		UScriptStruct::DeferCppStructOps<FNiagaraRibbonUVSettings>(FName(TEXT("NiagaraRibbonUVSettings")));
	}
} ScriptStruct_Niagara_StaticRegisterNativesFNiagaraRibbonUVSettings;
	struct Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics
	{
		...
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_DistributionMode_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DistributionMode_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_DistributionMode;
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_LeadingEdgeMode_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LeadingEdgeMode_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_LeadingEdgeMode;
		static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_TrailingEdgeMode_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TrailingEdgeMode_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_TrailingEdgeMode;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TilingLength_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_TilingLength;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnablePerParticleUOverride_MetaData[];
#endif
		static void NewProp_bEnablePerParticleUOverride_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnablePerParticleUOverride;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnablePerParticleVRangeOverride_MetaData[];
#endif
		static void NewProp_bEnablePerParticleVRangeOverride_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnablePerParticleVRangeOverride;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const UE4CodeGen_Private::FStructParams ReturnStructParams;
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::Struct_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_DistributionMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_DistributionMode_MetaData[] = {
		{ "Category", "UVs" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_DistributionMode = { "DistributionMode", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraRibbonUVSettings, DistributionMode), Z_Construct_UEnum_Niagara_ENiagaraRibbonUVDistributionMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_DistributionMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_DistributionMode_MetaData)) };
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_LeadingEdgeMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_LeadingEdgeMode_MetaData[] = {
		{ "Category", "UVs" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_LeadingEdgeMode = { "LeadingEdgeMode", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraRibbonUVSettings, LeadingEdgeMode), Z_Construct_UEnum_Niagara_ENiagaraRibbonUVEdgeMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_LeadingEdgeMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_LeadingEdgeMode_MetaData)) };
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TrailingEdgeMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TrailingEdgeMode_MetaData[] = {
		{ "Category", "UVs" },
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TrailingEdgeMode = { "TrailingEdgeMode", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraRibbonUVSettings, TrailingEdgeMode), Z_Construct_UEnum_Niagara_ENiagaraRibbonUVEdgeMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TrailingEdgeMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TrailingEdgeMode_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TilingLength_MetaData[] = {
		{ "Category", "UVs" },
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TilingLength = { "TilingLength", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraRibbonUVSettings, TilingLength), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TilingLength_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TilingLength_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Offset_MetaData[] = {
		{ "Category", "UVs" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Offset = { "Offset", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraRibbonUVSettings, Offset), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Offset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Offset_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Scale_MetaData[] = {
		{ "Category", "UVs" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Scale = { "Scale", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraRibbonUVSettings, Scale), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Scale_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Scale_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleUOverride_MetaData[] = {
		{ "Category", "UVs" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleUOverride = { "bEnablePerParticleUOverride", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FNiagaraRibbonUVSettings), &Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleUOverride_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleUOverride_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleUOverride_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleVRangeOverride_MetaData[] = {
		{ "Category", "UVs" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleVRangeOverride = { "bEnablePerParticleVRangeOverride", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FNiagaraRibbonUVSettings), &Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleVRangeOverride_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleVRangeOverride_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleVRangeOverride_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_DistributionMode_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_DistributionMode,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_LeadingEdgeMode_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_LeadingEdgeMode,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TrailingEdgeMode_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TrailingEdgeMode,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_TilingLength,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Offset,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_Scale,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleUOverride,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::NewProp_bEnablePerParticleVRangeOverride,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_Niagara,
		nullptr,
		&NewStructOps,
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_Niagara();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("NiagaraRibbonUVSettings"), sizeof(FNiagaraRibbonUVSettings), Get_Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraRibbonUVSettings_Hash() { return 693233189U; }
class UScriptStruct* FNiagaraRibbonShapeCustomVertex::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern NIAGARA_API uint32 Get_Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraRibbonShapeCustomVertex"), sizeof(FNiagaraRibbonShapeCustomVertex), Get_Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FNiagaraRibbonShapeCustomVertex(FNiagaraRibbonShapeCustomVertex::StaticStruct, TEXT("/Script/Niagara"), TEXT("NiagaraRibbonShapeCustomVertex"), false, nullptr, nullptr);
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraRibbonShapeCustomVertex
{
	FScriptStruct_Niagara_StaticRegisterNativesFNiagaraRibbonShapeCustomVertex()
	{
		UScriptStruct::DeferCppStructOps<FNiagaraRibbonShapeCustomVertex>(FName(TEXT("NiagaraRibbonShapeCustomVertex")));
	}
} ScriptStruct_Niagara_StaticRegisterNativesFNiagaraRibbonShapeCustomVertex;
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TextureV_MetaData[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Position_MetaData[] = {
		{ "Category", "Ribbon Rendering" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraRibbonShapeCustomVertex, Position), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Position_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Position_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Normal_MetaData[] = {
		{ "Category", "Ribbon Rendering" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Normal = { "Normal", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraRibbonShapeCustomVertex, Normal), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Normal_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Normal_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_TextureV_MetaData[] = {
		{ "Category", "Ribbon Rendering" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_TextureV = { "TextureV", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraRibbonShapeCustomVertex, TextureV), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_TextureV_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_TextureV_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Position,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_Normal,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::NewProp_TextureV,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_Niagara,
		nullptr,
		&NewStructOps,
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_Niagara();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("NiagaraRibbonShapeCustomVertex"), sizeof(FNiagaraRibbonShapeCustomVertex), Get_Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex_Hash() { return 3502798579U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_UV0Settings_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_UV0Settings;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_UV1Settings_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_UV1Settings;
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableAccurateGeometry_MetaData[];
#endif
		static void NewProp_bEnableAccurateGeometry_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableAccurateGeometry;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_WidthSegmentationCount_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_WidthSegmentationCount;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_MultiPlaneCount_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_MultiPlaneCount;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TubeSubdivisions_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_TubeSubdivisions;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_CustomVertices_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CustomVertices_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_CustomVertices;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_RibbonUVDistance_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_RibbonUVDistance;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_U0OverrideBinding_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_U0OverrideBinding;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_V0RangeOverrideBinding_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_V0RangeOverrideBinding;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_U1OverrideBinding_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_U1OverrideBinding;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_V1RangeOverrideBinding_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_V1RangeOverrideBinding;
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0TilingDistance = { "UV0TilingDistance", nullptr, (EPropertyFlags)0x0040000820000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, UV0TilingDistance_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0TilingDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0TilingDistance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0Scale = { "UV0Scale", nullptr, (EPropertyFlags)0x0040000820000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, UV0Scale_DEPRECATED), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0Scale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0Scale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0Offset = { "UV0Offset", nullptr, (EPropertyFlags)0x0040000820000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, UV0Offset_DEPRECATED), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0Offset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0Offset_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1TilingDistance = { "UV1TilingDistance", nullptr, (EPropertyFlags)0x0040000820000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, UV1TilingDistance_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1TilingDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1TilingDistance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1Scale = { "UV1Scale", nullptr, (EPropertyFlags)0x0040000820000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, UV1Scale_DEPRECATED), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1Scale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1Scale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1Offset = { "UV1Offset", nullptr, (EPropertyFlags)0x0040000820000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, UV1Offset_DEPRECATED), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1Offset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1Offset_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1AgeOffsetMode = { "UV1AgeOffsetMode", nullptr, (EPropertyFlags)0x0040000820000000, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, UV1AgeOffsetMode_DEPRECATED), Z_Construct_UEnum_Niagara_ENiagaraRibbonAgeOffsetMode, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1AgeOffsetMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1AgeOffsetMode_MetaData)) };
#endif // WITH_EDITORONLY_DATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_Shape_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_Shape = { "Shape", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, Shape), Z_Construct_UEnum_Niagara_ENiagaraRibbonShapeMode, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_Shape_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_Shape_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_bEnableAccurateGeometry_MetaData[] = {
		{ "Category", "Ribbon Shape" },
		{ "Comment", "/** Double geometry count, to allow for correct geometry on both sides of MultiPlane. With this off, \n\x09  * MultiPlane will switch normals based on view direction, but this could potentially cause issues in some materials \n\x09  */" },
		{ "EditCondition", "Shape == ENiagaraRibbonShapeMode::MultiPlane" },
		{ "ModuleRelativePath", "Public/NiagaraRibbonRendererProperties.h" },
		{ "ToolTip", "Double geometry count, to allow for correct geometry on both sides of MultiPlane. With this off,\nMultiPlane will switch normals based on view direction, but this could potentially cause issues in some materials" },
	};
#endif
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_MultiPlaneCount = { "MultiPlaneCount", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, MultiPlaneCount), METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_MultiPlaneCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_MultiPlaneCount_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_TubeSubdivisions_MetaData[] = {
		{ "Category", "Ribbon Shape" },
		{ "ClampMax", "16" },
		{ "ClampMin", "3" },
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_TubeSubdivisions = { "TubeSubdivisions", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, TubeSubdivisions), METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_TubeSubdivisions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_TubeSubdivisions_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_CustomVertices_Inner = { "CustomVertices", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNiagaraRibbonShapeCustomVertex, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_CustomVertices_MetaData[] = {
		{ "Category", "Ribbon Shape" },
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_CustomVertices = { "CustomVertices", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, CustomVertices), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_CustomVertices_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_CustomVertices_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_RibbonUVDistance_MetaData[] = {
		{ "Category", "Bindings" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_RibbonUVDistance = { "RibbonUVDistance", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, RibbonUVDistance), Z_Construct_UScriptStruct_FNiagaraVariableAttributeBinding, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_RibbonUVDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_RibbonUVDistance_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U0OverrideBinding_MetaData[] = {
		{ "Category", "Bindings" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U0OverrideBinding = { "U0OverrideBinding", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, U0OverrideBinding), Z_Construct_UScriptStruct_FNiagaraVariableAttributeBinding, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U0OverrideBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U0OverrideBinding_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V0RangeOverrideBinding_MetaData[] = {
		{ "Category", "Bindings" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V0RangeOverrideBinding = { "V0RangeOverrideBinding", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, V0RangeOverrideBinding), Z_Construct_UScriptStruct_FNiagaraVariableAttributeBinding, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V0RangeOverrideBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V0RangeOverrideBinding_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U1OverrideBinding_MetaData[] = {
		{ "Category", "Bindings" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U1OverrideBinding = { "U1OverrideBinding", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, U1OverrideBinding), Z_Construct_UScriptStruct_FNiagaraVariableAttributeBinding, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U1OverrideBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U1OverrideBinding_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V1RangeOverrideBinding_MetaData[] = {
		{ "Category", "Bindings" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V1RangeOverrideBinding = { "V1RangeOverrideBinding", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraRibbonRendererProperties, V1RangeOverrideBinding), Z_Construct_UScriptStruct_FNiagaraVariableAttributeBinding, METADATA_PARAMS(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V1RangeOverrideBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V1RangeOverrideBinding_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_MaterialParameterBindings_Inner = { "MaterialParameterBindings", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNiagaraMaterialAttributeBinding, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_MaterialParameterBindings_MetaData[] = {
		{ "Category", "Bindings" },
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV0Settings,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_UV1Settings,
#if WITH_EDITORONLY_DATA
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_Shape_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_Shape,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_bEnableAccurateGeometry,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_WidthSegmentationCount,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_MultiPlaneCount,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_TubeSubdivisions,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_CustomVertices_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_CustomVertices,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_RibbonUVDistance,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U0OverrideBinding,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V0RangeOverrideBinding,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_U1OverrideBinding,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_V1RangeOverrideBinding,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_MaterialParameterBindings_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraRibbonRendererProperties_Statics::NewProp_MaterialParameterBindings,
	};
	...
	IMPLEMENT_CLASS(UNiagaraRibbonRendererProperties, 426426266);
