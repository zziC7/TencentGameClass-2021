...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_MaxNeighborsPerCell_MetaData[];
#endif
		static const UE4CodeGen_Private::FUInt32PropertyParams NewProp_MaxNeighborsPerCell;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNiagaraDataInterfaceNeighborGrid3D_Statics::NewProp_MaxNeighborsPerCell_MetaData[] = {
		{ "Category", "Grid" },
		{ "ModuleRelativePath", "Classes/NiagaraDataInterfaceNeighborGrid3D.h" },
	};
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UNiagaraDataInterfaceNeighborGrid3D_Statics::NewProp_MaxNeighborsPerCell = { "MaxNeighborsPerCell", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraDataInterfaceNeighborGrid3D, MaxNeighborsPerCell), METADATA_PARAMS(Z_Construct_UClass_UNiagaraDataInterfaceNeighborGrid3D_Statics::NewProp_MaxNeighborsPerCell_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceNeighborGrid3D_Statics::NewProp_MaxNeighborsPerCell_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNiagaraDataInterfaceNeighborGrid3D_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNiagaraDataInterfaceNeighborGrid3D_Statics::NewProp_MaxNeighborsPerCell,
	};
	...
	IMPLEMENT_CLASS(UNiagaraDataInterfaceNeighborGrid3D, 3637179950);
