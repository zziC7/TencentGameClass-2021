...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraDataSetCompiledData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraDataSetCompiledData>(FName(TEXT("NiagaraDataSetCompiledData")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TotalHalfComponents_MetaData[];
#endif
		static const UE4CodeGen_Private::FUInt32PropertyParams NewProp_TotalHalfComponents;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraDataSetCompiledData_Statics::NewProp_TotalHalfComponents_MetaData[] = {
		{ "ModuleRelativePath", "Classes/NiagaraDataSet.h" },
	};
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FNiagaraDataSetCompiledData_Statics::NewProp_TotalHalfComponents = { "TotalHalfComponents", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraDataSetCompiledData, TotalHalfComponents), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraDataSetCompiledData_Statics::NewProp_TotalHalfComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraDataSetCompiledData_Statics::NewProp_TotalHalfComponents_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FNiagaraDataSetCompiledData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraDataSetCompiledData_Statics::NewProp_TotalHalfComponents,
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraDataSetCompiledData_Hash() { return 2579325027U; }
...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraVariableLayoutInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraVariableLayoutInfo>(FName(TEXT("NiagaraVariableLayoutInfo")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_HalfComponentStart_MetaData[];
#endif
		static const UE4CodeGen_Private::FUInt32PropertyParams NewProp_HalfComponentStart;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraVariableLayoutInfo_Statics::NewProp_HalfComponentStart_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FNiagaraVariableLayoutInfo_Statics::NewProp_HalfComponentStart = { "HalfComponentStart", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraVariableLayoutInfo, HalfComponentStart), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraVariableLayoutInfo_Statics::NewProp_HalfComponentStart_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariableLayoutInfo_Statics::NewProp_HalfComponentStart_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FNiagaraVariableLayoutInfo_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraVariableLayoutInfo_Statics::NewProp_HalfComponentStart,
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraVariableLayoutInfo_Hash() { return 4238443148U; }
