...
static struct FScriptStruct_Niagara_StaticRegisterNativesFNiagaraEmitterHandle
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNiagaraEmitterHandle>(FName(TEXT("NiagaraEmitterHandle")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bIsolated_MetaData[];
#endif
		static void NewProp_bIsolated_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsolated;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewProp_bIsolated_MetaData[] = {
		{ "ModuleRelativePath", "Classes/NiagaraEmitterHandle.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewProp_bIsolated = { "bIsolated", nullptr, (EPropertyFlags)0x0040000800002000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FNiagaraEmitterHandle), &Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewProp_bIsolated_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewProp_bIsolated_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewProp_bIsolated_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewProp_bIsolated,
#endif // WITH_EDITORONLY_DATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Hash() { return 2334595368U; }
