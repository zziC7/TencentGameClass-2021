...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UBTNode_Statics::NewProp_NodeName = { "NodeName", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTNode, NodeName), METADATA_PARAMS(Z_Construct_UClass_UBTNode_Statics::NewProp_NodeName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTNode_Statics::NewProp_NodeName_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UBTNode, 1232640741);
