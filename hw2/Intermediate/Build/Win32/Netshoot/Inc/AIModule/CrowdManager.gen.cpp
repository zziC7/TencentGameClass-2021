...
static struct FScriptStruct_AIModule_StaticRegisterNativesFCrowdAvoidanceSamplingPattern
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCrowdAvoidanceSamplingPattern>(FName(TEXT("CrowdAvoidanceSamplingPattern")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FCrowdAvoidanceSamplingPattern_Hash() { return 201320487U; }
...
static struct FScriptStruct_AIModule_StaticRegisterNativesFCrowdAvoidanceConfig
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCrowdAvoidanceConfig>(FName(TEXT("CrowdAvoidanceConfig")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_VelocityBias = { "VelocityBias", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCrowdAvoidanceConfig, VelocityBias), METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_VelocityBias_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_VelocityBias_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_DesiredVelocityWeight = { "DesiredVelocityWeight", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCrowdAvoidanceConfig, DesiredVelocityWeight), METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_DesiredVelocityWeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_DesiredVelocityWeight_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_SideBiasWeight = { "SideBiasWeight", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCrowdAvoidanceConfig, SideBiasWeight), METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_SideBiasWeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_SideBiasWeight_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_CustomPatternIdx = { "CustomPatternIdx", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCrowdAvoidanceConfig, CustomPatternIdx), nullptr, METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_CustomPatternIdx_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_CustomPatternIdx_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_AdaptiveDivisions = { "AdaptiveDivisions", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCrowdAvoidanceConfig, AdaptiveDivisions), nullptr, METADATA_PARAMS(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_AdaptiveDivisions_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Statics::NewProp_AdaptiveDivisions_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FCrowdAvoidanceConfig_Hash() { return 893792972U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_DebugDrawingWorld_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_DebugDrawingWorld;
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCrowdManager_Statics::NewProp_AvoidanceConfig = { "AvoidanceConfig", nullptr, (EPropertyFlags)0x0020080000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCrowdManager, AvoidanceConfig), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCrowdManager_Statics::NewProp_AvoidanceConfig_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCrowdManager_Statics::NewProp_AvoidanceConfig_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCrowdManager_Statics::NewProp_SamplingPatterns = { "SamplingPatterns", nullptr, (EPropertyFlags)0x0020080000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCrowdManager, SamplingPatterns), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCrowdManager_Statics::NewProp_SamplingPatterns_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCrowdManager_Statics::NewProp_SamplingPatterns_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UCrowdManager_Statics::NewProp_MaxAgents = { "MaxAgents", nullptr, (EPropertyFlags)0x0020080000004001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCrowdManager, MaxAgents), METADATA_PARAMS(Z_Construct_UClass_UCrowdManager_Statics::NewProp_MaxAgents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCrowdManager_Statics::NewProp_MaxAgents_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCrowdManager_Statics::NewProp_MaxAgentRadius = { "MaxAgentRadius", nullptr, (EPropertyFlags)0x0020080000004001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCrowdManager, MaxAgentRadius), METADATA_PARAMS(Z_Construct_UClass_UCrowdManager_Statics::NewProp_MaxAgentRadius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCrowdManager_Statics::NewProp_MaxAgentRadius_MetaData)) };
#if WITH_METADATA
...
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCrowdManager_Statics::NewProp_DebugDrawingWorld_MetaData[] = {
		{ "Comment", "/** UWorld that's going to be used for debug drawing calls. DebugDrawingWorld should be different than GetWorld()\n\x09 *\x09only on dedicated-server.\n\x09 *\x09Note that this is only relevant when ENABLE_DRAW_DEBUG is enabled*/" },
		{ "ModuleRelativePath", "Classes/Navigation/CrowdManager.h" },
		{ "ToolTip", "UWorld that's going to be used for debug drawing calls. DebugDrawingWorld should be different than GetWorld()\n    only on dedicated-server.\n    Note that this is only relevant when ENABLE_DRAW_DEBUG is enabled" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCrowdManager_Statics::NewProp_DebugDrawingWorld = { "DebugDrawingWorld", nullptr, (EPropertyFlags)0x0020080800002000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCrowdManager, DebugDrawingWorld), Z_Construct_UClass_UWorld_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCrowdManager_Statics::NewProp_DebugDrawingWorld_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCrowdManager_Statics::NewProp_DebugDrawingWorld_MetaData)) };
#endif // WITH_EDITORONLY_DATA
...
#if WITH_EDITORONLY_DATA
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCrowdManager_Statics::NewProp_DebugDrawingWorld,
#endif // WITH_EDITORONLY_DATA
	};
	...
	IMPLEMENT_CLASS(UCrowdManager, 3738655691);
