...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EPointOnCircleSpacingMethod_Hash() { return 1022916545U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnvQueryGenerator_OnCircle_Statics::NewProp_SpaceBetween = { "SpaceBetween", nullptr, (EPropertyFlags)0x0010008000010001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryGenerator_OnCircle, SpaceBetween), Z_Construct_UScriptStruct_FAIDataProviderFloatValue, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryGenerator_OnCircle_Statics::NewProp_SpaceBetween_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryGenerator_OnCircle_Statics::NewProp_SpaceBetween_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UEnvQueryGenerator_OnCircle_Statics::NewProp_PointOnCircleSpacingMethod = { "PointOnCircleSpacingMethod", nullptr, (EPropertyFlags)0x0010000000010001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryGenerator_OnCircle, PointOnCircleSpacingMethod), Z_Construct_UEnum_AIModule_EPointOnCircleSpacingMethod, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryGenerator_OnCircle_Statics::NewProp_PointOnCircleSpacingMethod_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryGenerator_OnCircle_Statics::NewProp_PointOnCircleSpacingMethod_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UEnvQueryGenerator_OnCircle, 536135964);
