...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UEnvQueryNode_Statics::NewProp_VerNum = { "VerNum", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryNode, VerNum), METADATA_PARAMS(Z_Construct_UClass_UEnvQueryNode_Statics::NewProp_VerNum_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryNode_Statics::NewProp_VerNum_MetaData)) };
	...
	IMPLEMENT_CLASS(UEnvQueryNode, 333556522);
