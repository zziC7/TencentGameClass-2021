...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAINoiseEvent
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAINoiseEvent>(FName(TEXT("AINoiseEvent")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAINoiseEvent_Hash() { return 1257881623U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAISense_Hearing_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAISense_Hearing_ReportNoiseEvent, "ReportNoiseEvent" }, // 3894025540
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAISense_Hearing, 86464945);
