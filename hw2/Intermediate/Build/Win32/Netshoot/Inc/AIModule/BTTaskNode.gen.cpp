...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBTTaskNode_Statics::NewProp_bIgnoreRestartSelf = { "bIgnoreRestartSelf", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UBTTaskNode), &Z_Construct_UClass_UBTTaskNode_Statics::NewProp_bIgnoreRestartSelf_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBTTaskNode_Statics::NewProp_bIgnoreRestartSelf_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTTaskNode_Statics::NewProp_bIgnoreRestartSelf_MetaData)) };
	...
	IMPLEMENT_CLASS(UBTTaskNode, 704592838);
