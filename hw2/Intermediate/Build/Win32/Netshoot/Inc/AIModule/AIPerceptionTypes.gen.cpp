...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EAISenseNotifyType_Hash() { return 2151106355U; }
...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAISenseAffiliationFilter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAISenseAffiliationFilter>(FName(TEXT("AISenseAffiliationFilter")));
	}
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectEnemies = { "bDetectEnemies", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FAISenseAffiliationFilter), &Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectEnemies_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectEnemies_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectEnemies_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectNeutrals = { "bDetectNeutrals", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FAISenseAffiliationFilter), &Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectNeutrals_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectNeutrals_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectNeutrals_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Hash() { return 2367416787U; }
...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAIStimulus
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAIStimulus>(FName(TEXT("AIStimulus")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Age = { "Age", nullptr, (EPropertyFlags)0x0020080000000004, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, Age), METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Age_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Age_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Strength = { "Strength", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, Strength), METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Strength_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Strength_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_ReceiverLocation = { "ReceiverLocation", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, ReceiverLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_ReceiverLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_ReceiverLocation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, Tag), METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Tag_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Tag_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAIStimulus_Hash() { return 585541362U; }
