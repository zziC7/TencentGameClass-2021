...
// End Cross Module References
	...
	struct Z_Construct_UFunction_UAITask_MoveTo_AIMoveTo_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_ProjectGoalOnNavigation;
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAITask_MoveTo_AIMoveTo_Statics::NewProp_ProjectGoalOnNavigation = { "ProjectGoalOnNavigation", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AITask_MoveTo_eventAIMoveTo_Parms, ProjectGoalOnNavigation), Z_Construct_UEnum_AIModule_EAIOptionFlag, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAITask_MoveTo_AIMoveTo_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAITask_MoveTo_AIMoveTo_Statics::NewProp_ProjectGoalOnNavigation,
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAITask_MoveTo_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAITask_MoveTo_AIMoveTo, "AIMoveTo" }, // 2258482070
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAITask_MoveTo_Statics::NewProp_OnRequestFailed = { "OnRequestFailed", nullptr, (EPropertyFlags)0x0020080010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAITask_MoveTo, OnRequestFailed), Z_Construct_UDelegateFunction_UGameplayTask_GenericGameplayTaskDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAITask_MoveTo_Statics::NewProp_OnRequestFailed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAITask_MoveTo_Statics::NewProp_OnRequestFailed_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAITask_MoveTo_Statics::NewProp_OnMoveFinished_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Tasks/AITask_MoveTo.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAITask_MoveTo_Statics::NewProp_OnMoveFinished = { "OnMoveFinished", nullptr, (EPropertyFlags)0x0020080010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAITask_MoveTo, OnMoveFinished), Z_Construct_UDelegateFunction_AIModule_MoveTaskCompletedSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAITask_MoveTo_Statics::NewProp_OnMoveFinished_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAITask_MoveTo_Statics::NewProp_OnMoveFinished_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAITask_MoveTo, 1585077147);
