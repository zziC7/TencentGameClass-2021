...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UBTDecorator_CheckGameplayTagsOnActor_Statics::NewProp_TagsToMatch = { "TagsToMatch", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_CheckGameplayTagsOnActor, TagsToMatch), Z_Construct_UEnum_GameplayTags_EGameplayContainerMatchType, METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_CheckGameplayTagsOnActor_Statics::NewProp_TagsToMatch_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_CheckGameplayTagsOnActor_Statics::NewProp_TagsToMatch_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBTDecorator_CheckGameplayTagsOnActor_Statics::NewProp_GameplayTags = { "GameplayTags", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_CheckGameplayTagsOnActor, GameplayTags), Z_Construct_UScriptStruct_FGameplayTagContainer, METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_CheckGameplayTagsOnActor_Statics::NewProp_GameplayTags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_CheckGameplayTagsOnActor_Statics::NewProp_GameplayTags_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UBTDecorator_CheckGameplayTagsOnActor, 570854436);
