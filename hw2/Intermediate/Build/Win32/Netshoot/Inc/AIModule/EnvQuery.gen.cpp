...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UEnvQuery_Statics::NewProp_QueryName = { "QueryName", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQuery, QueryName), METADATA_PARAMS(Z_Construct_UClass_UEnvQuery_Statics::NewProp_QueryName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQuery_Statics::NewProp_QueryName_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEnvQuery_Statics::NewProp_Options = { "Options", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQuery, Options), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEnvQuery_Statics::NewProp_Options_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQuery_Statics::NewProp_Options_MetaData)) };
	...
	IMPLEMENT_CLASS(UEnvQuery, 337467145);
