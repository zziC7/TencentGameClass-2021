...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex_Statics::NewProp_Controller_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex_Statics::NewProp_Controller = { "Controller", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIBlueprintHelperLibrary_eventGetCurrentPathIndex_Parms, Controller), Z_Construct_UClass_AController_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex_Statics::NewProp_Controller_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex_Statics::NewProp_Controller_MetaData)) };
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIBlueprintHelperLibrary_eventGetCurrentPathIndex_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex_Statics::NewProp_Controller,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex_Statics::Function_MetaDataParams[] = {
		{ "Category", "AI" },
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::NewProp_Controller = { "Controller", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIBlueprintHelperLibrary_eventGetCurrentPathPoints_Parms, Controller), Z_Construct_UClass_AController_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::NewProp_ReturnValue_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000582, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIBlueprintHelperLibrary_eventGetCurrentPathPoints_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::NewProp_ReturnValue_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::NewProp_Controller,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::NewProp_ReturnValue_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::Function_MetaDataParams[] = {
		{ "Category", "AI" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAIBlueprintHelperLibrary, nullptr, "GetCurrentPathPoints", nullptr, nullptr, sizeof(AIBlueprintHelperLibrary_eventGetCurrentPathPoints_Parms), Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex_Statics::NewProp_Controller_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex_Statics::NewProp_Controller = { "Controller", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIBlueprintHelperLibrary_eventGetNextNavLinkIndex_Parms, Controller), Z_Construct_UClass_AController_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex_Statics::NewProp_Controller_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex_Statics::NewProp_Controller_MetaData)) };
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AIBlueprintHelperLibrary_eventGetNextNavLinkIndex_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex_Statics::NewProp_Controller,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex_Statics::Function_MetaDataParams[] = {
		{ "Category", "AI" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAIBlueprintHelperLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_CreateMoveToProxyObject, "CreateMoveToProxyObject" }, // 2990794368
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetAIController, "GetAIController" }, // 279063381
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetBlackboard, "GetBlackboard" }, // 3595531771
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPath, "GetCurrentPath" }, // 2279723688
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathIndex, "GetCurrentPathIndex" }, // 1484637426
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetCurrentPathPoints, "GetCurrentPathPoints" }, // 1785992561
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_GetNextNavLinkIndex, "GetNextNavLinkIndex" }, // 676278255
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_IsValidAIDirection, "IsValidAIDirection" }, // 1837456232
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_IsValidAILocation, "IsValidAILocation" }, // 2317551659
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_IsValidAIRotation, "IsValidAIRotation" }, // 1209590732
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_LockAIResourcesWithAnimation, "LockAIResourcesWithAnimation" }, // 1700284056
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_SendAIMessage, "SendAIMessage" }, // 246866840
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_SimpleMoveToActor, "SimpleMoveToActor" }, // 879925984
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_SimpleMoveToLocation, "SimpleMoveToLocation" }, // 2876326138
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_SpawnAIFromClass, "SpawnAIFromClass" }, // 172984550
		{ &Z_Construct_UFunction_UAIBlueprintHelperLibrary_UnlockAIResourcesWithAnimation, "UnlockAIResourcesWithAnimation" }, // 1869614421
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAIBlueprintHelperLibrary, 1124872281);
