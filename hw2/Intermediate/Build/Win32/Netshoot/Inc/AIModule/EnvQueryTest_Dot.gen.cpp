...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EEnvTestDot_Hash() { return 3278460916U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineA = { "LineA", nullptr, (EPropertyFlags)0x0020080000010001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_Dot, LineA), Z_Construct_UScriptStruct_FEnvDirection, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineA_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineA_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineB = { "LineB", nullptr, (EPropertyFlags)0x0020080000010001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_Dot, LineB), Z_Construct_UScriptStruct_FEnvDirection, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineB_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_TestMode = { "TestMode", nullptr, (EPropertyFlags)0x0020080000010001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_Dot, TestMode), Z_Construct_UEnum_AIModule_EEnvTestDot, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_TestMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_TestMode_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UEnvQueryTest_Dot, 3067684198);
