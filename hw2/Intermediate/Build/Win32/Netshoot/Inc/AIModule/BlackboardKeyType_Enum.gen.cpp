...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBlackboardKeyType_Enum_Statics::NewProp_EnumType = { "EnumType", nullptr, (EPropertyFlags)0x0010000000010001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlackboardKeyType_Enum, EnumType), Z_Construct_UClass_UEnum, METADATA_PARAMS(Z_Construct_UClass_UBlackboardKeyType_Enum_Statics::NewProp_EnumType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlackboardKeyType_Enum_Statics::NewProp_EnumType_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBlackboardKeyType_Enum_Statics::NewProp_bIsEnumNameValid = { "bIsEnumNameValid", nullptr, (EPropertyFlags)0x0010000000030001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UBlackboardKeyType_Enum), &Z_Construct_UClass_UBlackboardKeyType_Enum_Statics::NewProp_bIsEnumNameValid_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBlackboardKeyType_Enum_Statics::NewProp_bIsEnumNameValid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlackboardKeyType_Enum_Statics::NewProp_bIsEnumNameValid_MetaData)) };
	...
	IMPLEMENT_CLASS(UBlackboardKeyType_Enum, 930528616);
