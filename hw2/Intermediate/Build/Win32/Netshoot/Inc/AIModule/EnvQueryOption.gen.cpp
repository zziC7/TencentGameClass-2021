...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEnvQueryOption_Statics::NewProp_Tests = { "Tests", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryOption, Tests), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryOption_Statics::NewProp_Tests_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryOption_Statics::NewProp_Tests_MetaData)) };
	...
	IMPLEMENT_CLASS(UEnvQueryOption, 1496350163);
