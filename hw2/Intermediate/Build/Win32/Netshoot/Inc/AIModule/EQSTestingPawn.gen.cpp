...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AIModule_EEnvQueryHightlightMode_Hash() { return 1999400866U; }
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEQSTestingPawn_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/** this class is abstract even though it's perfectly functional on its own.\n *\x09The reason is to stop it from showing as valid player pawn type when configuring \n *\x09project's game mode. */" },
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AEQSTestingPawn_Statics::NewProp_QueryParams = { "QueryParams", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEQSTestingPawn, QueryParams), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AEQSTestingPawn_Statics::NewProp_QueryParams_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEQSTestingPawn_Statics::NewProp_QueryParams_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AEQSTestingPawn_Statics::NewProp_TimeLimitPerStep = { "TimeLimitPerStep", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEQSTestingPawn, TimeLimitPerStep), METADATA_PARAMS(Z_Construct_UClass_AEQSTestingPawn_Statics::NewProp_TimeLimitPerStep_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEQSTestingPawn_Statics::NewProp_TimeLimitPerStep_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_AEQSTestingPawn_Statics::NewProp_QueryingMode = { "QueryingMode", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEQSTestingPawn, QueryingMode), Z_Construct_UEnum_AIModule_EEnvQueryRunMode, METADATA_PARAMS(Z_Construct_UClass_AEQSTestingPawn_Statics::NewProp_QueryingMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEQSTestingPawn_Statics::NewProp_QueryingMode_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AEQSTestingPawn, 3257669667);
