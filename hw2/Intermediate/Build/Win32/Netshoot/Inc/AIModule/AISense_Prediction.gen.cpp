...
static struct FScriptStruct_AIModule_StaticRegisterNativesFAIPredictionEvent
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAIPredictionEvent>(FName(TEXT("AIPredictionEvent")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAIPredictionEvent_Hash() { return 661010165U; }
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAISense_Prediction_RequestPawnPredictionEvent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAISense_Prediction, nullptr, "RequestPawnPredictionEvent", nullptr, nullptr, sizeof(AISense_Prediction_eventRequestPawnPredictionEvent_Parms), Z_Construct_UFunction_UAISense_Prediction_RequestPawnPredictionEvent_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAISense_Prediction_RequestPawnPredictionEvent_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAISense_Prediction_RequestPawnPredictionEvent_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAISense_Prediction_RequestPawnPredictionEvent_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAISense_Prediction_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAISense_Prediction_RequestControllerPredictionEvent, "RequestControllerPredictionEvent" }, // 1356694315
		{ &Z_Construct_UFunction_UAISense_Prediction_RequestPawnPredictionEvent, "RequestPawnPredictionEvent" }, // 2632229377
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAISense_Prediction_Statics::NewProp_RegisteredEvents = { "RegisteredEvents", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Prediction, RegisteredEvents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAISense_Prediction_Statics::NewProp_RegisteredEvents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Prediction_Statics::NewProp_RegisteredEvents_MetaData)) };
	...
	IMPLEMENT_CLASS(UAISense_Prediction, 3533175900);
