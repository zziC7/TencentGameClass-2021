...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_NumLoops = { "NumLoops", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_Loop, NumLoops), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_NumLoops_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_NumLoops_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UBTDecorator_Loop, 1965477598);
