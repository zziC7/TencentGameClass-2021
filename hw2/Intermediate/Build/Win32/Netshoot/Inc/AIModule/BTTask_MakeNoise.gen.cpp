...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTTask_MakeNoise_Statics::NewProp_Loudnes = { "Loudnes", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTTask_MakeNoise, Loudnes), METADATA_PARAMS(Z_Construct_UClass_UBTTask_MakeNoise_Statics::NewProp_Loudnes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTTask_MakeNoise_Statics::NewProp_Loudnes_MetaData)) };
	...
	IMPLEMENT_CLASS(UBTTask_MakeNoise, 4007536078);
