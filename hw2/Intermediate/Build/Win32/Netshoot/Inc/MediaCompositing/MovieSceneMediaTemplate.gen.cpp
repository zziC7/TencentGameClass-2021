...
static struct FScriptStruct_MediaCompositing_StaticRegisterNativesFMovieSceneMediaSectionTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneMediaSectionTemplate>(FName(TEXT("MovieSceneMediaSectionTemplate")));
	}
...
static struct FScriptStruct_MediaCompositing_StaticRegisterNativesFMovieSceneMediaSectionParams
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneMediaSectionParams>(FName(TEXT("MovieSceneMediaSectionParams")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneMediaSectionParams_Hash() { return 940209803U; }
