...
static struct FScriptStruct_LiveLinkInterface_StaticRegisterNativesFLiveLinkRefSkeleton
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLiveLinkRefSkeleton>(FName(TEXT("LiveLinkRefSkeleton")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FLiveLinkRefSkeleton_Statics::NewProp_BoneNames = { "BoneNames", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLiveLinkRefSkeleton, BoneNames), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkRefSkeleton_Statics::NewProp_BoneNames_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkRefSkeleton_Statics::NewProp_BoneNames_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FLiveLinkRefSkeleton_Statics::NewProp_BoneParents = { "BoneParents", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLiveLinkRefSkeleton, BoneParents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FLiveLinkRefSkeleton_Statics::NewProp_BoneParents_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLiveLinkRefSkeleton_Statics::NewProp_BoneParents_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FLiveLinkRefSkeleton_Hash() { return 3031795861U; }
