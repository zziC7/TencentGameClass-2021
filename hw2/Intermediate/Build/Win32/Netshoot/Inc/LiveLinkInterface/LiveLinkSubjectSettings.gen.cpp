...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bRebroadcastSubject_MetaData[];
#endif
		static void NewProp_bRebroadcastSubject_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bRebroadcastSubject;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_FrameRate_MetaData[] = {
		{ "Category", "LiveLink" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULiveLinkSubjectSettings, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_FrameRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_FrameRate_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_bRebroadcastSubject_MetaData[] = {
		{ "Category", "LiveLink" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_bRebroadcastSubject = { "bRebroadcastSubject", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ULiveLinkSubjectSettings), &Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_bRebroadcastSubject_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_bRebroadcastSubject_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_bRebroadcastSubject_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_FrameRate,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULiveLinkSubjectSettings_Statics::NewProp_bRebroadcastSubject,
	};
	...
	IMPLEMENT_CLASS(ULiveLinkSubjectSettings, 499055394);
