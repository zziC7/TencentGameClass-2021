...
static struct FScriptStruct_SlateReflector_StaticRegisterNativesFWidgetSnapshotResponse
{
	...
	{
		UScriptStruct::DeferCppStructOps<FWidgetSnapshotResponse>(FName(TEXT("WidgetSnapshotResponse")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FWidgetSnapshotResponse_Hash() { return 4212812706U; }
...
static struct FScriptStruct_SlateReflector_StaticRegisterNativesFWidgetSnapshotRequest
{
	...
	{
		UScriptStruct::DeferCppStructOps<FWidgetSnapshotRequest>(FName(TEXT("WidgetSnapshotRequest")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FWidgetSnapshotRequest_Hash() { return 121440367U; }
