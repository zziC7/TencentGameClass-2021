...
static struct FScriptStruct_AutomationController_StaticRegisterNativesFAutomatedTestGroup
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAutomatedTestGroup>(FName(TEXT("AutomatedTestGroup")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAutomatedTestGroup_Hash() { return 991618392U; }
...
static struct FScriptStruct_AutomationController_StaticRegisterNativesFAutomatedTestFilter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAutomatedTestFilter>(FName(TEXT("AutomatedTestFilter")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAutomatedTestFilter_Hash() { return 1715537212U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bSuppressLogErrors_MetaData[];
#endif
		static void NewProp_bSuppressLogErrors_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSuppressLogErrors;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bSuppressLogWarnings_MetaData[];
#endif
		static void NewProp_bSuppressLogWarnings_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSuppressLogWarnings;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogErrors_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogErrors = { "bSuppressLogErrors", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAutomationControllerSettings), &Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogErrors_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogErrors_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogErrors_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogWarnings_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogWarnings = { "bSuppressLogWarnings", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAutomationControllerSettings), &Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogWarnings_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogWarnings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogWarnings_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAutomationControllerSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogErrors,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAutomationControllerSettings_Statics::NewProp_bSuppressLogWarnings,
	...
	IMPLEMENT_CLASS(UAutomationControllerSettings, 736049394);
