...
static struct FScriptStruct_GeometryCache_StaticRegisterNativesFGeometryCacheMeshData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGeometryCacheMeshData>(FName(TEXT("GeometryCacheMeshData")));
	}
...
static struct FScriptStruct_GeometryCache_StaticRegisterNativesFGeometryCacheVertexInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGeometryCacheVertexInfo>(FName(TEXT("GeometryCacheVertexInfo")));
	}
...
static struct FScriptStruct_GeometryCache_StaticRegisterNativesFGeometryCacheMeshBatchInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGeometryCacheMeshBatchInfo>(FName(TEXT("GeometryCacheMeshBatchInfo")));
	}
