...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames = { "PlatformPlayerNames", nullptr, (EPropertyFlags)0x0010000800002005, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBaseMediaSource, PlatformPlayerNames), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlayerName = { "PlayerName", nullptr, (EPropertyFlags)0x0040000000002000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBaseMediaSource, PlayerName), METADATA_PARAMS(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlayerName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlayerName_MetaData)) };
	...
	IMPLEMENT_CLASS(UBaseMediaSource, 1587957559);
