...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Slate_ETextFlowDirection_Hash() { return 879809313U; }
	...
	uint32 Get_Z_Construct_UEnum_Slate_ETextWrappingPolicy_Hash() { return 1884693365U; }
	...
	static UEnum* ETextTransformPolicy_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Slate_ETextTransformPolicy, Z_Construct_UPackage__Script_Slate(), TEXT("ETextTransformPolicy"));
		}
		return Singleton;
	}
	template<> SLATE_API UEnum* StaticEnum<ETextTransformPolicy>()
	{
		return ETextTransformPolicy_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ETextTransformPolicy(ETextTransformPolicy_StaticEnum, TEXT("/Script/Slate"), TEXT("ETextTransformPolicy"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Slate_ETextTransformPolicy_Hash() { return 66446480U; }
	UEnum* Z_Construct_UEnum_Slate_ETextTransformPolicy()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Slate();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ETextTransformPolicy"), 0, Get_Z_Construct_UEnum_Slate_ETextTransformPolicy_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	uint32 Get_Z_Construct_UEnum_Slate_ETextJustify_Hash() { return 3559546382U; }
