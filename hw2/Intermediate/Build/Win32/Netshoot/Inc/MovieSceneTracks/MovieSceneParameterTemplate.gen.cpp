...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneComponentMaterialSectionTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneComponentMaterialSectionTemplate>(FName(TEXT("MovieSceneComponentMaterialSectionTemplate")));
	}
...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneParameterSectionTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneParameterSectionTemplate>(FName(TEXT("MovieSceneParameterSectionTemplate")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneParameterSectionTemplate_Hash() { return 1400079514U; }
