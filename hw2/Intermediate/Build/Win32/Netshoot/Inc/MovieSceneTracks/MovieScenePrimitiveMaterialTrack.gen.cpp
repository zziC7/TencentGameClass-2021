...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieScenePrimitiveMaterialTrack_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieScenePrimitiveMaterialTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieScenePrimitiveMaterialTrack, IMovieSceneTrackTemplateProducer), false },
		};
	...
	IMPLEMENT_CLASS(UMovieScenePrimitiveMaterialTrack, 431758761);
