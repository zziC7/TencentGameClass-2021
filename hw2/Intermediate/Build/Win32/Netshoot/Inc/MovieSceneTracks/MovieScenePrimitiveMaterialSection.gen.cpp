...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieScenePrimitiveMaterialSection_Statics::NewProp_MaterialChannel = { "MaterialChannel", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieScenePrimitiveMaterialSection, MaterialChannel), Z_Construct_UScriptStruct_FMovieSceneObjectPathChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieScenePrimitiveMaterialSection_Statics::NewProp_MaterialChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScenePrimitiveMaterialSection_Statics::NewProp_MaterialChannel_MetaData)) };
	...
	IMPLEMENT_CLASS(UMovieScenePrimitiveMaterialSection, 671040185);
