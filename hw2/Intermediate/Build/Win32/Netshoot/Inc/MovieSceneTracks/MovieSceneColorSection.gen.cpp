...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneColorKeyStruct
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneColorKeyStruct>(FName(TEXT("MovieSceneColorKeyStruct")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneColorKeyStruct_Hash() { return 2084963269U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_GreenCurve = { "GreenCurve", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneColorSection, GreenCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_GreenCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_GreenCurve_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneColorSection_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneColorSection_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneEntityProvider_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneColorSection, IMovieSceneEntityProvider), false },
		};
	...
	IMPLEMENT_CLASS(UMovieSceneColorSection, 2924842099);
