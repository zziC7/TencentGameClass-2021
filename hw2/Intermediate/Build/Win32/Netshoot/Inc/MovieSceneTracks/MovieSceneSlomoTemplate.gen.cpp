...
static struct FScriptStruct_MovieSceneTracks_StaticRegisterNativesFMovieSceneSlomoSectionTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneSlomoSectionTemplate>(FName(TEXT("MovieSceneSlomoSectionTemplate")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneSlomoSectionTemplate_Statics::NewProp_SlomoCurve = { "SlomoCurve", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSlomoSectionTemplate, SlomoCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSlomoSectionTemplate_Statics::NewProp_SlomoCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSlomoSectionTemplate_Statics::NewProp_SlomoCurve_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSlomoSectionTemplate_Hash() { return 4172736273U; }
