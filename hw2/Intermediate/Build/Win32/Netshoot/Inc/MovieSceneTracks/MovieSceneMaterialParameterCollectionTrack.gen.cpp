...
// End Cross Module References
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneMaterialParameterCollectionTrack_Statics::PropPointers[] = {
		...
		const UE4CodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneMaterialParameterCollectionTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneMaterialParameterCollectionTrack, IMovieSceneTrackTemplateProducer), false },
		};
	...
	IMPLEMENT_CLASS(UMovieSceneMaterialParameterCollectionTrack, 2071723795);
