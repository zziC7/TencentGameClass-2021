...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_UMG_EDynamicBoxType_Hash() { return 1898792566U; }
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::NewProp_InSettings_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(DynamicEntryBoxBase_eventSetRadialSettings_Parms, InSettings), Z_Construct_UScriptStruct_FRadialBoxSettings, METADATA_PARAMS(Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::NewProp_InSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::NewProp_InSettings_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::NewProp_InSettings,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::Function_MetaDataParams[] = {
		{ "Category", "DynamicEntryBox" },
		{ "ModuleRelativePath", "Public/Components/DynamicEntryBoxBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UDynamicEntryBoxBase, nullptr, "SetRadialSettings", nullptr, nullptr, sizeof(DynamicEntryBoxBase_eventSetRadialSettings_Parms), Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_RadialBoxSettings_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_RadialBoxSettings;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UDynamicEntryBoxBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UDynamicEntryBoxBase_GetAllEntries, "GetAllEntries" }, // 4010542314
		...
		{ &Z_Construct_UFunction_UDynamicEntryBoxBase_SetRadialSettings, "SetRadialSettings" }, // 3267637570
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDynamicEntryBoxBase_Statics::NewProp_RadialBoxSettings_MetaData[] = {
		{ "Category", "EntryLayout" },
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDynamicEntryBoxBase_Statics::NewProp_RadialBoxSettings = { "RadialBoxSettings", nullptr, (EPropertyFlags)0x0020080000000015, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDynamicEntryBoxBase, RadialBoxSettings), Z_Construct_UScriptStruct_FRadialBoxSettings, METADATA_PARAMS(Z_Construct_UClass_UDynamicEntryBoxBase_Statics::NewProp_RadialBoxSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDynamicEntryBoxBase_Statics::NewProp_RadialBoxSettings_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDynamicEntryBoxBase_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDynamicEntryBoxBase_Statics::NewProp_RadialBoxSettings,
	...
	IMPLEMENT_CLASS(UDynamicEntryBoxBase, 704801286);
