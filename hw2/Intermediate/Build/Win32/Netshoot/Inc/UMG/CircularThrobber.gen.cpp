...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCircularThrobber_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCircularThrobber_SetNumberOfPieces, "SetNumberOfPieces" }, // 4212292323
		{ &Z_Construct_UFunction_UCircularThrobber_SetPeriod, "SetPeriod" }, // 43120319
		{ &Z_Construct_UFunction_UCircularThrobber_SetRadius, "SetRadius" }, // 1706134533
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UCircularThrobber_Statics::NewProp_NumberOfPieces = { "NumberOfPieces", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCircularThrobber, NumberOfPieces), METADATA_PARAMS(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_NumberOfPieces_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_NumberOfPieces_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCircularThrobber_Statics::NewProp_Period = { "Period", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCircularThrobber, Period), METADATA_PARAMS(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_Period_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_Period_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCircularThrobber_Statics::NewProp_PieceImage = { "PieceImage", nullptr, (EPropertyFlags)0x0010000020000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCircularThrobber, PieceImage_DEPRECATED), Z_Construct_UClass_USlateBrushAsset_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_PieceImage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCircularThrobber_Statics::NewProp_PieceImage_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCircularThrobber, 2342492234);
