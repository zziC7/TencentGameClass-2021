...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAsyncTaskDownloadImage_DownloadImage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAsyncTaskDownloadImage, nullptr, "DownloadImage", nullptr, nullptr, sizeof(AsyncTaskDownloadImage_eventDownloadImage_Parms), Z_Construct_UFunction_UAsyncTaskDownloadImage_DownloadImage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAsyncTaskDownloadImage_DownloadImage_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAsyncTaskDownloadImage_DownloadImage_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAsyncTaskDownloadImage_DownloadImage_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAsyncTaskDownloadImage_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAsyncTaskDownloadImage_DownloadImage, "DownloadImage" }, // 433101722
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAsyncTaskDownloadImage_Statics::NewProp_OnSuccess = { "OnSuccess", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAsyncTaskDownloadImage, OnSuccess), Z_Construct_UDelegateFunction_UMG_DownloadImageDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAsyncTaskDownloadImage_Statics::NewProp_OnSuccess_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAsyncTaskDownloadImage_Statics::NewProp_OnSuccess_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAsyncTaskDownloadImage_Statics::NewProp_OnFail_MetaData[] = {
		{ "ModuleRelativePath", "Public/Blueprint/AsyncTaskDownloadImage.h" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAsyncTaskDownloadImage_Statics::NewProp_OnFail = { "OnFail", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAsyncTaskDownloadImage, OnFail), Z_Construct_UDelegateFunction_UMG_DownloadImageDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAsyncTaskDownloadImage_Statics::NewProp_OnFail_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAsyncTaskDownloadImage_Statics::NewProp_OnFail_MetaData)) };
	...
	IMPLEMENT_CLASS(UAsyncTaskDownloadImage, 1587927259);
