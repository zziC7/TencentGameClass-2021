...
static struct FScriptStruct_UMG_StaticRegisterNativesFSlateMeshVertex
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSlateMeshVertex>(FName(TEXT("SlateMeshVertex")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSlateMeshVertex_Hash() { return 4007700435U; }
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USlateVectorArtData_Statics::NewProp_MeshAsset = { "MeshAsset", nullptr, (EPropertyFlags)0x0040000800000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USlateVectorArtData, MeshAsset), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USlateVectorArtData_Statics::NewProp_MeshAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlateVectorArtData_Statics::NewProp_MeshAsset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USlateVectorArtData_Statics::NewProp_IndexData = { "IndexData", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USlateVectorArtData, IndexData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_USlateVectorArtData_Statics::NewProp_IndexData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlateVectorArtData_Statics::NewProp_IndexData_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USlateVectorArtData, 772019520);
