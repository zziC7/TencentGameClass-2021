...
static struct FScriptStruct_AnimationCore_StaticRegisterNativesFNodeChain
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNodeChain>(FName(TEXT("NodeChain")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes = { "Nodes", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNodeChain, Nodes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FNodeChain_Hash() { return 3212257434U; }
