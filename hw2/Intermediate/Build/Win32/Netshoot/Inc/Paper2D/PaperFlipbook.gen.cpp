...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Paper2D_EFlipbookCollisionMode_Hash() { return 1256503460U; }
...
static struct FScriptStruct_Paper2D_StaticRegisterNativesFPaperFlipbookKeyFrame
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPaperFlipbookKeyFrame>(FName(TEXT("PaperFlipbookKeyFrame")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPaperFlipbookKeyFrame_Hash() { return 32218679U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPaperFlipbook_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPaperFlipbook_GetKeyFrameIndexAtTime, "GetKeyFrameIndexAtTime" }, // 1781754329
		...
		{ &Z_Construct_UFunction_UPaperFlipbook_GetSpriteAtFrame, "GetSpriteAtFrame" }, // 3964046126
		{ &Z_Construct_UFunction_UPaperFlipbook_GetSpriteAtTime, "GetSpriteAtTime" }, // 3039024397
		{ &Z_Construct_UFunction_UPaperFlipbook_GetTotalDuration, "GetTotalDuration" }, // 3935743657
		{ &Z_Construct_UFunction_UPaperFlipbook_IsValidKeyFrameIndex, "IsValidKeyFrameIndex" }, // 2893915888
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UPaperFlipbook, 1063941968);
