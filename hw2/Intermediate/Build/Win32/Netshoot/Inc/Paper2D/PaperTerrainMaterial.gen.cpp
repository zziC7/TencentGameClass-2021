...
static struct FScriptStruct_Paper2D_StaticRegisterNativesFPaperTerrainMaterialRule
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPaperTerrainMaterialRule>(FName(TEXT("PaperTerrainMaterialRule")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPaperTerrainMaterialRule_Hash() { return 1775854615U; }
	...
	IMPLEMENT_CLASS(UPaperTerrainMaterial, 3051504103);
