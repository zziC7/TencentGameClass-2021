...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_InputCore_ETouchType_Hash() { return 5610002U; }
	...
	uint32 Get_Z_Construct_UEnum_InputCore_EConsoleForGamepadLabels_Hash() { return 1609700786U; }
	...
	uint32 Get_Z_Construct_UEnum_InputCore_ETouchIndex_Hash() { return 2149940907U; }
	...
	uint32 Get_Z_Construct_UEnum_InputCore_EControllerHand_Hash() { return 1164571473U; }
...
static struct FScriptStruct_InputCore_StaticRegisterNativesFKey
{
	...
	{
		UScriptStruct::DeferCppStructOps<FKey>(FName(TEXT("Key")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FKey_Statics::NewProp_KeyName = { "KeyName", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKey, KeyName), METADATA_PARAMS(Z_Construct_UScriptStruct_FKey_Statics::NewProp_KeyName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKey_Statics::NewProp_KeyName_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FKey_Hash() { return 1623365999U; }
	...
	IMPLEMENT_CLASS(UInputCoreTypes, 3972982574);
