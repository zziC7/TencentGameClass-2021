...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAppendSubjectNameToBones_MetaData[];
#endif
		static void NewProp_bAppendSubjectNameToBones_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAppendSubjectNameToBones;
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULiveLinkAnimationVirtualSubject_Statics::NewProp_bAppendSubjectNameToBones_MetaData[] = {
		{ "Category", "Settings" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULiveLinkAnimationVirtualSubject_Statics::NewProp_bAppendSubjectNameToBones = { "bAppendSubjectNameToBones", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ULiveLinkAnimationVirtualSubject), &Z_Construct_UClass_ULiveLinkAnimationVirtualSubject_Statics::NewProp_bAppendSubjectNameToBones_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULiveLinkAnimationVirtualSubject_Statics::NewProp_bAppendSubjectNameToBones_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULiveLinkAnimationVirtualSubject_Statics::NewProp_bAppendSubjectNameToBones_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULiveLinkAnimationVirtualSubject_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULiveLinkAnimationVirtualSubject_Statics::NewProp_bAppendSubjectNameToBones,
	};
	...
	IMPLEMENT_CLASS(ULiveLinkAnimationVirtualSubject, 1617119346);
