...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNavLinkComponent_Statics::NewProp_Links = { "Links", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNavLinkComponent, Links), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNavLinkComponent_Statics::NewProp_Links_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNavLinkComponent_Statics::NewProp_Links_MetaData)) };
	...
	IMPLEMENT_CLASS(UNavLinkComponent, 366126174);
