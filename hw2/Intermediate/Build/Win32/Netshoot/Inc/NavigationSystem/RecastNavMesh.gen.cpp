...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_NavigationSystem_ERecastPartitioning_Hash() { return 919579386U; }
...
static struct FScriptStruct_NavigationSystem_StaticRegisterNativesFRecastNavMeshGenerationProperties
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRecastNavMeshGenerationProperties>(FName(TEXT("RecastNavMeshGenerationProperties")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bUseExtraTopCellWhenMarkingAreas_MetaData[];
#endif
		static void NewProp_bUseExtraTopCellWhenMarkingAreas_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bUseExtraTopCellWhenMarkingAreas;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRecastNavMeshGenerationProperties_Statics::NewProp_bUseExtraTopCellWhenMarkingAreas_MetaData[] = {
		{ "Category", "Generation" },
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FRecastNavMeshGenerationProperties_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FRecastNavMeshGenerationProperties_Statics::NewProp_bUseExtraTopCellWhenMarkingAreas,
	...
	uint32 Get_Z_Construct_UScriptStruct_FRecastNavMeshGenerationProperties_Hash() { return 3712472674U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bDrawPolygonFlags_MetaData[];
#endif
		static void NewProp_bDrawPolygonFlags_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bDrawPolygonFlags;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ARecastNavMesh_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ARecastNavMesh_K2_ReplaceAreaInTileBounds, "K2_ReplaceAreaInTileBounds" }, // 1897735575
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bDrawPolygonFlags_MetaData[] = {
		{ "Category", "Display" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bDrawPolygonFlags = { "bDrawPolygonFlags", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ARecastNavMesh), &Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bDrawPolygonFlags_SetBit, METADATA_PARAMS(Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bDrawPolygonFlags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bDrawPolygonFlags_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bUseExtraTopCellWhenMarkingAreas_MetaData[] = {
		{ "Category", "Generation" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bUseExtraTopCellWhenMarkingAreas = { "bUseExtraTopCellWhenMarkingAreas", nullptr, (EPropertyFlags)0x0010040000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ARecastNavMesh), &Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bUseExtraTopCellWhenMarkingAreas_SetBit, METADATA_PARAMS(Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bUseExtraTopCellWhenMarkingAreas_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bUseExtraTopCellWhenMarkingAreas_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ARecastNavMesh_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bDrawPolygonFlags,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ARecastNavMesh_Statics::NewProp_bUseExtraTopCellWhenMarkingAreas,
	...
	IMPLEMENT_CLASS(ARecastNavMesh, 1211036193);
