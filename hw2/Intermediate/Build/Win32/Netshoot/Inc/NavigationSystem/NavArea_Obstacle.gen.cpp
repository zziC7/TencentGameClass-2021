...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNavArea_Obstacle_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UNavArea_Obstacle_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UNavArea_Obstacle()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UNavArea_Obstacle_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UNavArea_Obstacle, 3817294441);
	template<> NAVIGATIONSYSTEM_API UClass* StaticClass<UNavArea_Obstacle>()
	{
		return UNavArea_Obstacle::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UNavArea_Obstacle(Z_Construct_UClass_UNavArea_Obstacle, &UNavArea_Obstacle::StaticClass, TEXT("/Script/NavigationSystem"), TEXT("UNavArea_Obstacle"), false, nullptr, nullptr, nullptr);
