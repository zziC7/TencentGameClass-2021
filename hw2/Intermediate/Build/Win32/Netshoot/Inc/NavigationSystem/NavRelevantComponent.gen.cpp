...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNavRelevantComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNavRelevantComponent_SetNavigationRelevancy, "SetNavigationRelevancy" }, // 1787451759
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNavRelevantComponent_Statics::NewProp_bAttachToOwnersRoot = { "bAttachToOwnersRoot", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UNavRelevantComponent), &Z_Construct_UClass_UNavRelevantComponent_Statics::NewProp_bAttachToOwnersRoot_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNavRelevantComponent_Statics::NewProp_bAttachToOwnersRoot_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNavRelevantComponent_Statics::NewProp_bAttachToOwnersRoot_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UNavRelevantComponent, 3500528314);
