...
static struct FScriptStruct_AudioMixer_StaticRegisterNativesFSubmixEffectSubmixEQSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSubmixEffectSubmixEQSettings>(FName(TEXT("SubmixEffectSubmixEQSettings")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSubmixEffectSubmixEQSettings_Statics::NewProp_EQBands = { "EQBands", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSubmixEffectSubmixEQSettings, EQBands), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubmixEffectSubmixEQSettings_Statics::NewProp_EQBands_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubmixEffectSubmixEQSettings_Statics::NewProp_EQBands_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FSubmixEffectSubmixEQSettings_Hash() { return 794518557U; }
...
static struct FScriptStruct_AudioMixer_StaticRegisterNativesFSubmixEffectEQBand
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSubmixEffectEQBand>(FName(TEXT("SubmixEffectEQBand")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSubmixEffectEQBand_Hash() { return 2723250106U; }
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USubmixEffectSubmixEQPreset_SetSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SubmixEffectSubmixEQPreset_eventSetSettings_Parms, InSettings), Z_Construct_UScriptStruct_FSubmixEffectSubmixEQSettings, METADATA_PARAMS(Z_Construct_UFunction_USubmixEffectSubmixEQPreset_SetSettings_Statics::NewProp_InSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USubmixEffectSubmixEQPreset_SetSettings_Statics::NewProp_InSettings_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USubmixEffectSubmixEQPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USubmixEffectSubmixEQPreset_SetSettings, "SetSettings" }, // 2395391134
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USubmixEffectSubmixEQPreset_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USubmixEffectSubmixEQPreset, Settings), Z_Construct_UScriptStruct_FSubmixEffectSubmixEQSettings, METADATA_PARAMS(Z_Construct_UClass_USubmixEffectSubmixEQPreset_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USubmixEffectSubmixEQPreset_Statics::NewProp_Settings_MetaData)) };
	...
	IMPLEMENT_CLASS(USubmixEffectSubmixEQPreset, 546426488);
