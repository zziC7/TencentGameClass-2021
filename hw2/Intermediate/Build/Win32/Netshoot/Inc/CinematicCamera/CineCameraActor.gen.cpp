...
static struct FScriptStruct_CinematicCamera_StaticRegisterNativesFCameraLookatTrackingSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCameraLookatTrackingSettings>(FName(TEXT("CameraLookatTrackingSettings")));
	}
...
#endif
	const UE4CodeGen_Private::FSoftObjectPropertyParams Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_ActorToTrack = { "ActorToTrack", nullptr, (EPropertyFlags)0x0014000200000005, UE4CodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCameraLookatTrackingSettings, ActorToTrack), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_ActorToTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_ActorToTrack_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bAllowRoll = { "bAllowRoll", nullptr, (EPropertyFlags)0x0010000200000005, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FCameraLookatTrackingSettings), &Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bAllowRoll_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bAllowRoll_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Statics::NewProp_bAllowRoll_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FCameraLookatTrackingSettings_Hash() { return 1078877205U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACineCameraActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACineCameraActor_GetCineCameraComponent, "GetCineCameraComponent" }, // 4017428830
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ACineCameraActor, 4068191388);
