...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneTrackImplementationPtr
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneTrackImplementationPtr>(FName(TEXT("MovieSceneTrackImplementationPtr")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTrackImplementationPtr_Hash() { return 684049733U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneTrackImplementation
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneTrackImplementation>(FName(TEXT("MovieSceneTrackImplementation")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneTrackImplementation_Hash() { return 1234568497U; }
