...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSequenceInstanceDataPtr
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneSequenceInstanceDataPtr>(FName(TEXT("MovieSceneSequenceInstanceDataPtr")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSequenceInstanceDataPtr_Hash() { return 3440456968U; }
...
static struct FScriptStruct_MovieScene_StaticRegisterNativesFMovieSceneSequenceInstanceData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMovieSceneSequenceInstanceData>(FName(TEXT("MovieSceneSequenceInstanceData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneSequenceInstanceData_Hash() { return 3484347338U; }
