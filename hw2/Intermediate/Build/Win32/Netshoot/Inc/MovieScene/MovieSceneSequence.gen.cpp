...
// End Cross Module References
	...
	struct Z_Construct_UClass_UMovieSceneSequence_Statics
	{
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CompiledData_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_CompiledData;
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_SequenceFlags_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SequenceFlags_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_SequenceFlags;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneSequence_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneSequence_FindBindingByTag, "FindBindingByTag" }, // 4053253132
		{ &Z_Construct_UFunction_UMovieSceneSequence_FindBindingsByTag, "FindBindingsByTag" }, // 2296658003
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_CompiledData_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_CompiledData = { "CompiledData", nullptr, (EPropertyFlags)0x0042000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneSequence, CompiledData), Z_Construct_UClass_UMovieSceneCompiledData_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_CompiledData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_CompiledData_MetaData)) };
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags = { "SequenceFlags", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneSequence, SequenceFlags), Z_Construct_UEnum_MovieScene_EMovieSceneSequenceFlags, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneSequence_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_CompiledData,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags,
	};
	...
	IMPLEMENT_CLASS(UMovieSceneSequence, 334561599);
