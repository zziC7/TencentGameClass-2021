...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks = { "ChildMasterTracks", nullptr, (EPropertyFlags)0x0040008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneFolder, ChildMasterTracks), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks_MetaData)) };
	...
	IMPLEMENT_CLASS(UMovieSceneFolder, 1765712835);
