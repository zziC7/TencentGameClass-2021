...
static struct FScriptStruct_GameplayDebugger_StaticRegisterNativesFGameplayDebuggerPlayerData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGameplayDebuggerPlayerData>(FName(TEXT("GameplayDebuggerPlayerData")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_Controller = { "Controller", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGameplayDebuggerPlayerData, Controller), Z_Construct_UClass_UGameplayDebuggerLocalController_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_Controller_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_Controller_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_InputComponent = { "InputComponent", nullptr, (EPropertyFlags)0x0010000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGameplayDebuggerPlayerData, InputComponent), Z_Construct_UClass_UInputComponent_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_InputComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_InputComponent_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Hash() { return 3882069797U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PlayerData = { "PlayerData", nullptr, (EPropertyFlags)0x0020088000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameplayDebuggerPlayerManager, PlayerData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PlayerData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PlayerData_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PendingRegistrations = { "PendingRegistrations", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameplayDebuggerPlayerManager, PendingRegistrations), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PendingRegistrations_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PendingRegistrations_MetaData)) };
	...
	IMPLEMENT_CLASS(AGameplayDebuggerPlayerManager, 3816804920);
