...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_GeometryCollectionDebugDrawActor_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_GeometryCollectionDebugDrawActor;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_GeometryCollectionRenderLevelSetActor_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_GeometryCollectionRenderLevelSetActor;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::Class_MetaDataParams[] = {
		...
		{ "ToolTip", "UGeometryCollectionDebugDrawComponent\n  Component adding debug drawing functionality to a GeometryCollectionActor.\n  This component is automatically added to every GeometryCollectionActor." },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionDebugDrawActor_MetaData[] = {
		{ "Category", "Debug Draw" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionDebugDrawActor = { "GeometryCollectionDebugDrawActor", nullptr, (EPropertyFlags)0x0010040000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCollectionDebugDrawComponent, GeometryCollectionDebugDrawActor), Z_Construct_UClass_AGeometryCollectionDebugDrawActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionDebugDrawActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionDebugDrawActor_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionRenderLevelSetActor_MetaData[] = {
		{ "Category", "Debug Draw" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionRenderLevelSetActor = { "GeometryCollectionRenderLevelSetActor", nullptr, (EPropertyFlags)0x0010040000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCollectionDebugDrawComponent, GeometryCollectionRenderLevelSetActor), Z_Construct_UClass_AGeometryCollectionRenderLevelSetActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionRenderLevelSetActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionRenderLevelSetActor_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionDebugDrawActor,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::NewProp_GeometryCollectionRenderLevelSetActor,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UGeometryCollectionDebugDrawComponent()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UGeometryCollectionDebugDrawComponent_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UGeometryCollectionDebugDrawComponent, 1535414206);
	template<> GEOMETRYCOLLECTIONENGINE_API UClass* StaticClass<UGeometryCollectionDebugDrawComponent>()
	{
		return UGeometryCollectionDebugDrawComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UGeometryCollectionDebugDrawComponent(Z_Construct_UClass_UGeometryCollectionDebugDrawComponent, &UGeometryCollectionDebugDrawComponent::StaticClass, TEXT("/Script/GeometryCollectionEngine"), TEXT("UGeometryCollectionDebugDrawComponent"), false, nullptr, nullptr, nullptr);
