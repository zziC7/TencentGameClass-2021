...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UGeometryCollectionCache_Statics::NewProp_SupportedCollection = { "SupportedCollection", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCollectionCache, SupportedCollection), Z_Construct_UClass_UGeometryCollection_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGeometryCollectionCache_Statics::NewProp_SupportedCollection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCollectionCache_Statics::NewProp_SupportedCollection_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UGeometryCollectionCache, 116232887);
