...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_ObjectType = { "ObjectType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSimulationComponent, ObjectType), Z_Construct_UEnum_Chaos_EObjectStateTypeEnum, METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_ObjectType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_ObjectType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_CollisionType = { "CollisionType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSimulationComponent, CollisionType), Z_Construct_UEnum_Chaos_ECollisionTypeEnum, METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_CollisionType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_CollisionType_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_ImplicitType = { "ImplicitType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSimulationComponent, ImplicitType), Z_Construct_UEnum_Chaos_EImplicitTypeEnum, METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_ImplicitType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_ImplicitType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_InitialVelocityType = { "InitialVelocityType", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSimulationComponent, InitialVelocityType), Z_Construct_UEnum_Chaos_EInitialVelocityTypeEnum, METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_InitialVelocityType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSimulationComponent_Statics::NewProp_InitialVelocityType_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UStaticMeshSimulationComponent, 349772598);
