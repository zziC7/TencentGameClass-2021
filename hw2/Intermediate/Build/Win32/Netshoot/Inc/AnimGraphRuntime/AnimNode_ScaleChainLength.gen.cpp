...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_EScaleChainInitialLength_Hash() { return 545807428U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_ScaleChainLength
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_ScaleChainLength>(FName(TEXT("AnimNode_ScaleChainLength")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_InputPose = { "InputPose", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ScaleChainLength, InputPose), Z_Construct_UScriptStruct_FPoseLink, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_InputPose_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_InputPose_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_DefaultChainLength = { "DefaultChainLength", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ScaleChainLength, DefaultChainLength), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_DefaultChainLength_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_DefaultChainLength_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_ChainEndBone = { "ChainEndBone", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ScaleChainLength, ChainEndBone), Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_ChainEndBone_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_ChainEndBone_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_TargetLocation = { "TargetLocation", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ScaleChainLength, TargetLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_TargetLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_TargetLocation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_Alpha = { "Alpha", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ScaleChainLength, Alpha), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_Alpha_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Statics::NewProp_Alpha_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ScaleChainLength_Hash() { return 624060806U; }
