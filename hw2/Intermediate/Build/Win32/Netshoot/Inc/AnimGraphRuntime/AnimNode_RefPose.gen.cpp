...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AnimGraphRuntime_ERefPoseType_Hash() { return 3082202133U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_MeshSpaceRefPose
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_MeshSpaceRefPose>(FName(TEXT("AnimNode_MeshSpaceRefPose")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_MeshSpaceRefPose_Hash() { return 2211776814U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_RefPose
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_RefPose>(FName(TEXT("AnimNode_RefPose")));
	}
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAnimNode_RefPose_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_RefPose_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_RefPose_Hash() { return 1221734861U; }
