...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAnimNode_ApplyLimits
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimNode_ApplyLimits>(FName(TEXT("AnimNode_ApplyLimits")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets = { "AngularOffsets", nullptr, (EPropertyFlags)0x0010000000000045, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ApplyLimits, AngularOffsets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Hash() { return 1717440170U; }
...
static struct FScriptStruct_AnimGraphRuntime_StaticRegisterNativesFAngularRangeLimit
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAngularRangeLimit>(FName(TEXT("AngularRangeLimit")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAngularRangeLimit_Hash() { return 3103969216U; }
