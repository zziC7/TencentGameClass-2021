...
static struct FScriptStruct_CustomMeshComponent_StaticRegisterNativesFCustomMeshTriangle
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCustomMeshTriangle>(FName(TEXT("CustomMeshTriangle")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FCustomMeshTriangle_Hash() { return 868904719U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCustomMeshComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCustomMeshComponent_AddCustomMeshTriangles, "AddCustomMeshTriangles" }, // 2316775470
		{ &Z_Construct_UFunction_UCustomMeshComponent_ClearCustomMeshTriangles, "ClearCustomMeshTriangles" }, // 1377375334
		{ &Z_Construct_UFunction_UCustomMeshComponent_SetCustomMeshTriangles, "SetCustomMeshTriangles" }, // 726461537
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCustomMeshComponent, 2223290348);
