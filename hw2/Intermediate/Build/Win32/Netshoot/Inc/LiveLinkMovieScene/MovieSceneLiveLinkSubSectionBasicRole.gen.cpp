...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneLiveLinkSubSectionBasicRole_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneLiveLinkSubSectionBasicRole_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMovieSceneLiveLinkSubSectionBasicRole()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMovieSceneLiveLinkSubSectionBasicRole_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMovieSceneLiveLinkSubSectionBasicRole, 3248508605);
	template<> LIVELINKMOVIESCENE_API UClass* StaticClass<UMovieSceneLiveLinkSubSectionBasicRole>()
	{
		return UMovieSceneLiveLinkSubSectionBasicRole::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMovieSceneLiveLinkSubSectionBasicRole(Z_Construct_UClass_UMovieSceneLiveLinkSubSectionBasicRole, &UMovieSceneLiveLinkSubSectionBasicRole::StaticClass, TEXT("/Script/LiveLinkMovieScene"), TEXT("UMovieSceneLiveLinkSubSectionBasicRole"), false, nullptr, nullptr, nullptr);
