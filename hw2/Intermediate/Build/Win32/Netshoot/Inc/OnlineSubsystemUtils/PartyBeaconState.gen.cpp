...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_OnlineSubsystemUtils_EPartyReservationResult_Hash() { return 4268441891U; }
...
class UScriptStruct* FPartyBeaconCrossplayPlatformMapping::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern ONLINESUBSYSTEMUTILS_API uint32 Get_Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("PartyBeaconCrossplayPlatformMapping"), sizeof(FPartyBeaconCrossplayPlatformMapping), Get_Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping(FPartyBeaconCrossplayPlatformMapping::StaticStruct, TEXT("/Script/OnlineSubsystemUtils"), TEXT("PartyBeaconCrossplayPlatformMapping"), false, nullptr, nullptr);
static struct FScriptStruct_OnlineSubsystemUtils_StaticRegisterNativesFPartyBeaconCrossplayPlatformMapping
{
	FScriptStruct_OnlineSubsystemUtils_StaticRegisterNativesFPartyBeaconCrossplayPlatformMapping()
	{
		UScriptStruct::DeferCppStructOps<FPartyBeaconCrossplayPlatformMapping>(FName(TEXT("PartyBeaconCrossplayPlatformMapping")));
	}
} ScriptStruct_OnlineSubsystemUtils_StaticRegisterNativesFPartyBeaconCrossplayPlatformMapping;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::Struct_MetaDataParams[] = {
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformName_MetaData[] = {
		{ "Comment", "/** Platform name (eg WIN) */" },
		{ "ModuleRelativePath", "Public/PartyBeaconState.h" },
		{ "ToolTip", "Platform name (eg WIN)" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformName = { "PlatformName", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPartyBeaconCrossplayPlatformMapping, PlatformName), METADATA_PARAMS(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformName_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformType_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformType = { "PlatformType", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPartyBeaconCrossplayPlatformMapping, PlatformType), METADATA_PARAMS(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformType_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformName,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformType,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_OnlineSubsystemUtils,
		nullptr,
		&NewStructOps,
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_OnlineSubsystemUtils();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("PartyBeaconCrossplayPlatformMapping"), sizeof(FPartyBeaconCrossplayPlatformMapping), Get_Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Hash() { return 4239301458U; }
...
static struct FScriptStruct_OnlineSubsystemUtils_StaticRegisterNativesFPartyReservation
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPartyReservation>(FName(TEXT("PartyReservation")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPartyReservation_Hash() { return 4256450657U; }
	...
	struct Z_Construct_UClass_UPartyBeaconState_Statics
	{
		...
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_PlatformCrossplayRestrictions_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PlatformCrossplayRestrictions_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_PlatformCrossplayRestrictions;
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_PlatformTypeMapping_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PlatformTypeMapping_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_PlatformTypeMapping;
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions_Inner = { "PlatformCrossplayRestrictions", nullptr, (EPropertyFlags)0x0000000000004000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions = { "PlatformCrossplayRestrictions", nullptr, (EPropertyFlags)0x0020080000004000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, PlatformCrossplayRestrictions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions_MetaData)) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping_Inner = { "PlatformTypeMapping", nullptr, (EPropertyFlags)0x0000000000004000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping_MetaData[] = {
		{ "ModuleRelativePath", "Public/PartyBeaconState.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping = { "PlatformTypeMapping", nullptr, (EPropertyFlags)0x0020080000004000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, PlatformTypeMapping), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPartyBeaconState_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping,
	...
	IMPLEMENT_CLASS(UPartyBeaconState, 3177394494);
