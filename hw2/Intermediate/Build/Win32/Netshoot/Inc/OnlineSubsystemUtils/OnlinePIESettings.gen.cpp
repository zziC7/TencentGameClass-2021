...
static struct FScriptStruct_OnlineSubsystemUtils_StaticRegisterNativesFPIELoginSettingsInternal
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPIELoginSettingsInternal>(FName(TEXT("PIELoginSettingsInternal")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPIELoginSettingsInternal_Hash() { return 2248015934U; }
	...
	IMPLEMENT_CLASS(UOnlinePIESettings, 4026042449);
