...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_OnlineSubsystemUtils_EClientRequestType_Hash() { return 550685669U; }
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_SessionId_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_SessionId = { "SessionId", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PartyBeaconClient_eventServerAddOrUpdateReservationRequest_Parms, SessionId), METADATA_PARAMS(Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_SessionId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_SessionId_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_Reservation_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_Reservation = { "Reservation", nullptr, (EPropertyFlags)0x0010000008000082, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PartyBeaconClient_eventServerAddOrUpdateReservationRequest_Parms, Reservation), Z_Construct_UScriptStruct_FPartyReservation, METADATA_PARAMS(Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_Reservation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_Reservation_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_SessionId,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_Reservation,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::Function_MetaDataParams[] = {
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APartyBeaconClient_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest, "ServerAddOrUpdateReservationRequest" }, // 3778974828
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerCancelReservationRequest, "ServerCancelReservationRequest" }, // 1844777944
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerRemoveMemberFromReservationRequest, "ServerRemoveMemberFromReservationRequest" }, // 848153452
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerReservationRequest, "ServerReservationRequest" }, // 4087196589
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerUpdateReservationRequest, "ServerUpdateReservationRequest" }, // 2283728906
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(APartyBeaconClient, 3405402538);
