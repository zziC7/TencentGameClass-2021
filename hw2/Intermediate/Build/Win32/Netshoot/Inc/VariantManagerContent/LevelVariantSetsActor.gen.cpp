...
// End Cross Module References
	...
	struct Z_Construct_UClass_ALevelVariantSetsActor_Statics
	{
		...
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_DirectorInstances_Key_KeyProp;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ALevelVariantSetsActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ALevelVariantSetsActor_GetLevelVariantSets, "GetLevelVariantSets" }, // 619615952
		{ &Z_Construct_UFunction_ALevelVariantSetsActor_SetLevelVariantSets, "SetLevelVariantSets" }, // 1621427608
		{ &Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByIndex, "SwitchOnVariantByIndex" }, // 434170724
		{ &Z_Construct_UFunction_ALevelVariantSetsActor_SwitchOnVariantByName, "SwitchOnVariantByName" }, // 1684715123
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ALevelVariantSetsActor_Statics::NewProp_DirectorInstances_ValueProp = { "DirectorInstances", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_ULevelVariantSetsFunctionDirector_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_ALevelVariantSetsActor_Statics::NewProp_DirectorInstances_Key_KeyProp = { "DirectorInstances_Key", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UBlueprintGeneratedClass_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ALevelVariantSetsActor_Statics::NewProp_DirectorInstances_MetaData[] = {
		{ "ModuleRelativePath", "Public/LevelVariantSetsActor.h" },
	};
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_ALevelVariantSetsActor_Statics::NewProp_DirectorInstances = { "DirectorInstances", nullptr, (EPropertyFlags)0x0040000000002000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALevelVariantSetsActor, DirectorInstances), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ALevelVariantSetsActor_Statics::NewProp_DirectorInstances_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALevelVariantSetsActor_Statics::NewProp_DirectorInstances_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ALevelVariantSetsActor_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALevelVariantSetsActor_Statics::NewProp_DirectorInstances_ValueProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALevelVariantSetsActor_Statics::NewProp_DirectorInstances_Key_KeyProp,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALevelVariantSetsActor_Statics::NewProp_DirectorInstances,
	};
	...
	IMPLEMENT_CLASS(ALevelVariantSetsActor, 1676497141);
