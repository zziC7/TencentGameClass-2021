...
static struct FScriptStruct_AugmentedReality_StaticRegisterNativesFARSharedWorldReplicationState
{
	...
	{
		UScriptStruct::DeferCppStructOps<FARSharedWorldReplicationState>(FName(TEXT("ARSharedWorldReplicationState")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FARSharedWorldReplicationState_Hash() { return 82263603U; }
	...
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AARSharedWorldGameMode_SetARSharedWorldData_Statics::NewProp_ARWorldData = { "ARWorldData", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARSharedWorldGameMode_eventSetARSharedWorldData_Parms, ARWorldData), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AARSharedWorldGameMode_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AARSharedWorldGameMode_GetARSharedWorldGameState, "GetARSharedWorldGameState" }, // 1479666673
		{ &Z_Construct_UFunction_AARSharedWorldGameMode_SetARSharedWorldData, "SetARSharedWorldData" }, // 1654888146
		{ &Z_Construct_UFunction_AARSharedWorldGameMode_SetARWorldSharingIsReady, "SetARWorldSharingIsReady" }, // 3768277565
		{ &Z_Construct_UFunction_AARSharedWorldGameMode_SetPreviewImageData, "SetPreviewImageData" }, // 3323239629
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AARSharedWorldGameMode, 60990735);
