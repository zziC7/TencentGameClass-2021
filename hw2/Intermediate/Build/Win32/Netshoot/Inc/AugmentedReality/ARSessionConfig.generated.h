...
#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_SPARSE_DATA
#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_RPC_WRAPPERS \
 \
...
#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_RPC_WRAPPERS_NO_PURE_DECLS \
 \
	DECLARE_FUNCTION(execSetSceneReconstructionMethod); \
	DECLARE_FUNCTION(execSetSessionTrackingFeatureToEnable); \
	DECLARE_FUNCTION(execGetSceneReconstructionMethod); \
...
#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_ARCHIVESERIALIZER \
	DECLARE_FSTRUCTUREDARCHIVE_SERIALIZER(UARSessionConfig, NO_API)


#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_INCLASS_NO_PURE_DECLS \
private: \
...
public: \
	...
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_ARCHIVESERIALIZER


#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_INCLASS \
private: \
	static void StaticRegisterNativesUARSessionConfig(); \
	friend struct Z_Construct_UClass_UARSessionConfig_Statics; \
public: \
...
#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_STANDARD_CONSTRUCTORS \
...
#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_ENHANCED_CONSTRUCTORS \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UARSessionConfig(UARSessionConfig&&); \
	NO_API UARSessionConfig(const UARSessionConfig&); \
...
#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_PRIVATE_PROPERTY_OFFSET \
	...
	FORCEINLINE static uint32 __PPO__bUseOptimalVideoFormat() { return STRUCT_OFFSET(UARSessionConfig, bUseOptimalVideoFormat); } \
	...
	FORCEINLINE static uint32 __PPO__MaxNumberOfTrackedFaces() { return STRUCT_OFFSET(UARSessionConfig, MaxNumberOfTrackedFaces); } \
	...
	FORCEINLINE static uint32 __PPO__SceneReconstructionMethod() { return STRUCT_OFFSET(UARSessionConfig, SceneReconstructionMethod); } \
	FORCEINLINE static uint32 __PPO__PlaneComponentClass() { return STRUCT_OFFSET(UARSessionConfig, PlaneComponentClass); } \
	FORCEINLINE static uint32 __PPO__PointComponentClass() { return STRUCT_OFFSET(UARSessionConfig, PointComponentClass); } \
	FORCEINLINE static uint32 __PPO__FaceComponentClass() { return STRUCT_OFFSET(UARSessionConfig, FaceComponentClass); } \
	FORCEINLINE static uint32 __PPO__ImageComponentClass() { return STRUCT_OFFSET(UARSessionConfig, ImageComponentClass); } \
	FORCEINLINE static uint32 __PPO__QRCodeComponentClass() { return STRUCT_OFFSET(UARSessionConfig, QRCodeComponentClass); } \
	FORCEINLINE static uint32 __PPO__PoseComponentClass() { return STRUCT_OFFSET(UARSessionConfig, PoseComponentClass); } \
	FORCEINLINE static uint32 __PPO__EnvironmentProbeComponentClass() { return STRUCT_OFFSET(UARSessionConfig, EnvironmentProbeComponentClass); } \
	FORCEINLINE static uint32 __PPO__ObjectComponentClass() { return STRUCT_OFFSET(UARSessionConfig, ObjectComponentClass); } \
	FORCEINLINE static uint32 __PPO__MeshComponentClass() { return STRUCT_OFFSET(UARSessionConfig, MeshComponentClass); } \
	FORCEINLINE static uint32 __PPO__GeoAnchorComponentClass() { return STRUCT_OFFSET(UARSessionConfig, GeoAnchorComponentClass); } \
	FORCEINLINE static uint32 __PPO__DefaultMeshMaterial() { return STRUCT_OFFSET(UARSessionConfig, DefaultMeshMaterial); } \
	FORCEINLINE static uint32 __PPO__DefaultWireframeMeshMaterial() { return STRUCT_OFFSET(UARSessionConfig, DefaultWireframeMeshMaterial); }


#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_179_PROLOG
#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_GENERATED_BODY_LEGACY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_PRIVATE_PROPERTY_OFFSET \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_SPARSE_DATA \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_RPC_WRAPPERS \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_INCLASS \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_STANDARD_CONSTRUCTORS \
public: \
PRAGMA_ENABLE_DEPRECATION_WARNINGS


#define Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_GENERATED_BODY \
PRAGMA_DISABLE_DEPRECATION_WARNINGS \
public: \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_PRIVATE_PROPERTY_OFFSET \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_SPARSE_DATA \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_RPC_WRAPPERS_NO_PURE_DECLS \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_INCLASS_NO_PURE_DECLS \
	Engine_Source_Runtime_AugmentedReality_Public_ARSessionConfig_h_182_ENHANCED_CONSTRUCTORS \
private: \
PRAGMA_ENABLE_DEPRECATION_WARNINGS
