...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULocalizationSettings_Statics::NewProp_EngineTargetSet = { "EngineTargetSet", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULocalizationSettings, EngineTargetSet), Z_Construct_UClass_ULocalizationTargetSet_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULocalizationSettings_Statics::NewProp_EngineTargetSet_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULocalizationSettings_Statics::NewProp_EngineTargetSet_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULocalizationSettings_Statics::NewProp_GameTargetsSettings = { "GameTargetsSettings", nullptr, (EPropertyFlags)0x0040000000004000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULocalizationSettings, GameTargetsSettings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULocalizationSettings_Statics::NewProp_GameTargetsSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULocalizationSettings_Statics::NewProp_GameTargetsSettings_MetaData)) };
	...
	IMPLEMENT_CLASS(ULocalizationSettings, 514888305);
