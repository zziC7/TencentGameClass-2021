...
static struct FScriptStruct_Renderer_StaticRegisterNativesFLightPropagationVolumeSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLightPropagationVolumeSettings>(FName(TEXT("LightPropagationVolumeSettings")));
	}
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FLightPropagationVolumeSettings_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLightPropagationVolumeSettings_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FLightPropagationVolumeSettings_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLightPropagationVolumeSettings_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FLightPropagationVolumeSettings_Hash() { return 393423886U; }
