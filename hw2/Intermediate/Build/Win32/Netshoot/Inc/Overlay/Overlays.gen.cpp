...
static struct FScriptStruct_Overlay_StaticRegisterNativesFOverlayItem
{
	...
	{
		UScriptStruct::DeferCppStructOps<FOverlayItem>(FName(TEXT("OverlayItem")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_EndTime = { "EndTime", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FOverlayItem, EndTime), Z_Construct_UScriptStruct_FTimespan, METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_EndTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_EndTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Text = { "Text", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FOverlayItem, Text), METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Text_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Text_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FOverlayItem_Hash() { return 3159868172U; }
	...
	IMPLEMENT_CLASS(UOverlays, 4067101885);
