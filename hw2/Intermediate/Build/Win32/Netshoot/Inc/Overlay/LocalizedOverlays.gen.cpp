...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_LocaleToOverlaysMap = { "LocaleToOverlaysMap", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULocalizedOverlays, LocaleToOverlaysMap), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_LocaleToOverlaysMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_LocaleToOverlaysMap_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ULocalizedOverlays, 2255541258);
