...
static struct FScriptStruct_Engine_StaticRegisterNativesFLayerActorStats
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLayerActorStats>(FName(TEXT("LayerActorStats")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FLayerActorStats_Hash() { return 3604402566U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULayer_Statics::NewProp_ActorStats = { "ActorStats", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULayer, ActorStats), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULayer_Statics::NewProp_ActorStats_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULayer_Statics::NewProp_ActorStats_MetaData)) };
	...
	IMPLEMENT_CLASS(ULayer, 3974649726);
