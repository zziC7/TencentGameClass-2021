...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_MaxCurveError = { "MaxCurveError", nullptr, (EPropertyFlags)0x0010000800000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimCurveCompressionCodec_CompressedRichCurve, MaxCurveError), METADATA_PARAMS(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_MaxCurveError_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_MaxCurveError_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_ErrorSampleRate = { "ErrorSampleRate", nullptr, (EPropertyFlags)0x0010000800000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimCurveCompressionCodec_CompressedRichCurve, ErrorSampleRate), METADATA_PARAMS(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_ErrorSampleRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_ErrorSampleRate_MetaData)) };
	...
	IMPLEMENT_CLASS(UAnimCurveCompressionCodec_CompressedRichCurve, 2381389751);
