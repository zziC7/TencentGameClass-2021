...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionLightmassReplace_Statics::NewProp_Lightmass = { "Lightmass", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionLightmassReplace, Lightmass), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionLightmassReplace_Statics::NewProp_Lightmass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionLightmassReplace_Statics::NewProp_Lightmass_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialExpressionLightmassReplace, 1589731228);
