...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UObjectLibrary_Statics::NewProp_Objects = { "Objects", nullptr, (EPropertyFlags)0x0020080000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UObjectLibrary, Objects), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UObjectLibrary_Statics::NewProp_Objects_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UObjectLibrary_Statics::NewProp_Objects_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UObjectLibrary_Statics::NewProp_WeakObjects = { "WeakObjects", nullptr, (EPropertyFlags)0x0024080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UObjectLibrary, WeakObjects), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UObjectLibrary_Statics::NewProp_WeakObjects_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UObjectLibrary_Statics::NewProp_WeakObjects_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UObjectLibrary, 2315580526);
