...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ECloudStorageDelegate_Hash() { return 2923231159U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCloudStorageBase_Statics::NewProp_LocalCloudFiles = { "LocalCloudFiles", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCloudStorageBase, LocalCloudFiles), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCloudStorageBase_Statics::NewProp_LocalCloudFiles_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCloudStorageBase_Statics::NewProp_LocalCloudFiles_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCloudStorageBase, 1881034155);
