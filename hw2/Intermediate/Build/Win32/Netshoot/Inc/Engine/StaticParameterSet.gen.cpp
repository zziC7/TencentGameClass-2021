...
static struct FScriptStruct_Engine_StaticRegisterNativesFStaticParameterSet
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStaticParameterSet>(FName(TEXT("StaticParameterSet")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FStaticParameterSet_Hash() { return 485577882U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStaticMaterialLayersParameter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStaticMaterialLayersParameter>(FName(TEXT("StaticMaterialLayersParameter")));
	}
...
static_assert(std::is_polymorphic<FStaticTerrainLayerWeightParameter>() == std::is_polymorphic<FStaticParameterBase>(), "USTRUCT FStaticTerrainLayerWeightParameter cannot be polymorphic unless super FStaticParameterBase is polymorphic");
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStaticTerrainLayerWeightParameter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStaticTerrainLayerWeightParameter>(FName(TEXT("StaticTerrainLayerWeightParameter")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FStaticTerrainLayerWeightParameter_Hash() { return 3362740341U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStaticComponentMaskParameter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStaticComponentMaskParameter>(FName(TEXT("StaticComponentMaskParameter")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FStaticComponentMaskParameter_Hash() { return 57059963U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStaticSwitchParameter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStaticSwitchParameter>(FName(TEXT("StaticSwitchParameter")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStaticParameterBase
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStaticParameterBase>(FName(TEXT("StaticParameterBase")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FStaticParameterBase_Hash() { return 2325249692U; }
