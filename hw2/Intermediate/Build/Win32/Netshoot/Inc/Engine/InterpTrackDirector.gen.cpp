...
static struct FScriptStruct_Engine_StaticRegisterNativesFDirectorTrackCut
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDirectorTrackCut>(FName(TEXT("DirectorTrackCut")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDirectorTrackCut_Hash() { return 396906574U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInterpTrackDirector_Statics::NewProp_CutTrack = { "CutTrack", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackDirector, CutTrack), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackDirector_Statics::NewProp_CutTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackDirector_Statics::NewProp_CutTrack_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UInterpTrackDirector_Statics::NewProp_PreviewCamera = { "PreviewCamera", nullptr, (EPropertyFlags)0x0040000800002000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackDirector, PreviewCamera), Z_Construct_UClass_ACameraActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackDirector_Statics::NewProp_PreviewCamera_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackDirector_Statics::NewProp_PreviewCamera_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(UInterpTrackDirector, 976811903);
