...
static struct FScriptStruct_Engine_StaticRegisterNativesFBookmark2DJumpToSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBookmark2DJumpToSettings>(FName(TEXT("Bookmark2DJumpToSettings")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBookmark2DJumpToSettings_Hash() { return 77733549U; }
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBookMark2D_Statics::NewProp_Zoom2D = { "Zoom2D", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBookMark2D, Zoom2D), METADATA_PARAMS(Z_Construct_UClass_UBookMark2D_Statics::NewProp_Zoom2D_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBookMark2D_Statics::NewProp_Zoom2D_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UBookMark2D, 386176587);
