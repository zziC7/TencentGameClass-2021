...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionRerouteBase_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionRerouteBase_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMaterialExpressionRerouteBase()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMaterialExpressionRerouteBase_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMaterialExpressionRerouteBase, 2585729561);
	template<> ENGINE_API UClass* StaticClass<UMaterialExpressionRerouteBase>()
	{
		return UMaterialExpressionRerouteBase::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMaterialExpressionRerouteBase(Z_Construct_UClass_UMaterialExpressionRerouteBase, &UMaterialExpressionRerouteBase::StaticClass, TEXT("/Script/Engine"), TEXT("UMaterialExpressionRerouteBase"), false, nullptr, nullptr, nullptr);
