...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TransmittanceColor_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_TransmittanceColor;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput_Statics::NewProp_TransmittanceColor_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput_Statics::NewProp_TransmittanceColor = { "TransmittanceColor", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionThinTranslucentMaterialOutput, TransmittanceColor), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput_Statics::NewProp_TransmittanceColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput_Statics::NewProp_TransmittanceColor_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput_Statics::NewProp_TransmittanceColor,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMaterialExpressionThinTranslucentMaterialOutput, 949644563);
	template<> ENGINE_API UClass* StaticClass<UMaterialExpressionThinTranslucentMaterialOutput>()
	{
		return UMaterialExpressionThinTranslucentMaterialOutput::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMaterialExpressionThinTranslucentMaterialOutput(Z_Construct_UClass_UMaterialExpressionThinTranslucentMaterialOutput, &UMaterialExpressionThinTranslucentMaterialOutput::StaticClass, TEXT("/Script/Engine"), TEXT("UMaterialExpressionThinTranslucentMaterialOutput"), false, nullptr, nullptr, nullptr);
