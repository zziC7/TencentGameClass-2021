...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundClassAdjuster
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSoundClassAdjuster>(FName(TEXT("SoundClassAdjuster")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAudioEQEffect
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAudioEQEffect>(FName(TEXT("AudioEQEffect")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAudioEffectParameters
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAudioEffectParameters>(FName(TEXT("AudioEffectParameters")));
	}
