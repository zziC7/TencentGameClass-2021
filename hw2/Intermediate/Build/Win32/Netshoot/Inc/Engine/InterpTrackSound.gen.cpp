...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundTrackKey
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSoundTrackKey>(FName(TEXT("SoundTrackKey")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSoundTrackKey, Time), METADATA_PARAMS(Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Time_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Time_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Volume_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Matinee/InterpTrackSound.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Volume = { "Volume", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSoundTrackKey, Volume), METADATA_PARAMS(Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Volume_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Volume_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Pitch_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Matinee/InterpTrackSound.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Pitch = { "Pitch", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSoundTrackKey, Pitch), METADATA_PARAMS(Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Pitch_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundTrackKey_Statics::NewProp_Pitch_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FSoundTrackKey_Hash() { return 3600527321U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInterpTrackSound_Statics::NewProp_Sounds = { "Sounds", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackSound, Sounds), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackSound_Statics::NewProp_Sounds_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackSound_Statics::NewProp_Sounds_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInterpTrackSound, 2441503214);
