...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars = { "CVars", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDeviceProfile, CVars), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars_MetaData)) };
	...
	IMPLEMENT_CLASS(UDeviceProfile, 2838283671);
