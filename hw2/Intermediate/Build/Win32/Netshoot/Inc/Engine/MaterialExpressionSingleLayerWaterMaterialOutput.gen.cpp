...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ColorScaleBehindWater_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_ColorScaleBehindWater;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionSingleLayerWaterMaterialOutput_Statics::NewProp_ColorScaleBehindWater_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionSingleLayerWaterMaterialOutput_Statics::NewProp_ColorScaleBehindWater = { "ColorScaleBehindWater", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionSingleLayerWaterMaterialOutput, ColorScaleBehindWater), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionSingleLayerWaterMaterialOutput_Statics::NewProp_ColorScaleBehindWater_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSingleLayerWaterMaterialOutput_Statics::NewProp_ColorScaleBehindWater_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMaterialExpressionSingleLayerWaterMaterialOutput_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMaterialExpressionSingleLayerWaterMaterialOutput_Statics::NewProp_ColorScaleBehindWater,
	};
	...
	IMPLEMENT_CLASS(UMaterialExpressionSingleLayerWaterMaterialOutput, 1994738137);
