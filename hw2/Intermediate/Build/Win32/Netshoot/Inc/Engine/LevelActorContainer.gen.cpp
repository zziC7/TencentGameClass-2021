...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors = { "Actors", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelActorContainer, Actors), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors_MetaData)) };
	...
	IMPLEMENT_CLASS(ULevelActorContainer, 990387409);
