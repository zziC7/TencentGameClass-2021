...
static struct FScriptStruct_Engine_StaticRegisterNativesFMulticastRecordOptions
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMulticastRecordOptions>(FName(TEXT("MulticastRecordOptions")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FMulticastRecordOptions_Hash() { return 2239108397U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFRollbackNetStartupActorInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRollbackNetStartupActorInfo>(FName(TEXT("RollbackNetStartupActorInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FRollbackNetStartupActorInfo_Hash() { return 3820948551U; }
	...
	IMPLEMENT_CLASS(UDemoNetDriver, 3201304950);
