...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_TerminalVelocity = { "TerminalVelocity", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APhysicsVolume, TerminalVelocity), METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_TerminalVelocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_TerminalVelocity_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact = { "bPhysicsOnContact", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(APhysicsVolume), &Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact_SetBit, METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact_MetaData)) };
	...
	IMPLEMENT_CLASS(APhysicsVolume, 1161353338);
