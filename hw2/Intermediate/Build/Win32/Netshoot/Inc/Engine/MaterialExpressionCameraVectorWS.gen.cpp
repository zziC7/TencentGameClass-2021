...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionCameraVectorWS_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionCameraVectorWS_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UMaterialExpressionCameraVectorWS()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UMaterialExpressionCameraVectorWS_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UMaterialExpressionCameraVectorWS, 237899312);
	template<> ENGINE_API UClass* StaticClass<UMaterialExpressionCameraVectorWS>()
	{
		return UMaterialExpressionCameraVectorWS::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UMaterialExpressionCameraVectorWS(Z_Construct_UClass_UMaterialExpressionCameraVectorWS, &UMaterialExpressionCameraVectorWS::StaticClass, TEXT("/Script/Engine"), TEXT("UMaterialExpressionCameraVectorWS"), false, nullptr, nullptr, nullptr);
