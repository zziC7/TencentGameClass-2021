...
static struct FScriptStruct_Engine_StaticRegisterNativesFVoiceSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps<FVoiceSettings>(FName(TEXT("VoiceSettings")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FVoiceSettings_Hash() { return 2206052263U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVOIPTalker_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UVOIPTalker_CreateTalkerForPlayer, "CreateTalkerForPlayer" }, // 4085375468
	...
	IMPLEMENT_CLASS(UVOIPTalker, 878902850);
