...
static struct FScriptStruct_Engine_StaticRegisterNativesFActiveForceFeedbackEffect
{
	...
	{
		UScriptStruct::DeferCppStructOps<FActiveForceFeedbackEffect>(FName(TEXT("ActiveForceFeedbackEffect")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FActiveForceFeedbackEffect_Statics::NewProp_ForceFeedbackEffect = { "ForceFeedbackEffect", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActiveForceFeedbackEffect, ForceFeedbackEffect), Z_Construct_UClass_UForceFeedbackEffect_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FActiveForceFeedbackEffect_Statics::NewProp_ForceFeedbackEffect_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActiveForceFeedbackEffect_Statics::NewProp_ForceFeedbackEffect_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FActiveForceFeedbackEffect_Hash() { return 3319064976U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFForceFeedbackParameters
{
	...
	{
		UScriptStruct::DeferCppStructOps<FForceFeedbackParameters>(FName(TEXT("ForceFeedbackParameters")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FForceFeedbackParameters, Tag), METADATA_PARAMS(Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_Tag_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_Tag_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_bLooping = { "bLooping", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FForceFeedbackParameters), &Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_bLooping_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_bLooping_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_bLooping_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_bPlayWhilePaused = { "bPlayWhilePaused", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FForceFeedbackParameters), &Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_bPlayWhilePaused_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_bPlayWhilePaused_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FForceFeedbackParameters_Statics::NewProp_bPlayWhilePaused_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FForceFeedbackParameters_Hash() { return 2497814013U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFForceFeedbackChannelDetails
{
	...
	{
		UScriptStruct::DeferCppStructOps<FForceFeedbackChannelDetails>(FName(TEXT("ForceFeedbackChannelDetails")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FForceFeedbackChannelDetails_Hash() { return 2909430531U; }
	...
	IMPLEMENT_CLASS(UForceFeedbackEffect, 580186798);
