...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_ADocumentationActor_Statics::NewProp_DocumentLink = { "DocumentLink", nullptr, (EPropertyFlags)0x0010040800000005, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADocumentationActor, DocumentLink), METADATA_PARAMS(Z_Construct_UClass_ADocumentationActor_Statics::NewProp_DocumentLink_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADocumentationActor_Statics::NewProp_DocumentLink_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ADocumentationActor, 471314085);
