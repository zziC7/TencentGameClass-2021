...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimBlueprintDebugData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimBlueprintDebugData>(FName(TEXT("AnimBlueprintDebugData")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimationFrameSnapshot
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimationFrameSnapshot>(FName(TEXT("AnimationFrameSnapshot")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStateMachineDebugData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStateMachineDebugData>(FName(TEXT("StateMachineDebugData")));
	}
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStateMachineStateDebugData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStateMachineStateDebugData>(FName(TEXT("StateMachineStateDebugData")));
	}
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PropertyAccessLibrary_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_PropertyAccessLibrary;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimBlueprintGeneratedClass_Statics::NewProp_PropertyAccessLibrary_MetaData[] = {
		{ "Comment", "// The library holding the property access data\n" },
		{ "ModuleRelativePath", "Classes/Animation/AnimBlueprintGeneratedClass.h" },
		{ "ToolTip", "The library holding the property access data" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimBlueprintGeneratedClass_Statics::NewProp_PropertyAccessLibrary = { "PropertyAccessLibrary", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimBlueprintGeneratedClass, PropertyAccessLibrary), Z_Construct_UScriptStruct_FPropertyAccessLibrary, METADATA_PARAMS(Z_Construct_UClass_UAnimBlueprintGeneratedClass_Statics::NewProp_PropertyAccessLibrary_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimBlueprintGeneratedClass_Statics::NewProp_PropertyAccessLibrary_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAnimBlueprintGeneratedClass_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimBlueprintGeneratedClass_Statics::NewProp_PropertyAccessLibrary,
	};
	...
	IMPLEMENT_CLASS(UAnimBlueprintGeneratedClass, 2615557300);
