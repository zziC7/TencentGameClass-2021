...
static struct FScriptStruct_Engine_StaticRegisterNativesFConstraintInstance
{
	...
	{
		UScriptStruct::DeferCppStructOps<FConstraintInstance>(FName(TEXT("ConstraintInstance")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FConstraintInstance_Hash() { return 3652749782U; }
class UScriptStruct* FConstraintInstanceBase::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern ENGINE_API uint32 Get_Z_Construct_UScriptStruct_FConstraintInstanceBase_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FConstraintInstanceBase, Z_Construct_UPackage__Script_Engine(), TEXT("ConstraintInstanceBase"), sizeof(FConstraintInstanceBase), Get_Z_Construct_UScriptStruct_FConstraintInstanceBase_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FConstraintInstanceBase(FConstraintInstanceBase::StaticStruct, TEXT("/Script/Engine"), TEXT("ConstraintInstanceBase"), false, nullptr, nullptr);
static struct FScriptStruct_Engine_StaticRegisterNativesFConstraintInstanceBase
{
	FScriptStruct_Engine_StaticRegisterNativesFConstraintInstanceBase()
	{
		UScriptStruct::DeferCppStructOps<FConstraintInstanceBase>(FName(TEXT("ConstraintInstanceBase")));
	}
} ScriptStruct_Engine_StaticRegisterNativesFConstraintInstanceBase;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FConstraintInstanceBase_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/PhysicsEngine/ConstraintInstance.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FConstraintInstanceBase_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_Engine,
		nullptr,
		&NewStructOps,
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FConstraintInstanceBase_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_Engine();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("ConstraintInstanceBase"), sizeof(FConstraintInstanceBase), Get_Z_Construct_UScriptStruct_FConstraintInstanceBase_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FConstraintInstanceBase_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FConstraintInstanceBase_Hash() { return 4225351196U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFConstraintProfileProperties
{
	...
	{
		UScriptStruct::DeferCppStructOps<FConstraintProfileProperties>(FName(TEXT("ConstraintProfileProperties")));
	}
	...
	struct Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics
	{
		...
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_ProjectionAngularTolerance;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ProjectionLinearAlpha_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_ProjectionLinearAlpha;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ProjectionAngularAlpha_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_ProjectionAngularAlpha;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LinearBreakThreshold_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_LinearBreakThreshold;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_LinearPlasticityThreshold_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_LinearPlasticityThreshold;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AngularBreakThreshold_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_AngularBreakThreshold;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_AngularPlasticityThreshold_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_AngularPlasticityThreshold;
#if WITH_METADATA
		...
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableProjection;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableSoftProjection_MetaData[];
#endif
		static void NewProp_bEnableSoftProjection_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableSoftProjection;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAngularBreakable_MetaData[];
#endif
		static void NewProp_bAngularBreakable_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAngularBreakable;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAngularPlasticity_MetaData[];
#endif
		static void NewProp_bAngularPlasticity_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAngularPlasticity;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bLinearBreakable_MetaData[];
#endif
		static void NewProp_bLinearBreakable_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bLinearBreakable;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bLinearPlasticity_MetaData[];
#endif
		static void NewProp_bLinearPlasticity_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bLinearPlasticity;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const UE4CodeGen_Private::FStructParams ReturnStructParams;
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionLinearAlpha_MetaData[] = {
		{ "Category", "Projection" },
		{ "ClampMax", "1.0" },
		{ "ClampMin", "0.0" },
		{ "Comment", "/** [Chaos Only] How much linear projection to apply [0-1]. Projection fixes any post-solve position error in the constraint. */" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/ConstraintInstance.h" },
		{ "ToolTip", "[Chaos Only] How much linear projection to apply [0-1]. Projection fixes any post-solve position error in the constraint." },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionLinearAlpha = { "ProjectionLinearAlpha", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintProfileProperties, ProjectionLinearAlpha), METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionLinearAlpha_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionLinearAlpha_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionAngularAlpha_MetaData[] = {
		{ "Category", "Projection" },
		{ "ClampMax", "1.0" },
		{ "ClampMin", "0.0" },
		{ "Comment", "/** [Chaos Only] How much angular projection to apply [0-1]. Projection fixes any post-solve angle error in the constraint. */" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/ConstraintInstance.h" },
		{ "ToolTip", "[Chaos Only] How much angular projection to apply [0-1]. Projection fixes any post-solve angle error in the constraint." },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionAngularAlpha = { "ProjectionAngularAlpha", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintProfileProperties, ProjectionAngularAlpha), METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionAngularAlpha_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionAngularAlpha_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_LinearPlasticityThreshold_MetaData[] = {
		{ "Category", "Linear" },
		{ "ClampMin", "0.0" },
		{ "Comment", "/** Percent threshold from target position needed to reset the spring rest length.*/" },
		{ "editcondition", "bLinearPlasticity" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/ConstraintInstance.h" },
		{ "ToolTip", "Percent threshold from target position needed to reset the spring rest length." },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_LinearPlasticityThreshold = { "LinearPlasticityThreshold", nullptr, (EPropertyFlags)0x0010040000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintProfileProperties, LinearPlasticityThreshold), METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_LinearPlasticityThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_LinearPlasticityThreshold_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_AngularPlasticityThreshold_MetaData[] = {
		{ "Category", "Angular" },
		{ "ClampMin", "0.0" },
		{ "Comment", "/** Degree threshold from target angle needed to reset the target angle.*/" },
		{ "editcondition", "bAngularPlasticity" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/ConstraintInstance.h" },
		{ "ToolTip", "Degree threshold from target angle needed to reset the target angle." },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_AngularPlasticityThreshold = { "AngularPlasticityThreshold", nullptr, (EPropertyFlags)0x0010040000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintProfileProperties, AngularPlasticityThreshold), METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_AngularPlasticityThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_AngularPlasticityThreshold_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bEnableProjection_MetaData[] = {
		{ "Category", "Projection" },
		{ "Comment", "/**\n\x09* [PhysX] If distance error between bodies exceeds 0.1 units, or rotation error exceeds 10 degrees, body will be projected to fix this.\n\x09* For example a chain spinning too fast will have its elements appear detached due to velocity, this will project all bodies so they still appear attached to each other.\n\x09*\n\x09* [Chaos] Chaos applies a post-solve position and angular fixup where the parent body in the constraint is treated as having infinite mass and the child body is \n\x09* translated and rotated to resolve any remaining errors. This can be used to make constraint chains significantly stiffer at lower iteration counts. Increasing\n\x09* iterations would have the same effect, but be much more expensive. Projection only works well if the chain is not interacting with other objects (e.g.,\n\x09* through collisions) because the projection of the bodies in the chain will cause other constraints to be violated. Likewise, if a body is influenced by multiple\n\x09* constraints, then enabling projection on more than one constraint may lead to unexpected results - the \"last\" constraint would win but the order in which constraints\n\x09* are solved cannot be directly controlled.\n\x09*\n\x09* Note: projection will not be applied to constraints with soft limits.\n\x09*/" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/ConstraintInstance.h" },
		{ "ToolTip", "[PhysX] If distance error between bodies exceeds 0.1 units, or rotation error exceeds 10 degrees, body will be projected to fix this.\nFor example a chain spinning too fast will have its elements appear detached due to velocity, this will project all bodies so they still appear attached to each other.\n\n[Chaos] Chaos applies a post-solve position and angular fixup where the parent body in the constraint is treated as having infinite mass and the child body is\ntranslated and rotated to resolve any remaining errors. This can be used to make constraint chains significantly stiffer at lower iteration counts. Increasing\niterations would have the same effect, but be much more expensive. Projection only works well if the chain is not interacting with other objects (e.g.,\nthrough collisions) because the projection of the bodies in the chain will cause other constraints to be violated. Likewise, if a body is influenced by multiple\nconstraints, then enabling projection on more than one constraint may lead to unexpected results - the \"last\" constraint would win but the order in which constraints\nare solved cannot be directly controlled.\n\nNote: projection will not be applied to constraints with soft limits." },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bEnableSoftProjection_MetaData[] = {
		{ "Category", "Projection" },
		{ "Comment", "/**\n\x09 * [Chaos Only] Apply projection to constraints with soft limits. This can be used to stiffen up soft joints at low iteration counts, but the projection will\n\x09 * override a lot of the spring-damper behaviour of the soft limits. E.g., if you have soft projection enabled and ProjectionAngularAlpha = 1.0,\n\x09 * the joint will act as if it is a hard limit.\n\x09 */" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/ConstraintInstance.h" },
		{ "ToolTip", "[Chaos Only] Apply projection to constraints with soft limits. This can be used to stiffen up soft joints at low iteration counts, but the projection will\noverride a lot of the spring-damper behaviour of the soft limits. E.g., if you have soft projection enabled and ProjectionAngularAlpha = 1.0,\nthe joint will act as if it is a hard limit." },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bEnableSoftProjection = { "bEnableSoftProjection", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FConstraintProfileProperties), &Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bEnableSoftProjection_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bEnableSoftProjection_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bEnableSoftProjection_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bAngularPlasticity_MetaData[] = {
		{ "Category", "Angular" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bAngularPlasticity = { "bAngularPlasticity", nullptr, (EPropertyFlags)0x0010040000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FConstraintProfileProperties), &Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bAngularPlasticity_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bAngularPlasticity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bAngularPlasticity_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bLinearPlasticity_MetaData[] = {
		{ "Category", "Linear" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bLinearPlasticity = { "bLinearPlasticity", nullptr, (EPropertyFlags)0x0010040000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FConstraintProfileProperties), &Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bLinearPlasticity_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bLinearPlasticity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bLinearPlasticity_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionLinearAlpha,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_ProjectionAngularAlpha,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_LinearPlasticityThreshold,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_AngularPlasticityThreshold,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bEnableSoftProjection,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bAngularPlasticity,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FConstraintProfileProperties_Statics::NewProp_bLinearPlasticity,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FConstraintProfileProperties_Hash() { return 1680021741U; }
