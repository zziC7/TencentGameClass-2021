...
static struct FScriptStruct_Engine_StaticRegisterNativesFInterpGroupActorInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FInterpGroupActorInfo>(FName(TEXT("InterpGroupActorInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FInterpGroupActorInfo_Hash() { return 3231793316U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFCameraCutInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCameraCutInfo>(FName(TEXT("CameraCutInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FCameraCutInfo_Hash() { return 1728791442U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AMatineeActor_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AMatineeActor_EnableGroupByName, "EnableGroupByName" }, // 1291139856
		...
		{ &Z_Construct_UFunction_AMatineeActor_SetPosition, "SetPosition" }, // 2976373719
	...
	IMPLEMENT_CLASS(AMatineeActor, 2640672400);
