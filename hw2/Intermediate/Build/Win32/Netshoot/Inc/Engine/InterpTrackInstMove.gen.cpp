...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInterpTrackInstMove_Statics::NewProp_ResetLocation = { "ResetLocation", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackInstMove, ResetLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackInstMove_Statics::NewProp_ResetLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackInstMove_Statics::NewProp_ResetLocation_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInterpTrackInstMove, 530506799);
