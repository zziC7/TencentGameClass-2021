...
static struct FScriptStruct_Engine_StaticRegisterNativesFStreamingTextureBuildInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStreamingTextureBuildInfo>(FName(TEXT("StreamingTextureBuildInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FStreamingTextureBuildInfo_Hash() { return 520395123U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStreamingRenderAssetPrimitiveInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStreamingRenderAssetPrimitiveInfo>(FName(TEXT("StreamingRenderAssetPrimitiveInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Hash() { return 2114491423U; }
