...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleAccelerationOverLifetime_Statics::NewProp_AccelOverLife = { "AccelOverLife", nullptr, (EPropertyFlags)0x0010008000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleAccelerationOverLifetime, AccelOverLife), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleAccelerationOverLifetime_Statics::NewProp_AccelOverLife_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleAccelerationOverLifetime_Statics::NewProp_AccelOverLife_MetaData)) };
	...
	IMPLEMENT_CLASS(UParticleModuleAccelerationOverLifetime, 3539412762);
