...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale = { "FrictionScale", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTireType, FrictionScale), METADATA_PARAMS(Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale_MetaData)) };
	...
	IMPLEMENT_CLASS(UTireType, 1770728708);
