...
static struct FScriptStruct_Engine_StaticRegisterNativesFBandwidthTestGenerator
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBandwidthTestGenerator>(FName(TEXT("BandwidthTestGenerator")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBandwidthTestGenerator_Hash() { return 1221241237U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFBandwidthTestItem
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBandwidthTestItem>(FName(TEXT("BandwidthTestItem")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBandwidthTestItem_Hash() { return 2267524027U; }
	...
	IMPLEMENT_CLASS(ABandwidthTestActor, 1231024332);
