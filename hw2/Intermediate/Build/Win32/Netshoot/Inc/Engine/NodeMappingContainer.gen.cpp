...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UNodeMappingContainer_Statics::NewProp_TargetItems = { "TargetItems", nullptr, (EPropertyFlags)0x0040000000020001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNodeMappingContainer, TargetItems), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNodeMappingContainer_Statics::NewProp_TargetItems_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNodeMappingContainer_Statics::NewProp_TargetItems_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UClass_UNodeMappingContainer_Statics::NewProp_SourceToTarget = { "SourceToTarget", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNodeMappingContainer, SourceToTarget), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNodeMappingContainer_Statics::NewProp_SourceToTarget_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNodeMappingContainer_Statics::NewProp_SourceToTarget_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UNodeMappingContainer, 4163525911);
