...
static struct FScriptStruct_Engine_StaticRegisterNativesFActiveHapticFeedbackEffect
{
	...
	{
		UScriptStruct::DeferCppStructOps<FActiveHapticFeedbackEffect>(FName(TEXT("ActiveHapticFeedbackEffect")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FActiveHapticFeedbackEffect_Hash() { return 2504363186U; }
	...
	IMPLEMENT_CLASS(UHapticFeedbackEffect_Base, 2523934020);
