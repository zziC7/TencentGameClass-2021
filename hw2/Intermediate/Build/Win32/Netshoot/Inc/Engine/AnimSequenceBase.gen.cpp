...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ETypeAdvanceAnim_Hash() { return 2641912502U; }
	...
	DEFINE_FUNCTION(UAnimSequenceBase::execGetPlayLength)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAnimSequenceBase_GetPlayLength_Statics::Function_MetaDataParams[] = {
		{ "Category", "Animation" },
		{ "Comment", "/** Returns the total play length of the montage, if played back with a speed of 1.0. */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimSequenceBase.h" },
		{ "ToolTip", "Returns the total play length of the montage, if played back with a speed of 1.0." },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAnimSequenceBase_GetPlayLength_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAnimSequenceBase, nullptr, "GetPlayLength", nullptr, nullptr, sizeof(AnimSequenceBase_eventGetPlayLength_Parms), Z_Construct_UFunction_UAnimSequenceBase_GetPlayLength_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimSequenceBase_GetPlayLength_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAnimSequenceBase_GetPlayLength_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimSequenceBase_GetPlayLength_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimSequenceBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAnimSequenceBase_GetPlayLength, "GetPlayLength" }, // 1593657797
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimSequenceBase_Statics::NewProp_RawCurveData_MetaData[] = {
		{ "Comment", "/**\n\x09 * Raw uncompressed float curve data \n\x09 */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimSequenceBase.h" },
	...
	IMPLEMENT_CLASS(UAnimSequenceBase, 1612672928);
