...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EPlatformInterfaceDataType_Hash() { return 3039781676U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFDelegateArray
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDelegateArray>(FName(TEXT("DelegateArray")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FDelegateArray_Statics::NewProp_Delegates = { "Delegates", nullptr, (EPropertyFlags)0x0010008000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDelegateArray, Delegates), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FDelegateArray_Statics::NewProp_Delegates_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDelegateArray_Statics::NewProp_Delegates_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FDelegateArray_Hash() { return 2239110784U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFPlatformInterfaceDelegateResult
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPlatformInterfaceDelegateResult>(FName(TEXT("PlatformInterfaceDelegateResult")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPlatformInterfaceDelegateResult_Hash() { return 3753993172U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFPlatformInterfaceData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPlatformInterfaceData>(FName(TEXT("PlatformInterfaceData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPlatformInterfaceData_Hash() { return 2781419629U; }
	...
	IMPLEMENT_CLASS(UPlatformInterfaceBase, 3006427869);
