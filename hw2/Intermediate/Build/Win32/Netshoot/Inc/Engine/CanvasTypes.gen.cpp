...
static struct FScriptStruct_Engine_StaticRegisterNativesFWrappedStringElement
{
	...
	{
		UScriptStruct::DeferCppStructOps<FWrappedStringElement>(FName(TEXT("WrappedStringElement")));
	}
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FWrappedStringElement_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWrappedStringElement, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FWrappedStringElement_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWrappedStringElement_Statics::NewProp_Value_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FWrappedStringElement_Hash() { return 1460228114U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFTextSizingParameters
{
	...
	{
		UScriptStruct::DeferCppStructOps<FTextSizingParameters>(FName(TEXT("TextSizingParameters")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawXL = { "DrawXL", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTextSizingParameters, DrawXL), METADATA_PARAMS(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawXL_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawXL_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawYL = { "DrawYL", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTextSizingParameters, DrawYL), METADATA_PARAMS(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawYL_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawYL_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FTextSizingParameters_Hash() { return 1515254664U; }
