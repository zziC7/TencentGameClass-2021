...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_USoundNodeWaveParam_Statics::NewProp_WaveParameterName = { "WaveParameterName", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeWaveParam, WaveParameterName), METADATA_PARAMS(Z_Construct_UClass_USoundNodeWaveParam_Statics::NewProp_WaveParameterName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeWaveParam_Statics::NewProp_WaveParameterName_MetaData)) };
	...
	IMPLEMENT_CLASS(USoundNodeWaveParam, 1314613300);
