...
static struct FScriptStruct_Engine_StaticRegisterNativesFParticleSystemReplayFrame
{
	...
	{
		UScriptStruct::DeferCppStructOps<FParticleSystemReplayFrame>(FName(TEXT("ParticleSystemReplayFrame")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FParticleSystemReplayFrame_Hash() { return 1508741590U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFParticleEmitterReplayFrame
{
	...
	{
		UScriptStruct::DeferCppStructOps<FParticleEmitterReplayFrame>(FName(TEXT("ParticleEmitterReplayFrame")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FParticleEmitterReplayFrame_Hash() { return 4044001097U; }
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UParticleSystemReplay_Statics::NewProp_ClipIDNumber = { "ClipIDNumber", nullptr, (EPropertyFlags)0x0010000000202001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleSystemReplay, ClipIDNumber), METADATA_PARAMS(Z_Construct_UClass_UParticleSystemReplay_Statics::NewProp_ClipIDNumber_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleSystemReplay_Statics::NewProp_ClipIDNumber_MetaData)) };
	...
	IMPLEMENT_CLASS(UParticleSystemReplay, 638120035);
