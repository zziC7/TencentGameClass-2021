...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionDecalMipmapLevel_Statics::NewProp_TextureSize = { "TextureSize", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionDecalMipmapLevel, TextureSize), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionDecalMipmapLevel_Statics::NewProp_TextureSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionDecalMipmapLevel_Statics::NewProp_TextureSize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionDecalMipmapLevel_Statics::NewProp_ConstWidth = { "ConstWidth", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionDecalMipmapLevel, ConstWidth), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionDecalMipmapLevel_Statics::NewProp_ConstWidth_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionDecalMipmapLevel_Statics::NewProp_ConstWidth_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMaterialExpressionDecalMipmapLevel, 146502700);
