...
static struct FScriptStruct_Engine_StaticRegisterNativesFBoneReference
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBoneReference>(FName(TEXT("BoneReference")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FBoneReference_Hash() { return 2388884560U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimCurveType
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimCurveType>(FName(TEXT("AnimCurveType")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimCurveType_Hash() { return 597424874U; }
