...
static struct FScriptStruct_Engine_StaticRegisterNativesFCollectionVectorParameter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCollectionVectorParameter>(FName(TEXT("CollectionVectorParameter")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCollectionVectorParameter_Statics::NewProp_DefaultValue = { "DefaultValue", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCollectionVectorParameter, DefaultValue), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FCollectionVectorParameter_Statics::NewProp_DefaultValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCollectionVectorParameter_Statics::NewProp_DefaultValue_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FCollectionVectorParameter_Hash() { return 280312532U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFCollectionScalarParameter
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCollectionScalarParameter>(FName(TEXT("CollectionScalarParameter")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FCollectionScalarParameter_Hash() { return 2448473381U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFCollectionParameterBase
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCollectionParameterBase>(FName(TEXT("CollectionParameterBase")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FCollectionParameterBase_Hash() { return 1898582531U; }
	...
	IMPLEMENT_CLASS(UMaterialParameterCollection, 2974673957);
