...
static struct FScriptStruct_Engine_StaticRegisterNativesFRuntimeCurveLinearColor
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRuntimeCurveLinearColor>(FName(TEXT("RuntimeCurveLinearColor")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FRuntimeCurveLinearColor_Hash() { return 3896154660U; }
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCurveLinearColor, nullptr, "GetLinearColorValue", nullptr, nullptr, sizeof(CurveLinearColor_eventGetLinearColorValue_Parms), Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::NewProp_InTime = { "InTime", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CurveLinearColor_eventGetUnadjustedLinearColorValue_Parms, InTime), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CurveLinearColor_eventGetUnadjustedLinearColorValue_Parms, ReturnValue), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::NewProp_InTime,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::Function_MetaDataParams[] = {
		{ "Category", "Math|Curves" },
		{ "ModuleRelativePath", "Classes/Curves/CurveLinearColor.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCurveLinearColor, nullptr, "GetUnadjustedLinearColorValue", nullptr, nullptr, sizeof(CurveLinearColor_eventGetUnadjustedLinearColorValue_Parms), Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCurveLinearColor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCurveLinearColor_GetClampedLinearColorValue, "GetClampedLinearColorValue" }, // 9353932
		{ &Z_Construct_UFunction_UCurveLinearColor_GetLinearColorValue, "GetLinearColorValue" }, // 3518421775
		{ &Z_Construct_UFunction_UCurveLinearColor_GetUnadjustedLinearColorValue, "GetUnadjustedLinearColorValue" }, // 1822842623
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCurveLinearColor, 3538937762);
