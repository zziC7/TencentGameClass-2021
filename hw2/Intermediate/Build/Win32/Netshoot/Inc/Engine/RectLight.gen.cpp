...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARectLight_Statics::NewProp_RectLightComponent = { "RectLightComponent", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARectLight, RectLightComponent), Z_Construct_UClass_URectLightComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ARectLight_Statics::NewProp_RectLightComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARectLight_Statics::NewProp_RectLightComponent_MetaData)) };
	...
	IMPLEMENT_CLASS(ARectLight, 3063228146);
