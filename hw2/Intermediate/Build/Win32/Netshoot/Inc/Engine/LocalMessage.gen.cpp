...
static struct FScriptStruct_Engine_StaticRegisterNativesFClientReceiveData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FClientReceiveData>(FName(TEXT("ClientReceiveData")));
	}
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageType = { "MessageType", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClientReceiveData, MessageType), METADATA_PARAMS(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_RelatedPlayerState_2 = { "RelatedPlayerState_2", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClientReceiveData, RelatedPlayerState_2), Z_Construct_UClass_APlayerState_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_RelatedPlayerState_2_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_RelatedPlayerState_2_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FClientReceiveData_Hash() { return 608793116U; }
	...
	IMPLEMENT_CLASS(ULocalMessage, 3301261011);
