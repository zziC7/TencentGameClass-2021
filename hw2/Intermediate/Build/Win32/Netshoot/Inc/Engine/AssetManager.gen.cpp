...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bHasCompletedInitialScan_MetaData[];
#endif
		static void NewProp_bHasCompletedInitialScan_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bHasCompletedInitialScan;
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAssetManager_Statics::NewProp_ObjectReferenceList = { "ObjectReferenceList", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAssetManager, ObjectReferenceList), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAssetManager_Statics::NewProp_ObjectReferenceList_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAssetManager_Statics::NewProp_ObjectReferenceList_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetManager_Statics::NewProp_bIsBulkScanning_MetaData[] = {
		{ "Comment", "/** True if we are currently in bulk scanning mode */" },
		{ "ModuleRelativePath", "Classes/Engine/AssetManager.h" },
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAssetManager_Statics::NewProp_bHasCompletedInitialScan_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAssetManager_Statics::NewProp_bHasCompletedInitialScan = { "bHasCompletedInitialScan", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAssetManager), &Z_Construct_UClass_UAssetManager_Statics::NewProp_bHasCompletedInitialScan_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAssetManager_Statics::NewProp_bHasCompletedInitialScan_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAssetManager_Statics::NewProp_bHasCompletedInitialScan_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAssetManager_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAssetManager_Statics::NewProp_bHasCompletedInitialScan,
	...
	IMPLEMENT_CLASS(UAssetManager, 197163340);
