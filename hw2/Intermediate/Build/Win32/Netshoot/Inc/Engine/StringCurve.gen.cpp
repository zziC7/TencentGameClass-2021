...
static struct FScriptStruct_Engine_StaticRegisterNativesFStringCurve
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStringCurve>(FName(TEXT("StringCurve")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys = { "Keys", nullptr, (EPropertyFlags)0x0010000000000041, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStringCurve, Keys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FStringCurve_Hash() { return 2781415518U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFStringCurveKey
{
	...
	{
		UScriptStruct::DeferCppStructOps<FStringCurveKey>(FName(TEXT("StringCurveKey")));
	}
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStringCurveKey, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Value_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FStringCurveKey_Hash() { return 2424238376U; }
