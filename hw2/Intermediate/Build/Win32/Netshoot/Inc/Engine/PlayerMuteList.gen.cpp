...
static struct FScriptStruct_Engine_StaticRegisterNativesFPlayerMuteList
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPlayerMuteList>(FName(TEXT("PlayerMuteList")));
	}
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPlayerMuteList_Statics::NewProp_bHasVoiceHandshakeCompleted = { "bHasVoiceHandshakeCompleted", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPlayerMuteList), &Z_Construct_UScriptStruct_FPlayerMuteList_Statics::NewProp_bHasVoiceHandshakeCompleted_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerMuteList_Statics::NewProp_bHasVoiceHandshakeCompleted_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerMuteList_Statics::NewProp_bHasVoiceHandshakeCompleted_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FPlayerMuteList_Hash() { return 438017165U; }
