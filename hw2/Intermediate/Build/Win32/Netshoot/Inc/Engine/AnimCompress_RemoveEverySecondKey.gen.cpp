...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_MinKeys = { "MinKeys", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimCompress_RemoveEverySecondKey, MinKeys), METADATA_PARAMS(Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_MinKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimCompress_RemoveEverySecondKey_Statics::NewProp_MinKeys_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAnimCompress_RemoveEverySecondKey, 4058905238);
