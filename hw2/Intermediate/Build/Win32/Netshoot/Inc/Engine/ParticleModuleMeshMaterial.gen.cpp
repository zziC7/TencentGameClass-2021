...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParticleModuleMeshMaterial_Statics::NewProp_MeshMaterials = { "MeshMaterials", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleMeshMaterial, MeshMaterials), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleMeshMaterial_Statics::NewProp_MeshMaterials_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleMeshMaterial_Statics::NewProp_MeshMaterials_MetaData)) };
	...
	IMPLEMENT_CLASS(UParticleModuleMeshMaterial, 602206910);
