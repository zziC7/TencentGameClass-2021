...
static struct FScriptStruct_Engine_StaticRegisterNativesFAnimBlueprintFunctionData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimBlueprintFunctionData>(FName(TEXT("AnimBlueprintFunctionData")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimBlueprintFunctionData_Hash() { return 3700536358U; }
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAnimClassData_Statics::NewProp_PropertyAccessLibrary_MetaData[] = {
		{ "Comment", "// Property access library\n" },
		{ "ModuleRelativePath", "Classes/Animation/AnimClassData.h" },
		{ "ToolTip", "Property access library" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimClassData_Statics::NewProp_PropertyAccessLibrary = { "PropertyAccessLibrary", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimClassData, PropertyAccessLibrary), Z_Construct_UScriptStruct_FPropertyAccessLibrary, METADATA_PARAMS(Z_Construct_UClass_UAnimClassData_Statics::NewProp_PropertyAccessLibrary_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimClassData_Statics::NewProp_PropertyAccessLibrary_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAnimClassData_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAnimClassData_Statics::NewProp_PropertyAccessLibrary,
	};
	...
	IMPLEMENT_CLASS(UAnimClassData, 2360652853);
