...
static struct FScriptStruct_Engine_StaticRegisterNativesFMemberReference
{
	...
	{
		UScriptStruct::DeferCppStructOps<FMemberReference>(FName(TEXT("MemberReference")));
	}
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberScope = { "MemberScope", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMemberReference, MemberScope), METADATA_PARAMS(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberScope_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberScope_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext = { "bSelfContext", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMemberReference), &Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FMemberReference_Hash() { return 2406170719U; }
