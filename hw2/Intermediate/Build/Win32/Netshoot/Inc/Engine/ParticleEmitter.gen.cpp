...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EEmitterRenderMode_Hash() { return 2841004342U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EParticleSubUVInterpMethod_Hash() { return 3748699707U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EParticleBurstMethod_Hash() { return 3291092305U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFParticleBurst
{
	...
	{
		UScriptStruct::DeferCppStructOps<FParticleBurst>(FName(TEXT("ParticleBurst")));
	}
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FParticleBurst_Statics::NewProp_Count = { "Count", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FParticleBurst, Count), METADATA_PARAMS(Z_Construct_UScriptStruct_FParticleBurst_Statics::NewProp_Count_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParticleBurst_Statics::NewProp_Count_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FParticleBurst_Hash() { return 2312850339U; }
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UParticleEmitter_Statics::NewProp_SubUVDataOffset = { "SubUVDataOffset", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleEmitter, SubUVDataOffset), METADATA_PARAMS(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_SubUVDataOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_SubUVDataOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UParticleEmitter_Statics::NewProp_LODLevels_Inner = { "LODLevels", nullptr, (EPropertyFlags)0x0002000000080008, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UParticleLODLevel_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_LODLevels_Inner_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_LODLevels_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParticleEmitter_Statics::NewProp_LODLevels = { "LODLevels", nullptr, (EPropertyFlags)0x0010008000000008, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleEmitter, LODLevels), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_LODLevels_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_LODLevels_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UParticleEmitter_Statics::NewProp_PeakActiveParticles = { "PeakActiveParticles", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleEmitter, PeakActiveParticles), METADATA_PARAMS(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_PeakActiveParticles_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_PeakActiveParticles_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UParticleEmitter_Statics::NewProp_InitialAllocationCount = { "InitialAllocationCount", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleEmitter, InitialAllocationCount), METADATA_PARAMS(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_InitialAllocationCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_InitialAllocationCount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UParticleEmitter_Statics::NewProp_QualityLevelSpawnRateScale = { "QualityLevelSpawnRateScale", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleEmitter, QualityLevelSpawnRateScale), METADATA_PARAMS(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_QualityLevelSpawnRateScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_QualityLevelSpawnRateScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UParticleEmitter_Statics::NewProp_DetailModeDisplay = { "DetailModeDisplay", nullptr, (EPropertyFlags)0x0010000800022001, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleEmitter, DetailModeDisplay), METADATA_PARAMS(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_DetailModeDisplay_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleEmitter_Statics::NewProp_DetailModeDisplay_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(UParticleEmitter, 482708383);
