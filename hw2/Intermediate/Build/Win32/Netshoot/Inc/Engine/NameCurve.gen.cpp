...
static struct FScriptStruct_Engine_StaticRegisterNativesFNameCurve
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNameCurve>(FName(TEXT("NameCurve")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FNameCurve_Hash() { return 211985762U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFNameCurveKey
{
	...
	{
		UScriptStruct::DeferCppStructOps<FNameCurveKey>(FName(TEXT("NameCurveKey")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNameCurveKey, Time), METADATA_PARAMS(Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Time_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Time_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNameCurveKey, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Value_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FNameCurveKey_Hash() { return 2660077742U; }
