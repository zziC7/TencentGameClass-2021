...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EPSCPoolMethod_Hash() { return 2509210667U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFWorldPSCPool
{
	...
	{
		UScriptStruct::DeferCppStructOps<FWorldPSCPool>(FName(TEXT("WorldPSCPool")));
	}
...
#endif
	const UE4CodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FWorldPSCPool_Statics::NewProp_WorldParticleSystemPools = { "WorldParticleSystemPools", nullptr, (EPropertyFlags)0x0040008000000000, UE4CodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWorldPSCPool, WorldParticleSystemPools), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FWorldPSCPool_Statics::NewProp_WorldParticleSystemPools_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldPSCPool_Statics::NewProp_WorldParticleSystemPools_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FWorldPSCPool_Hash() { return 3521569069U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFPSCPool
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPSCPool>(FName(TEXT("PSCPool")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPSCPool_Statics::NewProp_FreeElements = { "FreeElements", nullptr, (EPropertyFlags)0x0010008000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPSCPool, FreeElements), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPSCPool_Statics::NewProp_FreeElements_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPSCPool_Statics::NewProp_FreeElements_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FPSCPool_Hash() { return 2328955451U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFPSCPoolElem
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPSCPoolElem>(FName(TEXT("PSCPoolElem")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPSCPoolElem_Hash() { return 2790057818U; }
