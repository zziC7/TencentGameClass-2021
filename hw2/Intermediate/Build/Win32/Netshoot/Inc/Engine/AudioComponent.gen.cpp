...
// End Cross Module References
	...
	struct Z_Construct_UDelegateFunction_Engine_OnAudioVirtualizationChanged__DelegateSignature_Statics
	{
		...
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsVirtualized;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_Engine_OnAudioVirtualizationChanged__DelegateSignature_Statics::NewProp_bIsVirtualized = { "bIsVirtualized", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(_Script_Engine_eventOnAudioVirtualizationChanged_Parms), &Z_Construct_UDelegateFunction_Engine_OnAudioVirtualizationChanged__DelegateSignature_Statics::NewProp_bIsVirtualized_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_Engine_OnAudioVirtualizationChanged__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Engine_OnAudioVirtualizationChanged__DelegateSignature_Statics::NewProp_bIsVirtualized,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Engine_OnAudioVirtualizationChanged__DelegateSignature_Statics::Function_MetaDataParams[] = {
	...
	struct Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_PlayState_Underlying;
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_PlayState;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::NewProp_PlayState_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::NewProp_PlayState = { "PlayState", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventOnAudioPlayStateChanged_Parms, PlayState), Z_Construct_UEnum_Engine_EAudioComponentPlayState, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::NewProp_PlayState_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::NewProp_PlayState,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "Comment", "/** Called when sound's PlayState changes. */" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "Called when sound's PlayState changes." },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Engine, nullptr, "OnAudioPlayStateChanged__DelegateSignature", nullptr, nullptr, sizeof(_Script_Engine_eventOnAudioPlayStateChanged_Parms), Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	uint32 Get_Z_Construct_UEnum_Engine_EAudioFaderCurve_Hash() { return 1009288669U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EAudioComponentPlayState_Hash() { return 2536416513U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFAudioComponentParam
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAudioComponentParam>(FName(TEXT("AudioComponentParam")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAudioComponentParam_Hash() { return 1388610566U; }
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_HasCookedAmplitudeEnvelopeData_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
		{ "Comment", "/** Queries whether or not the targeted Audio Component instance\xe2\x80\x99s sound has Envelope Data, returns FALSE if none found. */" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "Queries whether or not the targeted Audio Component instance\xe2\x80\x99s sound has Envelope Data, returns FALSE if none found." },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AudioComponent_eventIsVirtualized_Parms), &Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioComponent, nullptr, "IsVirtualized", nullptr, nullptr, sizeof(AudioComponent_eventIsVirtualized_Parms), Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAudioComponent_IsVirtualized()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAudioComponent_IsVirtualized_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_Play_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
		{ "Comment", "/** Begins playing the targeted Audio Component\xe2\x80\x99s sound at the designated Start Time, seeking into a sound. \n\x09 * @param StartTime The offset, in seconds, to begin reading the sound at\n\x09 */" },
		{ "CPP_Default_StartTime", "0.000000" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "Begins playing the targeted Audio Component\xe2\x80\x99s sound at the designated Start Time, seeking into a sound.\n@param StartTime The offset, in seconds, to begin reading the sound at" },
	};
#endif
	...
	struct Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics
	{
		...
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_InFadeInDuration;
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_InFadeVolumeLevel;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_InFadeCurve_Underlying;
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_InFadeCurve;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_WorldContextObject_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000082, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventPlayQuantized_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_WorldContextObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_WorldContextObject_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InClockHandle = { "InClockHandle", nullptr, (EPropertyFlags)0x0010000008000180, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventPlayQuantized_Parms, InClockHandle), Z_Construct_UClass_UQuartzClockHandle_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InQuantizationBoundary = { "InQuantizationBoundary", nullptr, (EPropertyFlags)0x0010000008000180, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventPlayQuantized_Parms, InQuantizationBoundary), Z_Construct_UScriptStruct_FQuartzQuantizationBoundary, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InDelegate_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UE4CodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InDelegate = { "InDelegate", nullptr, (EPropertyFlags)0x0010040008000182, UE4CodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventPlayQuantized_Parms, InDelegate), Z_Construct_UDelegateFunction_Engine_OnQuartzCommandEventBP__DelegateSignature, METADATA_PARAMS(Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InDelegate_MetaData)) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InStartTime = { "InStartTime", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventPlayQuantized_Parms, InStartTime), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InFadeInDuration = { "InFadeInDuration", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventPlayQuantized_Parms, InFadeInDuration), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InFadeVolumeLevel = { "InFadeVolumeLevel", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventPlayQuantized_Parms, InFadeVolumeLevel), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InFadeCurve_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InFadeCurve = { "InFadeCurve", nullptr, (EPropertyFlags)0x0010040000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventPlayQuantized_Parms, InFadeCurve), Z_Construct_UEnum_Engine_EAudioFaderCurve, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_WorldContextObject,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InClockHandle,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InQuantizationBoundary,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InDelegate,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InStartTime,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InFadeInDuration,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InFadeVolumeLevel,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InFadeCurve_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::NewProp_InFadeCurve,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::Function_MetaDataParams[] = {
		{ "AdvancedDisplay", "3" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioComponent, nullptr, "PlayQuantized", nullptr, nullptr, sizeof(AudioComponent_eventPlayQuantized_Parms), Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04420400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAudioComponent_PlayQuantized()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAudioComponent_PlayQuantized_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics
	{
		...
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_AudioBusSendLevel;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::NewProp_AudioBus = { "AudioBus", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventSetAudioBusSendPostEffect_Parms, AudioBus), Z_Construct_UClass_UAudioBus_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::NewProp_AudioBusSendLevel = { "AudioBusSendLevel", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventSetAudioBusSendPostEffect_Parms, AudioBusSendLevel), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::NewProp_AudioBus,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::NewProp_AudioBusSendLevel,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioComponent, nullptr, "SetAudioBusSendPostEffect", nullptr, nullptr, sizeof(AudioComponent_eventSetAudioBusSendPostEffect_Parms), Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::NewProp_AudioBus = { "AudioBus", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventSetAudioBusSendPreEffect_Parms, AudioBus), Z_Construct_UClass_UAudioBus_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::NewProp_AudioBusSendLevel = { "AudioBusSendLevel", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioComponent_eventSetAudioBusSendPreEffect_Parms, AudioBusSendLevel), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::NewProp_AudioBus,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::NewProp_AudioBusSendLevel,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAudioComponent, nullptr, "SetAudioBusSendPreEffect", nullptr, nullptr, sizeof(AudioComponent_eventSetAudioBusSendPreEffect_Parms), Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_SetBoolParameter_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
		{ "Comment", "/** Allows the designer to set the Boolean Parameter on the SoundCue whose name matches the name indicated.\n\x09 * @param InName The name of the Boolean to set. It must match the name set in SoundCue's Branch Node \n\x09 * @param InBool The value to set the Parameter to\n\x09 */" },
		{ "DisplayName", "Set Boolean Parameter" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "Allows the designer to set the Boolean Parameter on the SoundCue whose name matches the name indicated.\n@param InName The name of the Boolean to set. It must match the name set in SoundCue's Branch Node\n@param InBool The value to set the Parameter to" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_SetFloatParameter_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
		{ "Comment", "/** Allows the designer to set the Float Parameter on the SoundCue whose name matches the name indicated.\n\x09 * @param InName The name of the Float to set. It must match the name set in SoundCue's Crossfade By Param or Continuous Modulator Node.\n\x09 * @param InFloat The value to set the Parameter to.\n\x09 */" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "Allows the designer to set the Float Parameter on the SoundCue whose name matches the name indicated.\n@param InName The name of the Float to set. It must match the name set in SoundCue's Crossfade By Param or Continuous Modulator Node.\n@param InFloat The value to set the Parameter to." },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_SetIntParameter_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
		{ "Comment", "/** Allows the designer to set the Integer Parameter on the SoundCue whose name matches the name indicated.\n\x09 * @param InName The name of the Integer to set. It must match the name set in SoundCue's Switch Node\n\x09 * @param InInt The value to set the Parameter to\n\x09 */" },
		{ "DisplayName", "Set Integer Parameter" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "Allows the designer to set the Integer Parameter on the SoundCue whose name matches the name indicated.\n@param InName The name of the Integer to set. It must match the name set in SoundCue's Switch Node\n@param InInt The value to set the Parameter to" },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAudioComponent_SetOutputToBusOnly_Statics::NewProp_bInOutputToBusOnly = { "bInOutputToBusOnly", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AudioComponent_eventSetOutputToBusOnly_Parms), &Z_Construct_UFunction_UAudioComponent_SetOutputToBusOnly_Statics::NewProp_bInOutputToBusOnly_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAudioComponent_SetOutputToBusOnly_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAudioComponent_SetOutputToBusOnly_Statics::NewProp_bInOutputToBusOnly,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_SetOutputToBusOnly_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAudioComponent_SetWaveParameter_Statics::Function_MetaDataParams[] = {
		{ "Category", "Audio|Components|Audio" },
		{ "Comment", "/** Allows the designer to set the Wave Parameter on the SoundCue whose name matches the name indicated.\n\x09 * @param InName The name of the Wave to set. It must match the name set in SoundCue's WaveParam Node\n\x09 * @param InWave The value to set the Parameter to\n\x09 */" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "Allows the designer to set the Wave Parameter on the SoundCue whose name matches the name indicated.\n@param InName The name of the Wave to set. It must match the name set in SoundCue's WaveParam Node\n@param InWave The value to set the Parameter to" },
	};
#endif
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ModulationRouting_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_ModulationRouting;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OnAudioPlayStateChanged_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnAudioPlayStateChanged;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_OnAudioVirtualizationChanged_MetaData[];
#endif
		static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnAudioVirtualizationChanged;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAudioComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAudioComponent_AdjustAttenuation, "AdjustAttenuation" }, // 3164955329
		{ &Z_Construct_UFunction_UAudioComponent_AdjustVolume, "AdjustVolume" }, // 1280942039
		{ &Z_Construct_UFunction_UAudioComponent_BP_GetAttenuationSettingsToApply, "BP_GetAttenuationSettingsToApply" }, // 3364704194
		{ &Z_Construct_UFunction_UAudioComponent_FadeIn, "FadeIn" }, // 1151996149
		{ &Z_Construct_UFunction_UAudioComponent_FadeOut, "FadeOut" }, // 885633037
		{ &Z_Construct_UFunction_UAudioComponent_GetCookedEnvelopeData, "GetCookedEnvelopeData" }, // 1256868258
		{ &Z_Construct_UFunction_UAudioComponent_GetCookedEnvelopeDataForAllPlayingSounds, "GetCookedEnvelopeDataForAllPlayingSounds" }, // 1446057539
		{ &Z_Construct_UFunction_UAudioComponent_GetCookedFFTData, "GetCookedFFTData" }, // 1265802411
		{ &Z_Construct_UFunction_UAudioComponent_GetCookedFFTDataForAllPlayingSounds, "GetCookedFFTDataForAllPlayingSounds" }, // 287306732
		{ &Z_Construct_UFunction_UAudioComponent_GetPlayState, "GetPlayState" }, // 3749977707
		{ &Z_Construct_UFunction_UAudioComponent_HasCookedAmplitudeEnvelopeData, "HasCookedAmplitudeEnvelopeData" }, // 3277624466
		{ &Z_Construct_UFunction_UAudioComponent_HasCookedFFTData, "HasCookedFFTData" }, // 2761651012
		{ &Z_Construct_UFunction_UAudioComponent_IsPlaying, "IsPlaying" }, // 4074069495
		{ &Z_Construct_UFunction_UAudioComponent_IsVirtualized, "IsVirtualized" }, // 1006845239
		{ &Z_Construct_UFunction_UAudioComponent_Play, "Play" }, // 2476031868
		{ &Z_Construct_UFunction_UAudioComponent_PlayQuantized, "PlayQuantized" }, // 3930502931
		{ &Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPostEffect, "SetAudioBusSendPostEffect" }, // 1904573868
		{ &Z_Construct_UFunction_UAudioComponent_SetAudioBusSendPreEffect, "SetAudioBusSendPreEffect" }, // 2069757560
		{ &Z_Construct_UFunction_UAudioComponent_SetBoolParameter, "SetBoolParameter" }, // 4125168852
		{ &Z_Construct_UFunction_UAudioComponent_SetFloatParameter, "SetFloatParameter" }, // 3064472887
		{ &Z_Construct_UFunction_UAudioComponent_SetIntParameter, "SetIntParameter" }, // 1778192941
		{ &Z_Construct_UFunction_UAudioComponent_SetLowPassFilterEnabled, "SetLowPassFilterEnabled" }, // 182221701
		{ &Z_Construct_UFunction_UAudioComponent_SetLowPassFilterFrequency, "SetLowPassFilterFrequency" }, // 3864499674
		{ &Z_Construct_UFunction_UAudioComponent_SetOutputToBusOnly, "SetOutputToBusOnly" }, // 2675407470
		...
		{ &Z_Construct_UFunction_UAudioComponent_SetSourceBusSendPostEffect, "SetSourceBusSendPostEffect" }, // 2183408962
		{ &Z_Construct_UFunction_UAudioComponent_SetSourceBusSendPreEffect, "SetSourceBusSendPreEffect" }, // 2120154093
		{ &Z_Construct_UFunction_UAudioComponent_SetSubmixSend, "SetSubmixSend" }, // 2465581628
		...
		{ &Z_Construct_UFunction_UAudioComponent_SetWaveParameter, "SetWaveParameter" }, // 796257451
		{ &Z_Construct_UFunction_UAudioComponent_Stop, "Stop" }, // 3452359505
		{ &Z_Construct_UFunction_UAudioComponent_StopDelayed, "StopDelayed" }, // 1398932999
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAudioComponent_Statics::NewProp_LowPassFilterFrequency_MetaData[] = {
		{ "Category", "Filter" },
		{ "ClampMin", "0.0" },
		{ "Comment", "/** The frequency of the Lowpass Filter (in Hz) to apply to this voice. A frequency of 0.0 is the device sample rate and will bypass the filter. */" },
		{ "EditCondition", "bEnableLowPassFilter" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "The frequency of the Lowpass Filter (in Hz) to apply to this voice. A frequency of 0.0 is the device sample rate and will bypass the filter." },
		{ "UIMin", "0.0" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAudioComponent_Statics::NewProp_ModulationRouting_MetaData[] = {
		{ "Category", "Modulation" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAudioComponent_Statics::NewProp_ModulationRouting = { "ModulationRouting", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAudioComponent, ModulationRouting), Z_Construct_UScriptStruct_FSoundModulationDefaultRoutingSettings, METADATA_PARAMS(Z_Construct_UClass_UAudioComponent_Statics::NewProp_ModulationRouting_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAudioComponent_Statics::NewProp_ModulationRouting_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioPlayStateChanged_MetaData[] = {
		{ "Comment", "/** This function returns the Targeted Audio Component\xe2\x80\x99s current Play State.\n\x09  * Playing, if the sound is currently playing.\n\x09  * Stopped, if the sound is stopped.\n\x09  * Paused, if the sound is currently playing, but paused.\n\x09  * Fading In, if the sound is in the process of Fading In.\n\x09  * Fading Out, if the sound is in the process of Fading Out.\n\x09  */" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "This function returns the Targeted Audio Component\xe2\x80\x99s current Play State.\nPlaying, if the sound is currently playing.\nStopped, if the sound is stopped.\nPaused, if the sound is currently playing, but paused.\nFading In, if the sound is in the process of Fading In.\nFading Out, if the sound is in the process of Fading Out." },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioPlayStateChanged = { "OnAudioPlayStateChanged", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAudioComponent, OnAudioPlayStateChanged), Z_Construct_UDelegateFunction_Engine_OnAudioPlayStateChanged__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioPlayStateChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioPlayStateChanged_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioVirtualizationChanged_MetaData[] = {
		{ "Comment", "/** Called when virtualization state changes */" },
		{ "ModuleRelativePath", "Classes/Components/AudioComponent.h" },
		{ "ToolTip", "Called when virtualization state changes" },
	};
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioVirtualizationChanged = { "OnAudioVirtualizationChanged", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAudioComponent, OnAudioVirtualizationChanged), Z_Construct_UDelegateFunction_Engine_OnAudioVirtualizationChanged__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioVirtualizationChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioVirtualizationChanged_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAudioComponent_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAudioComponent_Statics::NewProp_ModulationRouting,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioPlayStateChanged,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAudioComponent_Statics::NewProp_OnAudioVirtualizationChanged,
	...
	IMPLEMENT_CLASS(UAudioComponent, 1138345487);
