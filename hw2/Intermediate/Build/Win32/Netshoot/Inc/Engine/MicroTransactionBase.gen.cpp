...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMicroTransactionResult_Hash() { return 4265902444U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMicroTransactionDelegate_Hash() { return 2411676521U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFPurchaseInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPurchaseInfo>(FName(TEXT("PurchaseInfo")));
	}
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_Identifier = { "Identifier", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPurchaseInfo, Identifier), METADATA_PARAMS(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_Identifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_Identifier_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPurchaseInfo, DisplayName), METADATA_PARAMS(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayDescription = { "DisplayDescription", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPurchaseInfo, DisplayDescription), METADATA_PARAMS(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayDescription_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayDescription_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayPrice = { "DisplayPrice", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPurchaseInfo, DisplayPrice), METADATA_PARAMS(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayPrice_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayPrice_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FPurchaseInfo_Hash() { return 1091318245U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_AvailableProducts = { "AvailableProducts", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMicroTransactionBase, AvailableProducts), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_AvailableProducts_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_AvailableProducts_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMicroTransactionBase, 2479684723);
