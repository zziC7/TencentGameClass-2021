...
static struct FScriptStruct_Engine_StaticRegisterNativesFSingleAnimationPlayData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSingleAnimationPlayData>(FName(TEXT("SingleAnimationPlayData")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_AnimToPlay = { "AnimToPlay", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSingleAnimationPlayData, AnimToPlay), Z_Construct_UClass_UAnimationAsset_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_AnimToPlay_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_AnimToPlay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPlayRate = { "SavedPlayRate", nullptr, (EPropertyFlags)0x0010040000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSingleAnimationPlayData, SavedPlayRate), METADATA_PARAMS(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPlayRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPlayRate_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FSingleAnimationPlayData_Hash() { return 3381571U; }
