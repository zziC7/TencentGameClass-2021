...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundNodeDoppler_Statics::NewProp_bUseSmoothing = { "bUseSmoothing", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USoundNodeDoppler), &Z_Construct_UClass_USoundNodeDoppler_Statics::NewProp_bUseSmoothing_SetBit, METADATA_PARAMS(Z_Construct_UClass_USoundNodeDoppler_Statics::NewProp_bUseSmoothing_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeDoppler_Statics::NewProp_bUseSmoothing_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USoundNodeDoppler, 855669244);
