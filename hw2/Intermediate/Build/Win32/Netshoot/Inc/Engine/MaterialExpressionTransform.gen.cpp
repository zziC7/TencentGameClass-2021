...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMaterialVectorCoordTransform_Hash() { return 29117940U; }
	UEnum* Z_Construct_UEnum_Engine_EMaterialVectorCoordTransform()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "TRANSFORM_ParticleWorld.Comment", "/** Particle space */" },
	...
	uint32 Get_Z_Construct_UEnum_Engine_EMaterialVectorCoordTransformSource_Hash() { return 3644955845U; }
	UEnum* Z_Construct_UEnum_Engine_EMaterialVectorCoordTransformSource()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "TRANSFORMSOURCE_ParticleWorld.Comment", "/** Particle space */" },
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialExpressionTransform_Statics::NewProp_TransformType = { "TransformType", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionTransform, TransformType), Z_Construct_UEnum_Engine_EMaterialVectorCoordTransform, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionTransform_Statics::NewProp_TransformType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionTransform_Statics::NewProp_TransformType_MetaData)) };
	...
	IMPLEMENT_CLASS(UMaterialExpressionTransform, 2395918346);
