...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBreakpoint_Statics::NewProp_Node = { "Node", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBreakpoint, Node), Z_Construct_UClass_UEdGraphNode_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBreakpoint_Statics::NewProp_Node_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBreakpoint_Statics::NewProp_Node_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UBreakpoint_Statics::ClassParams = {
		...
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_UBreakpoint_Statics::PropPointers),
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UBreakpoint_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UBreakpoint_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UBreakpoint, 2110519567);
