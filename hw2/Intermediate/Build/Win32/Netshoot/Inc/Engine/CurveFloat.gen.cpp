...
static struct FScriptStruct_Engine_StaticRegisterNativesFRuntimeFloatCurve
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRuntimeFloatCurve>(FName(TEXT("RuntimeFloatCurve")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewProp_EditorCurveData = { "EditorCurveData", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRuntimeFloatCurve, EditorCurveData), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewProp_EditorCurveData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewProp_EditorCurveData_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FRuntimeFloatCurve_Hash() { return 3877505771U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCurveFloat_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCurveFloat_GetFloatValue, "GetFloatValue" }, // 3917063206
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UCurveFloat, 17392548);
