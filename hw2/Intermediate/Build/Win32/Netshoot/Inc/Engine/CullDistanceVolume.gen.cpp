...
static struct FScriptStruct_Engine_StaticRegisterNativesFCullDistanceSizePair
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCullDistanceSizePair>(FName(TEXT("CullDistanceSizePair")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FCullDistanceSizePair_Hash() { return 2833881647U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_CullDistances = { "CullDistances", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACullDistanceVolume, CullDistances), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_CullDistances_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_CullDistances_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_bEnabled = { "bEnabled", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACullDistanceVolume), &Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_bEnabled_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_bEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_bEnabled_MetaData)) };
	...
	IMPLEMENT_CLASS(ACullDistanceVolume, 941104626);
