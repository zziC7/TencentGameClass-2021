...
static struct FScriptStruct_Engine_StaticRegisterNativesFPoseSnapshot
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPoseSnapshot>(FName(TEXT("PoseSnapshot")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_BoneNames = { "BoneNames", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPoseSnapshot, BoneNames), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_BoneNames_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPoseSnapshot_Statics::NewProp_BoneNames_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FPoseSnapshot_Hash() { return 3525915110U; }
