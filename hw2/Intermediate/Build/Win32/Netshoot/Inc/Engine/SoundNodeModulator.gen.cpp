...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMin = { "PitchMin", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeModulator, PitchMin), METADATA_PARAMS(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMax = { "PitchMax", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeModulator, PitchMax), METADATA_PARAMS(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMax_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMax_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USoundNodeModulator, 1158967047);
