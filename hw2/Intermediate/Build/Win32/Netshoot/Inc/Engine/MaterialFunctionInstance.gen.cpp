...
// End Cross Module References
	...
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialFunctionInstance_Statics::NewProp_RuntimeVirtualTextureParameterValues_Inner = { "RuntimeVirtualTextureParameterValues", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FRuntimeVirtualTextureParameterValue, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialFunctionInstance_Statics::NewProp_RuntimeVirtualTextureParameterValues_MetaData[] = {
		{ "Category", "MaterialFunctionInstance" },
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMaterialFunctionInstance_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMaterialFunctionInstance_Statics::NewProp_RuntimeVirtualTextureParameterValues_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMaterialFunctionInstance_Statics::NewProp_RuntimeVirtualTextureParameterValues,
#if WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(UMaterialFunctionInstance, 4253883169);
