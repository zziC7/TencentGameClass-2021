...
static struct FScriptStruct_Engine_StaticRegisterNativesFPreviewMeshCollectionEntry
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPreviewMeshCollectionEntry>(FName(TEXT("PreviewMeshCollectionEntry")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPreviewMeshCollectionEntry_Hash() { return 1744240607U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_SkeletalMeshes = { "SkeletalMeshes", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPreviewMeshCollection, SkeletalMeshes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_SkeletalMeshes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_SkeletalMeshes_MetaData)) };
	...
	IMPLEMENT_CLASS(UPreviewMeshCollection, 3111473144);
