...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactThreshold = { "ImpactThreshold", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsCollisionHandler, ImpactThreshold), METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactReFireDelay = { "ImpactReFireDelay", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsCollisionHandler, ImpactReFireDelay), METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactReFireDelay_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactReFireDelay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_LastImpactSoundTime = { "LastImpactSoundTime", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsCollisionHandler, LastImpactSoundTime), METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_LastImpactSoundTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_LastImpactSoundTime_MetaData)) };
	...
	IMPLEMENT_CLASS(UPhysicsCollisionHandler, 1929729240);
