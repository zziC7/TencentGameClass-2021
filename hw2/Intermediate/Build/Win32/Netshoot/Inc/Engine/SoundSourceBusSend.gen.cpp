...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ESourceBusSendLevelControlMethod_Hash() { return 109047874U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFSoundSourceBusSendInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSoundSourceBusSendInfo>(FName(TEXT("SoundSourceBusSendInfo")));
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSoundSourceBusSendInfo_Statics::NewProp_AudioBus_MetaData[] = {
		{ "Category", "BusSend" },
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FSoundSourceBusSendInfo_Statics::NewProp_AudioBus = { "AudioBus", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSoundSourceBusSendInfo, AudioBus), Z_Construct_UClass_UAudioBus_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSoundSourceBusSendInfo_Statics::NewProp_AudioBus_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSoundSourceBusSendInfo_Statics::NewProp_AudioBus_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FSoundSourceBusSendInfo_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FSoundSourceBusSendInfo_Statics::NewProp_AudioBus,
	...
	uint32 Get_Z_Construct_UScriptStruct_FSoundSourceBusSendInfo_Hash() { return 2248547276U; }
