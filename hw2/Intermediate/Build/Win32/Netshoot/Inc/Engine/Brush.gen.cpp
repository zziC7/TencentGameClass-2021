...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_EBrushType_Hash() { return 2792277579U; }
	...
	uint32 Get_Z_Construct_UEnum_Engine_ECsgOper_Hash() { return 445764114U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFGeomSelection
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGeomSelection>(FName(TEXT("GeomSelection")));
	}
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FGeomSelection_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGeomSelection, Type), METADATA_PARAMS(Z_Construct_UScriptStruct_FGeomSelection_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGeomSelection_Statics::NewProp_Type_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FGeomSelection_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGeomSelection, Index), METADATA_PARAMS(Z_Construct_UScriptStruct_FGeomSelection_Statics::NewProp_Index_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGeomSelection_Statics::NewProp_Index_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FGeomSelection_Hash() { return 2900565484U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ABrush_Statics::NewProp_SavedSelections = { "SavedSelections", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABrush, SavedSelections), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ABrush_Statics::NewProp_SavedSelections_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABrush_Statics::NewProp_SavedSelections_MetaData)) };
	...
	IMPLEMENT_CLASS(ABrush, 2570196576);
