...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHLODEngineSubsystem_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UHLODEngineSubsystem_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UHLODEngineSubsystem()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UHLODEngineSubsystem_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UHLODEngineSubsystem, 3202482549);
	template<> ENGINE_API UClass* StaticClass<UHLODEngineSubsystem>()
	{
		return UHLODEngineSubsystem::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UHLODEngineSubsystem(Z_Construct_UClass_UHLODEngineSubsystem, &UHLODEngineSubsystem::StaticClass, TEXT("/Script/Engine"), TEXT("UHLODEngineSubsystem"), false, nullptr, nullptr, nullptr);
