...
// End Cross Module References
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USpectatorPawnMovement_Statics::NewProp_bIgnoreTimeDilation = { "bIgnoreTimeDilation", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(USpectatorPawnMovement), &Z_Construct_UClass_USpectatorPawnMovement_Statics::NewProp_bIgnoreTimeDilation_SetBit, METADATA_PARAMS(Z_Construct_UClass_USpectatorPawnMovement_Statics::NewProp_bIgnoreTimeDilation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USpectatorPawnMovement_Statics::NewProp_bIgnoreTimeDilation_MetaData)) };
	...
	IMPLEMENT_CLASS(USpectatorPawnMovement, 3149387499);
