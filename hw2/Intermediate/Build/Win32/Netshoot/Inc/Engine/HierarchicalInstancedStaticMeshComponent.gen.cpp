...
static struct FScriptStruct_Engine_StaticRegisterNativesFClusterNode
{
	...
	{
		UScriptStruct::DeferCppStructOps<FClusterNode>(FName(TEXT("ClusterNode")));
	}
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_BoundMin = { "BoundMin", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClusterNode, BoundMin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_BoundMin_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_BoundMin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_BoundMax = { "BoundMax", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClusterNode, BoundMax), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_BoundMax_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_BoundMax_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_LastChild_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Components/HierarchicalInstancedStaticMeshComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_LastChild = { "LastChild", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClusterNode, LastChild), METADATA_PARAMS(Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_LastChild_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_LastChild_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_MinInstanceScale = { "MinInstanceScale", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClusterNode, MinInstanceScale), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_MinInstanceScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClusterNode_Statics::NewProp_MinInstanceScale_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FClusterNode_Hash() { return 2474020768U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFClusterNode_DEPRECATED
{
	...
	{
		UScriptStruct::DeferCppStructOps<FClusterNode_DEPRECATED>(FName(TEXT("ClusterNode_DEPRECATED")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FClusterNode_DEPRECATED_Hash() { return 3265463807U; }
	DEFINE_FUNCTION(UHierarchicalInstancedStaticMeshComponent::execRemoveInstances)
	{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHierarchicalInstancedStaticMeshComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHierarchicalInstancedStaticMeshComponent_RemoveInstances, "RemoveInstances" }, // 1602154882
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHierarchicalInstancedStaticMeshComponent_Statics::NewProp_SortedInstances_MetaData[] = {
		{ "Comment", "// Table for remaping instances from cluster tree to PerInstanceSMData order\n" },
		{ "ModuleRelativePath", "Classes/Components/HierarchicalInstancedStaticMeshComponent.h" },
		{ "ToolTip", "Table for remaping instances from cluster tree to PerInstanceSMData order" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHierarchicalInstancedStaticMeshComponent_Statics::NewProp_SortedInstances = { "SortedInstances", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHierarchicalInstancedStaticMeshComponent, SortedInstances), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UHierarchicalInstancedStaticMeshComponent_Statics::NewProp_SortedInstances_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHierarchicalInstancedStaticMeshComponent_Statics::NewProp_SortedInstances_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UHierarchicalInstancedStaticMeshComponent_Statics::NewProp_UnbuiltInstanceBoundsList = { "UnbuiltInstanceBoundsList", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHierarchicalInstancedStaticMeshComponent, UnbuiltInstanceBoundsList), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UHierarchicalInstancedStaticMeshComponent_Statics::NewProp_UnbuiltInstanceBoundsList_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHierarchicalInstancedStaticMeshComponent_Statics::NewProp_UnbuiltInstanceBoundsList_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UHierarchicalInstancedStaticMeshComponent, 1247658798);
