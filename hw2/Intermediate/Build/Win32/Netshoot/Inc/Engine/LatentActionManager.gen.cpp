...
static struct FScriptStruct_Engine_StaticRegisterNativesFLatentActionManager
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLatentActionManager>(FName(TEXT("LatentActionManager")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FLatentActionManager_Hash() { return 3051922875U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFLatentActionInfo
{
	...
	{
		UScriptStruct::DeferCppStructOps<FLatentActionInfo>(FName(TEXT("LatentActionInfo")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FLatentActionInfo_Hash() { return 671594833U; }
