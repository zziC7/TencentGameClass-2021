...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCheatManagerExtension_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UCheatManagerExtension_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UCheatManagerExtension()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UCheatManagerExtension_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UCheatManagerExtension, 2878444707);
	template<> ENGINE_API UClass* StaticClass<UCheatManagerExtension>()
	{
		return UCheatManagerExtension::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UCheatManagerExtension(Z_Construct_UClass_UCheatManagerExtension, &UCheatManagerExtension::StaticClass, TEXT("/Script/Engine"), TEXT("UCheatManagerExtension"), false, nullptr, nullptr, nullptr);
	...
	struct Z_Construct_UClass_UCheatManager_Statics
	{
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_CheatManagerExtensions_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_CheatManagerExtensions_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_CheatManagerExtensions;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const FCppClassTypeInfoStatic StaticCppClassTypeInfo;
		static const UE4CodeGen_Private::FClassParams ClassParams;
	};
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCheatManager_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UCheatManager_BugItGo, "BugItGo" }, // 961476492
		{ &Z_Construct_UFunction_UCheatManager_BugItStringCreator, "BugItStringCreator" }, // 3602948924
		...
		{ &Z_Construct_UFunction_UCheatManager_DebugCapsuleSweepSize, "DebugCapsuleSweepSize" }, // 1684915281
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UCheatManager_Statics::NewProp_CheatManagerExtensions_Inner = { "CheatManagerExtensions", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UCheatManagerExtension_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UCheatManager_Statics::NewProp_CheatManagerExtensions_MetaData[] = {
		{ "Comment", "/** List of registered cheat manager extensions */" },
		{ "ModuleRelativePath", "Classes/GameFramework/CheatManager.h" },
		{ "ToolTip", "List of registered cheat manager extensions" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCheatManager_Statics::NewProp_CheatManagerExtensions = { "CheatManagerExtensions", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCheatManager, CheatManagerExtensions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCheatManager_Statics::NewProp_CheatManagerExtensions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCheatManager_Statics::NewProp_CheatManagerExtensions_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UCheatManager_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCheatManager_Statics::NewProp_CheatManagerExtensions_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UCheatManager_Statics::NewProp_CheatManagerExtensions,
	};
	...
	IMPLEMENT_CLASS(UCheatManager, 3356691931);
