...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UParticleModuleBeamTarget_Statics::NewProp_TargetTangentMethod = { "TargetTangentMethod", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleBeamTarget, TargetTangentMethod), Z_Construct_UEnum_Engine_Beam2SourceTargetTangentMethod, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleBeamTarget_Statics::NewProp_TargetTangentMethod_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleBeamTarget_Statics::NewProp_TargetTangentMethod_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleBeamTarget_Statics::NewProp_TargetTangent = { "TargetTangent", nullptr, (EPropertyFlags)0x0010008000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleBeamTarget, TargetTangent), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleBeamTarget_Statics::NewProp_TargetTangent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleBeamTarget_Statics::NewProp_TargetTangent_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UParticleModuleBeamTarget, 16112700);
