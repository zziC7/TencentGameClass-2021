...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPlayer_Statics::NewProp_CurrentNetSpeed = { "CurrentNetSpeed", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPlayer, CurrentNetSpeed), METADATA_PARAMS(Z_Construct_UClass_UPlayer_Statics::NewProp_CurrentNetSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPlayer_Statics::NewProp_CurrentNetSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredInternetSpeed = { "ConfiguredInternetSpeed", nullptr, (EPropertyFlags)0x0010000000044000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPlayer, ConfiguredInternetSpeed), METADATA_PARAMS(Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredInternetSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredInternetSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredLanSpeed = { "ConfiguredLanSpeed", nullptr, (EPropertyFlags)0x0010000000044000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPlayer, ConfiguredLanSpeed), METADATA_PARAMS(Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredLanSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredLanSpeed_MetaData)) };
	...
	IMPLEMENT_CLASS(UPlayer, 3493016869);
