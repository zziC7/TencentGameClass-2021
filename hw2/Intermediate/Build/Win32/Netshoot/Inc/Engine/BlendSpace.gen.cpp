...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlendSpace_Statics::NewProp_AxisToScaleAnimation_MetaData[] = {
		...
		{ "Comment", "/** If you have input interpolation, which axis to drive animation speed (scale) - i.e. for locomotion animation, speed axis will drive animation speed (thus scale)**/" },
		{ "ModuleRelativePath", "Classes/Animation/BlendSpace.h" },
	...
	IMPLEMENT_CLASS(UBlendSpace, 396585114);
