...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_Engine_ETrackToggleAction_Hash() { return 780070661U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFToggleTrackKey
{
	...
	{
		UScriptStruct::DeferCppStructOps<FToggleTrackKey>(FName(TEXT("ToggleTrackKey")));
	}
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FToggleTrackKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FToggleTrackKey, Time), METADATA_PARAMS(Z_Construct_UScriptStruct_FToggleTrackKey_Statics::NewProp_Time_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FToggleTrackKey_Statics::NewProp_Time_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FToggleTrackKey_Statics::NewProp_ToggleAction = { "ToggleAction", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FToggleTrackKey, ToggleAction), Z_Construct_UEnum_Engine_ETrackToggleAction, METADATA_PARAMS(Z_Construct_UScriptStruct_FToggleTrackKey_Statics::NewProp_ToggleAction_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FToggleTrackKey_Statics::NewProp_ToggleAction_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FToggleTrackKey_Hash() { return 1909514829U; }
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInterpTrackToggle_Statics::NewProp_ToggleTrack = { "ToggleTrack", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInterpTrackToggle, ToggleTrack), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInterpTrackToggle_Statics::NewProp_ToggleTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInterpTrackToggle_Statics::NewProp_ToggleTrack_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInterpTrackToggle, 2421351850);
