...
static struct FScriptStruct_Engine_StaticRegisterNativesFSimpleCurve
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSimpleCurve>(FName(TEXT("SimpleCurve")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSimpleCurve_Hash() { return 3055615592U; }
...
static struct FScriptStruct_Engine_StaticRegisterNativesFSimpleCurveKey
{
	...
	{
		UScriptStruct::DeferCppStructOps<FSimpleCurveKey>(FName(TEXT("SimpleCurveKey")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FSimpleCurveKey_Hash() { return 165819923U; }
