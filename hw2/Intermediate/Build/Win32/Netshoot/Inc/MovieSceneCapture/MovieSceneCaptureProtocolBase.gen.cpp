...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_MovieSceneCapture_EMovieSceneCaptureProtocolState_Hash() { return 528356352U; }
...
static struct FScriptStruct_MovieSceneCapture_StaticRegisterNativesFFrameMetrics
{
	...
	{
		UScriptStruct::DeferCppStructOps<FFrameMetrics>(FName(TEXT("FrameMetrics")));
	}
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_FrameNumber = { "FrameNumber", nullptr, (EPropertyFlags)0x0010000000000014, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFrameMetrics, FrameNumber), METADATA_PARAMS(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_FrameNumber_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_FrameNumber_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FFrameMetrics_Hash() { return 2033956421U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneCaptureProtocolBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneCaptureProtocolBase_GetState, "GetState" }, // 3310509309
		{ &Z_Construct_UFunction_UMovieSceneCaptureProtocolBase_IsCapturing, "IsCapturing" }, // 3610652535
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieSceneCaptureProtocolBase_Statics::NewProp_State = { "State", nullptr, (EPropertyFlags)0x0040000000002000, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCaptureProtocolBase, State), Z_Construct_UEnum_MovieSceneCapture_EMovieSceneCaptureProtocolState, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCaptureProtocolBase_Statics::NewProp_State_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCaptureProtocolBase_Statics::NewProp_State_MetaData)) };
	...
	IMPLEMENT_CLASS(UMovieSceneCaptureProtocolBase, 2787946995);
	...
	IMPLEMENT_CLASS(UMovieSceneImageCaptureProtocolBase, 232790725);
	...
	IMPLEMENT_CLASS(UMovieSceneAudioCaptureProtocolBase, 1704735469);
