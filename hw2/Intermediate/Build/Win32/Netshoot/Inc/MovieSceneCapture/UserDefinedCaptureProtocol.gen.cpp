...
static struct FScriptStruct_MovieSceneCapture_StaticRegisterNativesFCapturedPixels
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCapturedPixels>(FName(TEXT("CapturedPixels")));
	}
...
static struct FScriptStruct_MovieSceneCapture_StaticRegisterNativesFCapturedPixelsID
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCapturedPixelsID>(FName(TEXT("CapturedPixelsID")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FCapturedPixelsID_Hash() { return 1748889203U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UUserDefinedCaptureProtocol_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUserDefinedCaptureProtocol_GenerateFilename, "GenerateFilename" }, // 6362338
		...
		{ &Z_Construct_UFunction_UUserDefinedCaptureProtocol_OnPixelsReceived, "OnPixelsReceived" }, // 723655912
		...
		{ &Z_Construct_UFunction_UUserDefinedCaptureProtocol_ResolveBuffer, "ResolveBuffer" }, // 436155946
	...
	IMPLEMENT_CLASS(UUserDefinedCaptureProtocol, 3317869854);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UUserDefinedImageCaptureProtocol_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUserDefinedImageCaptureProtocol_GenerateFilenameForBuffer, "GenerateFilenameForBuffer" }, // 3099652219
		...
		{ &Z_Construct_UFunction_UUserDefinedImageCaptureProtocol_WriteImageToDisk, "WriteImageToDisk" }, // 924469683
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UUserDefinedImageCaptureProtocol, 2722334178);
