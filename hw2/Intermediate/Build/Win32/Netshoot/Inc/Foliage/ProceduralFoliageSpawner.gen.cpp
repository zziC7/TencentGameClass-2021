...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UProceduralFoliageSpawner_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UProceduralFoliageSpawner_Simulate, "Simulate" }, // 3518255074
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_RandomSeed = { "RandomSeed", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UProceduralFoliageSpawner, RandomSeed), METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_RandomSeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_RandomSeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_TileSize = { "TileSize", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UProceduralFoliageSpawner, TileSize), METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_TileSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_TileSize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_MinimumQuadTreeSize = { "MinimumQuadTreeSize", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UProceduralFoliageSpawner, MinimumQuadTreeSize), METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_MinimumQuadTreeSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_MinimumQuadTreeSize_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_FoliageTypes = { "FoliageTypes", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UProceduralFoliageSpawner, FoliageTypes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_FoliageTypes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UProceduralFoliageSpawner_Statics::NewProp_FoliageTypes_MetaData)) };
	...
	IMPLEMENT_CLASS(UProceduralFoliageSpawner, 3631762550);
