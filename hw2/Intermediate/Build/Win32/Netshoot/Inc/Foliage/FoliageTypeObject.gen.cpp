...
static struct FScriptStruct_Foliage_StaticRegisterNativesFFoliageTypeObject
{
	...
	{
		UScriptStruct::DeferCppStructOps<FFoliageTypeObject>(FName(TEXT("FoliageTypeObject")));
	}
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_FoliageTypeObject = { "FoliageTypeObject", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFoliageTypeObject, FoliageTypeObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_FoliageTypeObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_FoliageTypeObject_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_TypeInstance = { "TypeInstance", nullptr, (EPropertyFlags)0x0040000000002000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFoliageTypeObject, TypeInstance), Z_Construct_UClass_UFoliageType_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_TypeInstance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_TypeInstance_MetaData)) };
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UScriptStruct_FFoliageTypeObject_Hash() { return 3505982725U; }
