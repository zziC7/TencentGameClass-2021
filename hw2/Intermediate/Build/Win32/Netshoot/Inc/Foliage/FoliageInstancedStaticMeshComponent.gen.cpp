...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_Foliage_InstanceRadialDamageSignature__DelegateSignature_Statics::NewProp_Instances = { "Instances", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Foliage_eventInstanceRadialDamageSignature_Parms, Instances), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UDelegateFunction_Foliage_InstanceRadialDamageSignature__DelegateSignature_Statics::NewProp_Instances_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Foliage_InstanceRadialDamageSignature__DelegateSignature_Statics::NewProp_Instances_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_Foliage_InstanceRadialDamageSignature__DelegateSignature_Statics::NewProp_Damages = { "Damages", nullptr, (EPropertyFlags)0x0010000008000182, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Foliage_eventInstanceRadialDamageSignature_Parms, Damages), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UDelegateFunction_Foliage_InstanceRadialDamageSignature__DelegateSignature_Statics::NewProp_Damages_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Foliage_InstanceRadialDamageSignature__DelegateSignature_Statics::NewProp_Damages_MetaData)) };
...
#endif
		static const UE4CodeGen_Private::FFInt64PropertyParams NewProp_FoliageHiddenEditorViews;
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_GenerationGuid_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_GenerationGuid;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_EDITORONLY_DATA
#endif // WITH_EDITORONLY_DATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_OnInstanceTakeRadialDamage = { "OnInstanceTakeRadialDamage", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFoliageInstancedStaticMeshComponent, OnInstanceTakeRadialDamage), Z_Construct_UDelegateFunction_Foliage_InstanceRadialDamageSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_OnInstanceTakeRadialDamage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_OnInstanceTakeRadialDamage_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFInt64PropertyParams Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_FoliageHiddenEditorViews = { "FoliageHiddenEditorViews", nullptr, (EPropertyFlags)0x0010000800002000, UE4CodeGen_Private::EPropertyGenFlags::UInt64, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFoliageInstancedStaticMeshComponent, FoliageHiddenEditorViews), METADATA_PARAMS(Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_FoliageHiddenEditorViews_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_FoliageHiddenEditorViews_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_GenerationGuid_MetaData[] = {
		{ "ModuleRelativePath", "Public/FoliageInstancedStaticMeshComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_GenerationGuid = { "GenerationGuid", nullptr, (EPropertyFlags)0x0040000000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFoliageInstancedStaticMeshComponent, GenerationGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_GenerationGuid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_GenerationGuid_MetaData)) };
...
#endif // WITH_EDITORONLY_DATA
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UFoliageInstancedStaticMeshComponent_Statics::NewProp_GenerationGuid,
	};
	...
	IMPLEMENT_CLASS(UFoliageInstancedStaticMeshComponent, 1820748715);
