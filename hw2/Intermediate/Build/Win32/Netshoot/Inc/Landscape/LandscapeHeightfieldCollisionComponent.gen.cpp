...
// End Cross Module References
	...
	struct Z_Construct_UClass_ULandscapeHeightfieldCollisionComponent_Statics
	{
		...
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_PhysicalMaterialRenderObjects_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PhysicalMaterialRenderObjects_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_PhysicalMaterialRenderObjects;
...
#if WITH_EDITORONLY_DATA
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ULandscapeHeightfieldCollisionComponent_Statics::NewProp_PhysicalMaterialRenderObjects_Inner = { "PhysicalMaterialRenderObjects", nullptr, (EPropertyFlags)0x0000000800000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPhysicalMaterial_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULandscapeHeightfieldCollisionComponent_Statics::NewProp_PhysicalMaterialRenderObjects_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULandscapeHeightfieldCollisionComponent_Statics::NewProp_PhysicalMaterialRenderObjects = { "PhysicalMaterialRenderObjects", nullptr, (EPropertyFlags)0x0010000800000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeHeightfieldCollisionComponent, PhysicalMaterialRenderObjects), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULandscapeHeightfieldCollisionComponent_Statics::NewProp_PhysicalMaterialRenderObjects_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeHeightfieldCollisionComponent_Statics::NewProp_PhysicalMaterialRenderObjects_MetaData)) };
#endif // WITH_EDITORONLY_DATA
...
#if WITH_EDITORONLY_DATA
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULandscapeHeightfieldCollisionComponent_Statics::NewProp_PhysicalMaterialRenderObjects_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ULandscapeHeightfieldCollisionComponent_Statics::NewProp_PhysicalMaterialRenderObjects,
#endif // WITH_EDITORONLY_DATA
	...
	IMPLEMENT_CLASS(ULandscapeHeightfieldCollisionComponent, 1374832114);
