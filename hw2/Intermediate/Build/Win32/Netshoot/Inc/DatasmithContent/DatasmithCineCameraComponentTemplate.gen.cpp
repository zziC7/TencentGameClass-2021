...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithPostProcessSettingsTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithPostProcessSettingsTemplate>(FName(TEXT("DatasmithPostProcessSettingsTemplate")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithPostProcessSettingsTemplate_Hash() { return 787363074U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithCameraFocusSettingsTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithCameraFocusSettingsTemplate>(FName(TEXT("DatasmithCameraFocusSettingsTemplate")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithCameraFocusSettingsTemplate_Hash() { return 1340094150U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithCameraLensSettingsTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithCameraLensSettingsTemplate>(FName(TEXT("DatasmithCameraLensSettingsTemplate")));
	}
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithCameraFilmbackSettingsTemplate
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithCameraFilmbackSettingsTemplate>(FName(TEXT("DatasmithCameraFilmbackSettingsTemplate")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithCameraFilmbackSettingsTemplate_Hash() { return 2426795755U; }
	...
	IMPLEMENT_CLASS(UDatasmithCineCameraComponentTemplate, 3326434078);
