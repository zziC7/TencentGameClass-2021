...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_LandscapeMaterial_MetaData[] = {
		{ "ModuleRelativePath", "Public/ObjectTemplates/DatasmithLandscapeTemplate.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_LandscapeMaterial = { "LandscapeMaterial", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithLandscapeTemplate, LandscapeMaterial), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_LandscapeMaterial_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_LandscapeMaterial_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_StaticLightingLOD_MetaData[] = {
		{ "ModuleRelativePath", "Public/ObjectTemplates/DatasmithLandscapeTemplate.h" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_StaticLightingLOD = { "StaticLightingLOD", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithLandscapeTemplate, StaticLightingLOD), METADATA_PARAMS(Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_StaticLightingLOD_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_StaticLightingLOD_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_LandscapeMaterial,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_StaticLightingLOD,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UDatasmithLandscapeTemplate()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UDatasmithLandscapeTemplate, 1914555577);
	template<> DATASMITHCONTENT_API UClass* StaticClass<UDatasmithLandscapeTemplate>()
	{
		return UDatasmithLandscapeTemplate::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UDatasmithLandscapeTemplate(Z_Construct_UClass_UDatasmithLandscapeTemplate, &UDatasmithLandscapeTemplate::StaticClass, TEXT("/Script/DatasmithContent"), TEXT("UDatasmithLandscapeTemplate"), false, nullptr, nullptr, nullptr);
