...
// End Cross Module References
	static UEnum* EDatasmithCADRetessellationRule_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_DatasmithContent_EDatasmithCADRetessellationRule, Z_Construct_UPackage__Script_DatasmithContent(), TEXT("EDatasmithCADRetessellationRule"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EDatasmithCADRetessellationRule(EDatasmithCADRetessellationRule_StaticEnum, TEXT("/Script/DatasmithContent"), TEXT("EDatasmithCADRetessellationRule"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithCADRetessellationRule_Hash() { return 935082165U; }
	UEnum* Z_Construct_UEnum_DatasmithContent_EDatasmithCADRetessellationRule()
	{
		...
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EDatasmithCADRetessellationRule"), 0, Get_Z_Construct_UEnum_DatasmithContent_EDatasmithCADRetessellationRule_Hash(), false);
#else
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithCADStitchingTechnique_Hash() { return 3468827320U; }
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithImportScene_Hash() { return 2406285870U; }
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithImportLightmapMax_Hash() { return 289639299U; }
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithImportLightmapMin_Hash() { return 3311419350U; }
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithImportMaterialQuality_Hash() { return 865732522U; }
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithImportActorPolicy_Hash() { return 238556439U; }
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithImportAssetConflictPolicy_Hash() { return 3897703857U; }
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithImportSearchPackagePolicy_Hash() { return 584919210U; }
...
class UScriptStruct* FDatasmithRetessellationOptions::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern DATASMITHCONTENT_API uint32 Get_Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FDatasmithRetessellationOptions, Z_Construct_UPackage__Script_DatasmithContent(), TEXT("DatasmithRetessellationOptions"), sizeof(FDatasmithRetessellationOptions), Get_Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FDatasmithRetessellationOptions(FDatasmithRetessellationOptions::StaticStruct, TEXT("/Script/DatasmithContent"), TEXT("DatasmithRetessellationOptions"), false, nullptr, nullptr);
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithRetessellationOptions
{
	FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithRetessellationOptions()
	{
		UScriptStruct::DeferCppStructOps<FDatasmithRetessellationOptions>(FName(TEXT("DatasmithRetessellationOptions")));
	}
} ScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithRetessellationOptions;
	struct Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics
	{
		...
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_RetessellationRule_Underlying;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_RetessellationRule_MetaData[];
#endif
		static const UE4CodeGen_Private::FEnumPropertyParams NewProp_RetessellationRule;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
		static const UE4CodeGen_Private::FStructParams ReturnStructParams;
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/DatasmithImportOptions.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::NewProp_RetessellationRule_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::NewProp_RetessellationRule_MetaData[] = {
		{ "Category", "Retessellation Options" },
		{ "ModuleRelativePath", "Public/DatasmithImportOptions.h" },
		{ "ToolTip", "Regenerate deleted surfaces during retesselate or ignore them" },
	};
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::NewProp_RetessellationRule = { "RetessellationRule", nullptr, (EPropertyFlags)0x0010040000004005, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDatasmithRetessellationOptions, RetessellationRule), Z_Construct_UEnum_DatasmithContent_EDatasmithCADRetessellationRule, METADATA_PARAMS(Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::NewProp_RetessellationRule_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::NewProp_RetessellationRule_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::NewProp_RetessellationRule_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::NewProp_RetessellationRule,
	};
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_DatasmithContent,
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_DatasmithContent();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("DatasmithRetessellationOptions"), sizeof(FDatasmithRetessellationOptions), Get_Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithRetessellationOptions_Hash() { return 3103515801U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithTessellationOptions
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithTessellationOptions>(FName(TEXT("DatasmithTessellationOptions")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithTessellationOptions_Hash() { return 3624480378U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithImportBaseOptions
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithImportBaseOptions>(FName(TEXT("DatasmithImportBaseOptions")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithImportBaseOptions_Hash() { return 3340233528U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithReimportOptions
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithReimportOptions>(FName(TEXT("DatasmithReimportOptions")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithReimportOptions_Hash() { return 4252272246U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithStaticMeshImportOptions
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithStaticMeshImportOptions>(FName(TEXT("DatasmithStaticMeshImportOptions")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FDatasmithStaticMeshImportOptions_Hash() { return 1057040562U; }
...
static struct FScriptStruct_DatasmithContent_StaticRegisterNativesFDatasmithAssetImportOptions
{
	...
	{
		UScriptStruct::DeferCppStructOps<FDatasmithAssetImportOptions>(FName(TEXT("DatasmithAssetImportOptions")));
	}
	...
	IMPLEMENT_CLASS(UDatasmithImportOptions, 441649879);
