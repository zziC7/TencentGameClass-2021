...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithAreaLightActorType_Hash() { return 3696887827U; }
	...
	uint32 Get_Z_Construct_UEnum_DatasmithContent_EDatasmithAreaLightActorShape_Hash() { return 3885683852U; }
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_Mobility_MetaData[] = {
		{ "Category", "Mobility" },
		{ "ModuleRelativePath", "Public/DatasmithAreaLightActor.h" },
	};
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_Mobility = { "Mobility", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADatasmithAreaLightActor, Mobility), Z_Construct_UEnum_Engine_EComponentMobility, METADATA_PARAMS(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_Mobility_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_Mobility_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ADatasmithAreaLightActor_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ADatasmithAreaLightActor_Statics::NewProp_Mobility,
	...
	IMPLEMENT_CLASS(ADatasmithAreaLightActor, 3619761782);
