...
// End Cross Module References
	static UEnum* EOculusDeviceType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_OculusHMD_EOculusDeviceType, Z_Construct_UPackage__Script_OculusHMD(), TEXT("EOculusDeviceType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EOculusDeviceType(EOculusDeviceType_StaticEnum, TEXT("/Script/OculusHMD"), TEXT("EOculusDeviceType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_OculusHMD_EOculusDeviceType_Hash() { return 800476887U; }
	UEnum* Z_Construct_UEnum_OculusHMD_EOculusDeviceType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_OculusHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EOculusDeviceType"), 0, Get_Z_Construct_UEnum_OculusHMD_EOculusDeviceType_Hash(), false);
#else
	...
	static UEnum* EHandTrackingSupport_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_OculusHMD_EHandTrackingSupport, Z_Construct_UPackage__Script_OculusHMD(), TEXT("EHandTrackingSupport"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EHandTrackingSupport(EHandTrackingSupport_StaticEnum, TEXT("/Script/OculusHMD"), TEXT("EHandTrackingSupport"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_OculusHMD_EHandTrackingSupport_Hash() { return 2986492417U; }
	UEnum* Z_Construct_UEnum_OculusHMD_EHandTrackingSupport()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_OculusHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EHandTrackingSupport"), 0, Get_Z_Construct_UEnum_OculusHMD_EHandTrackingSupport_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
	...
	static UEnum* EColorSpace_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_OculusHMD_EColorSpace, Z_Construct_UPackage__Script_OculusHMD(), TEXT("EColorSpace"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EColorSpace(EColorSpace_StaticEnum, TEXT("/Script/OculusHMD"), TEXT("EColorSpace"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_OculusHMD_EColorSpace_Hash() { return 3689020133U; }
	UEnum* Z_Construct_UEnum_OculusHMD_EColorSpace()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_OculusHMD();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EColorSpace"), 0, Get_Z_Construct_UEnum_OculusHMD_EColorSpace_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "EColorSpace::Unknown", (int64)EColorSpace::Unknown },
				{ "EColorSpace::Unmanaged", (int64)EColorSpace::Unmanaged },
				{ "EColorSpace::Rec_2020", (int64)EColorSpace::Rec_2020 },
				{ "EColorSpace::Rec_709", (int64)EColorSpace::Rec_709 },
				{ "EColorSpace::Rift_CV1", (int64)EColorSpace::Rift_CV1 },
				{ "EColorSpace::Rift_S", (int64)EColorSpace::Rift_S },
				{ "EColorSpace::Quest", (int64)EColorSpace::Quest },
				{ "EColorSpace::P3", (int64)EColorSpace::P3 },
				{ "EColorSpace::Adobe_RGB", (int64)EColorSpace::Adobe_RGB },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "Adobe_RGB.Comment", "/// Similar to sRGB but with deeper greens using D65 white point\n" },
				{ "Adobe_RGB.Name", "EColorSpace::Adobe_RGB" },
				...
				{ "Rec_2020.Name", "EColorSpace::Rec_2020" },
				...
				{ "Rec_709.Name", "EColorSpace::Rec_709" },
				...
				{ "Rift_CV1.Name", "EColorSpace::Rift_CV1" },
				...
				{ "Rift_S.Name", "EColorSpace::Rift_S" },
				...
				{ "Unknown.Name", "EColorSpace::Unknown" },
				...
				{ "Unmanaged.Name", "EColorSpace::Unmanaged" },
	...
	uint32 Get_Z_Construct_UEnum_OculusHMD_EBoundaryType_Hash() { return 2110948211U; }
	...
	uint32 Get_Z_Construct_UEnum_OculusHMD_EFixedFoveatedRenderingLevel_Hash() { return 2699503878U; }
	...
	uint32 Get_Z_Construct_UEnum_OculusHMD_ETrackedDeviceType_Hash() { return 2904385809U; }
...
static struct FScriptStruct_OculusHMD_StaticRegisterNativesFGuardianTestResult
{
	...
	{
		UScriptStruct::DeferCppStructOps<FGuardianTestResult>(FName(TEXT("GuardianTestResult")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FGuardianTestResult_Hash() { return 1351719910U; }
...
static struct FScriptStruct_OculusHMD_StaticRegisterNativesFHmdUserProfile
{
	...
	{
		UScriptStruct::DeferCppStructOps<FHmdUserProfile>(FName(TEXT("HmdUserProfile")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FHmdUserProfile_Hash() { return 3107132790U; }
...
static struct FScriptStruct_OculusHMD_StaticRegisterNativesFHmdUserProfileField
{
	...
	{
		UScriptStruct::DeferCppStructOps<FHmdUserProfileField>(FName(TEXT("HmdUserProfileField")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FHmdUserProfileField_Hash() { return 3829187821U; }
	...
	{
		P_GET_ENUM(EColorSpace,Z_Param_ColorSpace);
		P_FINISH;
		P_NATIVE_BEGIN;
		UOculusFunctionLibrary::SetClientColorDesc(EColorSpace(Z_Param_ColorSpace));
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UOculusFunctionLibrary::execGetHmdColorDesc)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(EColorSpace*)Z_Param__Result=UOculusFunctionLibrary::GetHmdColorDesc();
		P_NATIVE_END;
	}
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OculusFunctionLibrary_eventGetDeviceType_Parms, ReturnValue), Z_Construct_UEnum_OculusHMD_EOculusDeviceType, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::NewProp_ReturnValue_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::Function_MetaDataParams[] = {
		{ "Category", "OculusLibrary" },
		{ "ModuleRelativePath", "Public/OculusFunctionLibrary.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetDeviceType", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetDeviceType_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OculusFunctionLibrary_eventGetHmdColorDesc_Parms, ReturnValue), Z_Construct_UEnum_OculusHMD_EColorSpace, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::NewProp_ReturnValue_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::Function_MetaDataParams[] = {
		{ "Category", "OculusLibrary" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetHmdColorDesc", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetHmdColorDesc_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(OculusFunctionLibrary_eventGetSystemHmd3DofModeEnabled_Parms), &Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::Function_MetaDataParams[] = {
		{ "Category", "OculusLibrary" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "GetSystemHmd3DofModeEnabled", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventGetSystemHmd3DofModeEnabled_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::NewProp_ColorSpace_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::NewProp_ColorSpace = { "ColorSpace", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OculusFunctionLibrary_eventSetClientColorDesc_Parms, ColorSpace), Z_Construct_UEnum_OculusHMD_EColorSpace, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::NewProp_ColorSpace_Underlying,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::NewProp_ColorSpace,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::Function_MetaDataParams[] = {
		{ "Category", "OculusLibrary" },
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UOculusFunctionLibrary, nullptr, "SetClientColorDesc", nullptr, nullptr, sizeof(OculusFunctionLibrary_eventSetClientColorDesc_Parms), Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UOculusFunctionLibrary_SetFixedFoveatedRenderingLevel_Statics
	{
		...
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_isDynamic;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UOculusFunctionLibrary_SetFixedFoveatedRenderingLevel_Statics::NewProp_isDynamic = { "isDynamic", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(OculusFunctionLibrary_eventSetFixedFoveatedRenderingLevel_Parms), &Z_Construct_UFunction_UOculusFunctionLibrary_SetFixedFoveatedRenderingLevel_Statics::NewProp_isDynamic_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UOculusFunctionLibrary_SetFixedFoveatedRenderingLevel_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UOculusFunctionLibrary_SetFixedFoveatedRenderingLevel_Statics::NewProp_isDynamic,
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UOculusFunctionLibrary_SetReorientHMDOnControllerRecenter_Statics::Function_MetaDataParams[] = {
		...
		{ "DeprecatedFunction", "" },
		{ "DeprecationMessage", "This function is no longer supported." },
		{ "ModuleRelativePath", "Public/OculusFunctionLibrary.h" },
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOculusFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_AddLoadingSplashScreen, "AddLoadingSplashScreen" }, // 1268833527
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_ClearLoadingSplashScreens, "ClearLoadingSplashScreens" }, // 399938437
		...
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetAvailableDisplayFrequencies, "GetAvailableDisplayFrequencies" }, // 2915681374
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndBaseOffsetInMeters, "GetBaseRotationAndBaseOffsetInMeters" }, // 2647607799
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetBaseRotationAndPositionOffset, "GetBaseRotationAndPositionOffset" }, // 3071107439
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetCurrentDisplayFrequency, "GetCurrentDisplayFrequency" }, // 897487277
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceName, "GetDeviceName" }, // 1141054825
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetDeviceType, "GetDeviceType" }, // 310529174
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetFixedFoveatedRenderingLevel, "GetFixedFoveatedRenderingLevel" }, // 209228761
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUFrameTime, "GetGPUFrameTime" }, // 874643675
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetGPUUtilization, "GetGPUUtilization" }, // 1808717519
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianDimensions, "GetGuardianDimensions" }, // 733964088
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetGuardianPoints, "GetGuardianPoints" }, // 1263116336
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetHmdColorDesc, "GetHmdColorDesc" }, // 183295619
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetNodeGuardianIntersection, "GetNodeGuardianIntersection" }, // 2050513574
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetPlayAreaTransform, "GetPlayAreaTransform" }, // 3232303732
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetPointGuardianIntersection, "GetPointGuardianIntersection" }, // 2877071945
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetPose, "GetPose" }, // 1816960359
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetRawSensorData, "GetRawSensorData" }, // 3167552857
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetSystemHmd3DofModeEnabled, "GetSystemHmd3DofModeEnabled" }, // 4199670874
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_GetUserProfile, "GetUserProfile" }, // 4122988240
		...
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_IsDeviceTracked, "IsDeviceTracked" }, // 2546325255
		...
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetBaseRotationAndBaseOffsetInMeters, "SetBaseRotationAndBaseOffsetInMeters" }, // 394910414
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetBaseRotationAndPositionOffset, "SetBaseRotationAndPositionOffset" }, // 1992420815
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetClientColorDesc, "SetClientColorDesc" }, // 3846978625
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetColorScaleAndOffset, "SetColorScaleAndOffset" }, // 1282453595
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetCPUAndGPULevels, "SetCPUAndGPULevels" }, // 1829372678
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetDisplayFrequency, "SetDisplayFrequency" }, // 2419475774
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetFixedFoveatedRenderingLevel, "SetFixedFoveatedRenderingLevel" }, // 3950827401
		...
		{ &Z_Construct_UFunction_UOculusFunctionLibrary_SetReorientHMDOnControllerRecenter, "SetReorientHMDOnControllerRecenter" }, // 796556376
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UOculusFunctionLibrary, 3964882011);
