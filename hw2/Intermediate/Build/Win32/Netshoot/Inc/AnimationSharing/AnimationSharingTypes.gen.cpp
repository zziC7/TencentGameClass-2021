...
static struct FScriptStruct_AnimationSharing_StaticRegisterNativesFAnimationSharingScalability
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimationSharingScalability>(FName(TEXT("AnimationSharingScalability")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimationSharingScalability_Hash() { return 2454258608U; }
...
static struct FScriptStruct_AnimationSharing_StaticRegisterNativesFPerSkeletonAnimationSharingSetup
{
	...
	{
		UScriptStruct::DeferCppStructOps<FPerSkeletonAnimationSharingSetup>(FName(TEXT("PerSkeletonAnimationSharingSetup")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FPerSkeletonAnimationSharingSetup_Hash() { return 2117720129U; }
...
static struct FScriptStruct_AnimationSharing_StaticRegisterNativesFAnimationStateEntry
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimationStateEntry>(FName(TEXT("AnimationStateEntry")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimationStateEntry_Hash() { return 3579952483U; }
...
static struct FScriptStruct_AnimationSharing_StaticRegisterNativesFAnimationSetup
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAnimationSetup>(FName(TEXT("AnimationSetup")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAnimationSetup_Hash() { return 3778070069U; }
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimationSharingStateProcessor_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAnimationSharingStateProcessor_ProcessActorState, "ProcessActorState" }, // 3518551059
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAnimationSharingStateProcessor, 3348537254);
