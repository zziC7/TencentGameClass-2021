...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFAdaptorPolygon2Group
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAdaptorPolygon2Group>(FName(TEXT("AdaptorPolygon2Group")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAdaptorPolygon2Group_Hash() { return 3067657775U; }
...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFAdaptorPolygon
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAdaptorPolygon>(FName(TEXT("AdaptorPolygon")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FAdaptorPolygon_Hash() { return 2892557091U; }

static_assert(std::is_polymorphic<FAdaptorTriangleID>() == std::is_polymorphic<FElementID>(), "USTRUCT FAdaptorTriangleID cannot be polymorphic unless super FElementID is polymorphic");
...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFAdaptorTriangleID
{
	...
	{
		UScriptStruct::DeferCppStructOps<FAdaptorTriangleID>(FName(TEXT("AdaptorTriangleID")));
	}
	...
	IMPLEMENT_CLASS(UEditableGeometryCollectionAdapter, 2295318342);
