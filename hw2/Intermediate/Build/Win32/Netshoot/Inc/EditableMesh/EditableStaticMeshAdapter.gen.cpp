...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFRenderingPolygonGroup
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRenderingPolygonGroup>(FName(TEXT("RenderingPolygonGroup")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FRenderingPolygonGroup_Hash() { return 4027576896U; }
...
static struct FScriptStruct_EditableMesh_StaticRegisterNativesFRenderingPolygon
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRenderingPolygon>(FName(TEXT("RenderingPolygon")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FRenderingPolygon_Hash() { return 2924175864U; }
	...
	IMPLEMENT_CLASS(UEditableStaticMeshAdapter, 2193767306);
