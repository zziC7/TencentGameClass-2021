...
// End Cross Module References
	static UEnum* EGeometryCollectionCacheType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_Chaos_EGeometryCollectionCacheType, Z_Construct_UPackage__Script_Chaos(), TEXT("EGeometryCollectionCacheType"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EGeometryCollectionCacheType(EGeometryCollectionCacheType_StaticEnum, TEXT("/Script/Chaos"), TEXT("EGeometryCollectionCacheType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_Chaos_EGeometryCollectionCacheType_Hash() { return 1787770246U; }
	UEnum* Z_Construct_UEnum_Chaos_EGeometryCollectionCacheType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_Chaos();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EGeometryCollectionCacheType"), 0, Get_Z_Construct_UEnum_Chaos_EGeometryCollectionCacheType_Hash(), false);
#else
...
class UScriptStruct* FRecordedTransformTrack::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern CHAOS_API uint32 Get_Z_Construct_UScriptStruct_FRecordedTransformTrack_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FRecordedTransformTrack, Z_Construct_UPackage__Script_Chaos(), TEXT("RecordedTransformTrack"), sizeof(FRecordedTransformTrack), Get_Z_Construct_UScriptStruct_FRecordedTransformTrack_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FRecordedTransformTrack(FRecordedTransformTrack::StaticStruct, TEXT("/Script/Chaos"), TEXT("RecordedTransformTrack"), false, nullptr, nullptr);
static struct FScriptStruct_Chaos_StaticRegisterNativesFRecordedTransformTrack
{
	FScriptStruct_Chaos_StaticRegisterNativesFRecordedTransformTrack()
	{
		UScriptStruct::DeferCppStructOps<FRecordedTransformTrack>(FName(TEXT("RecordedTransformTrack")));
	}
} ScriptStruct_Chaos_StaticRegisterNativesFRecordedTransformTrack;
	...
	uint32 Get_Z_Construct_UScriptStruct_FRecordedTransformTrack_Hash() { return 2986761092U; }
class UScriptStruct* FRecordedFrame::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern CHAOS_API uint32 Get_Z_Construct_UScriptStruct_FRecordedFrame_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FRecordedFrame, Z_Construct_UPackage__Script_Chaos(), TEXT("RecordedFrame"), sizeof(FRecordedFrame), Get_Z_Construct_UScriptStruct_FRecordedFrame_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FRecordedFrame(FRecordedFrame::StaticStruct, TEXT("/Script/Chaos"), TEXT("RecordedFrame"), false, nullptr, nullptr);
static struct FScriptStruct_Chaos_StaticRegisterNativesFRecordedFrame
{
	FScriptStruct_Chaos_StaticRegisterNativesFRecordedFrame()
	{
		UScriptStruct::DeferCppStructOps<FRecordedFrame>(FName(TEXT("RecordedFrame")));
	}
} ScriptStruct_Chaos_StaticRegisterNativesFRecordedFrame;
	...
	uint32 Get_Z_Construct_UScriptStruct_FRecordedFrame_Hash() { return 881361327U; }
class UScriptStruct* FSolverTrailingData::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern CHAOS_API uint32 Get_Z_Construct_UScriptStruct_FSolverTrailingData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FSolverTrailingData, Z_Construct_UPackage__Script_Chaos(), TEXT("SolverTrailingData"), sizeof(FSolverTrailingData), Get_Z_Construct_UScriptStruct_FSolverTrailingData_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FSolverTrailingData(FSolverTrailingData::StaticStruct, TEXT("/Script/Chaos"), TEXT("SolverTrailingData"), false, nullptr, nullptr);
static struct FScriptStruct_Chaos_StaticRegisterNativesFSolverTrailingData
{
	FScriptStruct_Chaos_StaticRegisterNativesFSolverTrailingData()
	{
		UScriptStruct::DeferCppStructOps<FSolverTrailingData>(FName(TEXT("SolverTrailingData")));
	}
} ScriptStruct_Chaos_StaticRegisterNativesFSolverTrailingData;
	...
	uint32 Get_Z_Construct_UScriptStruct_FSolverTrailingData_Hash() { return 1861564352U; }
class UScriptStruct* FSolverBreakingData::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern CHAOS_API uint32 Get_Z_Construct_UScriptStruct_FSolverBreakingData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FSolverBreakingData, Z_Construct_UPackage__Script_Chaos(), TEXT("SolverBreakingData"), sizeof(FSolverBreakingData), Get_Z_Construct_UScriptStruct_FSolverBreakingData_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FSolverBreakingData(FSolverBreakingData::StaticStruct, TEXT("/Script/Chaos"), TEXT("SolverBreakingData"), false, nullptr, nullptr);
static struct FScriptStruct_Chaos_StaticRegisterNativesFSolverBreakingData
{
	FScriptStruct_Chaos_StaticRegisterNativesFSolverBreakingData()
	{
		UScriptStruct::DeferCppStructOps<FSolverBreakingData>(FName(TEXT("SolverBreakingData")));
	}
} ScriptStruct_Chaos_StaticRegisterNativesFSolverBreakingData;
	...
	uint32 Get_Z_Construct_UScriptStruct_FSolverBreakingData_Hash() { return 393787256U; }
class UScriptStruct* FSolverCollisionData::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern CHAOS_API uint32 Get_Z_Construct_UScriptStruct_FSolverCollisionData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FSolverCollisionData, Z_Construct_UPackage__Script_Chaos(), TEXT("SolverCollisionData"), sizeof(FSolverCollisionData), Get_Z_Construct_UScriptStruct_FSolverCollisionData_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FSolverCollisionData(FSolverCollisionData::StaticStruct, TEXT("/Script/Chaos"), TEXT("SolverCollisionData"), false, nullptr, nullptr);
static struct FScriptStruct_Chaos_StaticRegisterNativesFSolverCollisionData
{
	FScriptStruct_Chaos_StaticRegisterNativesFSolverCollisionData()
	{
		UScriptStruct::DeferCppStructOps<FSolverCollisionData>(FName(TEXT("SolverCollisionData")));
	}
} ScriptStruct_Chaos_StaticRegisterNativesFSolverCollisionData;
	...
	uint32 Get_Z_Construct_UScriptStruct_FSolverCollisionData_Hash() { return 1723244395U; }
