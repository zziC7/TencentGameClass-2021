...
static struct FScriptStruct_InteractiveToolsFramework_StaticRegisterNativesFBrushStampData
{
	...
	{
		UScriptStruct::DeferCppStructOps<FBrushStampData>(FName(TEXT("BrushStampData")));
	}
	...
	IMPLEMENT_CLASS(UBrushBaseProperties, 2980117219);
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_WorldToLocalScale_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_WorldToLocalScale;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBaseBrushTool_Statics::NewProp_WorldToLocalScale_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBaseBrushTool_Statics::NewProp_WorldToLocalScale = { "WorldToLocalScale", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBaseBrushTool, WorldToLocalScale), METADATA_PARAMS(Z_Construct_UClass_UBaseBrushTool_Statics::NewProp_WorldToLocalScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBaseBrushTool_Statics::NewProp_WorldToLocalScale_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UBaseBrushTool_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBaseBrushTool_Statics::NewProp_WorldToLocalScale,
	...
	IMPLEMENT_CLASS(UBaseBrushTool, 1212518785);
